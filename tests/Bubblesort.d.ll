...
while.end18:                                      ; preds = %while.cond
  %7 = load i32, ptr getelementptr inbounds ([5001 x i32], ptr @sortlist, i64 0, i64 1), align 4
  %8 = load i32, ptr @littlest, align 4
  %cmp19 = icmp ne i32 %7, %8
  br i1 %cmp19, label %if.then21, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %while.end18
  %9 = load i32, ptr getelementptr inbounds ([5001 x i32], ptr @sortlist, i64 0, i64 500), align 16
...
if.end22:                                         ; preds = %if.then21, %lor.lhs.false
  ...
  %call26 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %11)
  ret void
}
...
for.body:                                         ; preds = %for.cond
  call void @Bubble(i32 noundef %i.0)
  br label %for.inc
