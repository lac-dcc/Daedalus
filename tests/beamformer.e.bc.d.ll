...
3:                                                ; preds = %5, %2
  %4 = tail call i32 @getopt(i32 noundef %0, ptr noundef %1, ptr noundef nonnull @.str) #16
...
6:                                                ; preds = %3
  ...
  %8 = tail call i32 @atoi(ptr nocapture noundef %7) #17
  store i32 %8, ptr @numiters, align 4, !tbaa !13
  br label %5

9:                                                ; preds = %3
  tail call void @begin_StrictFP() #18
  tail call void @begin() #18
  ret i32 0
}
...
define internal void @begin_StrictFP() #3 {
  ...
  call void @llvm.lifetime.start.p0(i64 384, ptr nonnull %1) #19
  call void @llvm.lifetime.start.p0(i64 384, ptr nonnull %2) #19
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %3) #19
  call void @llvm.lifetime.start.p0(i64 98304, ptr nonnull %4) #19
  call void @llvm.lifetime.start.p0(i64 98304, ptr nonnull %5) #19
  call void @llvm.lifetime.start.p0(i64 589824, ptr nonnull %6) #19
  call void @llvm.lifetime.start.p0(i64 384, ptr nonnull %7) #19
  call void @llvm.lifetime.start.p0(i64 49152, ptr nonnull %8) #19
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %9) #19
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %10) #19
  call void @llvm.lifetime.start.p0(i64 2048, ptr nonnull %11) #19
  br label %12

12:                                               ; preds = %12, %0
  %13 = phi i64 [ 0, %0 ], [ %16, %12 ]
  %14 = getelementptr inbounds [12 x %struct.BeamFirData], ptr %1, i64 0, i64 %13
  call void @BeamFirSetup_StrictFP(ptr noundef nonnull %14, i32 noundef 64) #18
  %15 = getelementptr inbounds [12 x %struct.BeamFirData], ptr %2, i64 0, i64 %13
  call void @BeamFirSetup_StrictFP(ptr noundef nonnull %15, i32 noundef 64) #18
...
18:                                               ; preds = %37, %12
  ...
  call void @BeamFirSetup_StrictFP(ptr noundef nonnull %20, i32 noundef 512) #18
...
45:                                               ; preds = %45, %40
  ...
  call void @InputGenerate_StrictFP(i32 noundef %42, ptr noundef nonnull %48, i32 noundef 1024) #18
...
54:                                               ; preds = %54, %43
  ...
  call void @BeamFirFilter_StrictFP(ptr noundef nonnull %44, i32 noundef 1024, i32 noundef 1, ptr noundef nonnull %57, ptr noundef nonnull %58) #18
...
61:                                               ; preds = %61, %51
  ...
  call void @BeamFirFilter_StrictFP(ptr noundef nonnull %52, i32 noundef 1024, i32 noundef 2, ptr noundef nonnull %65, ptr noundef nonnull %66) #18
...
128:                                              ; preds = %128, %93
  ...
  call void @BeamFirFilter_StrictFP(ptr noundef nonnull %94, i32 noundef 512, i32 noundef 1, ptr noundef nonnull %131, ptr noundef nonnull %132) #18
...
152:                                              ; preds = %149
  call void @llvm.lifetime.end.p0(i64 2048, ptr nonnull %11) #19
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %10) #19
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %9) #19
  call void @llvm.lifetime.end.p0(i64 49152, ptr nonnull %8) #19
  call void @llvm.lifetime.end.p0(i64 384, ptr nonnull %7) #19
  call void @llvm.lifetime.end.p0(i64 589824, ptr nonnull %6) #19
  call void @llvm.lifetime.end.p0(i64 98304, ptr nonnull %5) #19
  call void @llvm.lifetime.end.p0(i64 98304, ptr nonnull %4) #19
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %3) #19
  call void @llvm.lifetime.end.p0(i64 384, ptr nonnull %2) #19
  call void @llvm.lifetime.end.p0(i64 384, ptr nonnull %1) #19
  ret void
}
...
define internal void @begin() #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %10) #19
  call void @llvm.lifetime.start.p0(i64 2048, ptr nonnull %11) #19
  call void @llvm.lifetime.start.p0(i64 8192, ptr nonnull %12) #19
  br label %13

13:                                               ; preds = %13, %0
  %14 = phi i64 [ 0, %0 ], [ %17, %13 ]
  %15 = getelementptr inbounds [12 x %struct.BeamFirData], ptr %1, i64 0, i64 %14
  call void @BeamFirSetup(ptr noundef nonnull %15, i32 noundef 64) #18
  %16 = getelementptr inbounds [12 x %struct.BeamFirData], ptr %2, i64 0, i64 %14
  call void @BeamFirSetup(ptr noundef nonnull %16, i32 noundef 64) #18
...
19:                                               ; preds = %38, %13
  ...
  call void @BeamFirSetup(ptr noundef nonnull %21, i32 noundef 512) #18
...
54:                                               ; preds = %54, %49
  ...
  %57 = getelementptr inbounds float, ptr %4, i64 %56
  call void @InputGenerate(i32 noundef %51, ptr noundef nonnull %57, i32 noundef 1024) #18
...
63:                                               ; preds = %63, %52
  ...
  call void @BeamFirFilter(ptr noundef nonnull %53, i32 noundef 1024, i32 noundef 1, ptr noundef nonnull %66, ptr noundef nonnull %67) #18
...
70:                                               ; preds = %70, %60
  ...
  call void @BeamFirFilter(ptr noundef nonnull %61, i32 noundef 1024, i32 noundef 2, ptr noundef nonnull %74, ptr noundef nonnull %75) #18
...
135:                                              ; preds = %135, %102
  ...
  call void @BeamFirFilter(ptr noundef nonnull %103, i32 noundef 512, i32 noundef 1, ptr noundef nonnull %138, ptr noundef nonnull %139) #18
...
170:                                              ; preds = %160
  ...
  %174 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %171, ptr noundef nonnull @.str.2, double noundef %172, double noundef %173, double noundef 1.000000e-05) #20
  tail call void @exit(i32 noundef 1) #21
  unreachable

175:                                              ; preds = %160
  %176 = fpext float %165 to double
  %177 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %176) #18
...
183:                                              ; preds = %45
  call void @llvm.lifetime.end.p0(i64 8192, ptr nonnull %12) #19
  call void @llvm.lifetime.end.p0(i64 2048, ptr nonnull %11) #19
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %10) #19
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %9) #19
  call void @llvm.lifetime.end.p0(i64 49152, ptr nonnull %8) #19
...
12:                                               ; preds = %2
  ...
  %14 = call i32 @_wyvern_slice_BeamFirSetup_StrictFP__193562115(i32 %1)
  %15 = call i64 @_wyvern_slice_BeamFirSetup_StrictFP__27515057(i32 %1)
  %16 = or i64 %15, 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %13, i8 0, i64 %16, i1 false), !tbaa !16
  %17 = getelementptr i8, ptr %9, i64 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %17, i8 0, i64 %16, i1 false), !tbaa !16
  br label %18
...
5:                                                ; preds = %3
  %6 = getelementptr inbounds float, ptr %1, i64 512
  %7 = zext i32 %2 to i64
  br label %8

8:                                                ; preds = %24, %5
  %9 = phi i64 [ 0, %5 ], [ %25, %24 ]
  %10 = call i1 @_wyvern_slice_InputGenerate_StrictFP__189832267(i32 %0, i64 %9)
  br i1 %10, label %11, label %12

11:                                               ; preds = %8
  store <2 x float> <float 1.600000e+01, float 1.700000e+01>, ptr %6, align 4, !tbaa !16
  br label %24
...
12:                                               ; preds = %8
  ...
  store <2 x float> %23, ptr %19, align 4, !tbaa !16
  br label %24

24:                                               ; preds = %12, %11
  %25 = add nuw nsw i64 %9, 1
  %26 = icmp eq i64 %25, %7
  br i1 %26, label %27, label %8, !llvm.loop !56
...
24:                                               ; preds = %12, %11
  %25 = add nuw nsw i64 %9, 1
  %26 = icmp eq i64 %25, %7
  br i1 %26, label %27, label %8, !llvm.loop !58
...
define internal i1 @_wyvern_slice_InputGenerate_StrictFP__189832267(i32 %0, i64 %1) #15 {
sliceclone_1:
  %2 = icmp eq i32 %0, 1
  %3 = icmp eq i64 %1, 256
  %4 = and i1 %2, %3
...
; Function Attrs: noinline nounwind optsize willreturn
define internal i64 @_wyvern_slice_BeamFirSetup_StrictFP__27515057(i32 %0) #15 {
sliceclone_:
  %1 = shl nuw i32 %0, 1
...
; Function Attrs: noinline nounwind optsize willreturn
define internal i32 @_wyvern_slice_BeamFirSetup_StrictFP__193562115(i32 %0) #15 {
sliceclone_:
  %1 = shl nuw i32 %0, 1
  %2 = tail call i32 @llvm.smax.i32(i32 %1, i32 2)
  %3 = add nsw i32 %2, -2
