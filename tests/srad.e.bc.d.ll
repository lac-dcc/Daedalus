...
264:                                              ; preds = %260, %262, %268
  %265 = phi i64 [ %267, %268 ], [ 1, %262 ], [ 1, %260 ]
  %266 = add nsw i64 %265, -1
  %267 = add nuw nsw i64 %265, 1
  br label %270

268:                                              ; preds = %333
  %269 = icmp eq i64 %267, 2047
  br i1 %269, label %354, label %264, !llvm.loop !20

270:                                              ; preds = %333, %264
  %271 = phi i64 [ 1, %264 ], [ %287, %333 ]
  %272 = getelementptr inbounds [1024 x float], ptr %5, i64 %265, i64 %271
  %273 = load float, ptr %272, align 4, !tbaa !9
  %274 = getelementptr inbounds [1024 x float], ptr %5, i64 %266, i64 %271
  %275 = load float, ptr %274, align 4, !tbaa !9
  %276 = fsub float %275, %273
  %277 = getelementptr inbounds [1024 x float], ptr %0, i64 %265, i64 %271
  store float %276, ptr %277, align 4, !tbaa !9
  %278 = getelementptr inbounds [1024 x float], ptr %5, i64 %267, i64 %271
  %279 = load float, ptr %278, align 4, !tbaa !9
  %280 = fsub float %279, %273
  %281 = getelementptr inbounds [1024 x float], ptr %1, i64 %265, i64 %271
  store float %280, ptr %281, align 4, !tbaa !9
  %282 = add nsw i64 %271, -1
  %283 = getelementptr inbounds [1024 x float], ptr %5, i64 %265, i64 %282
  %284 = load float, ptr %283, align 4, !tbaa !9
  %285 = fsub float %284, %273
  %286 = getelementptr inbounds [1024 x float], ptr %2, i64 %265, i64 %271
  store float %285, ptr %286, align 4, !tbaa !9
  %287 = add nuw nsw i64 %271, 1
  %288 = getelementptr inbounds [1024 x float], ptr %5, i64 %265, i64 %287
  %289 = load float, ptr %288, align 4, !tbaa !9
  %290 = fsub float %289, %273
  %291 = getelementptr inbounds [1024 x float], ptr %3, i64 %265, i64 %271
  store float %290, ptr %291, align 4, !tbaa !9
  %292 = load float, ptr %277, align 4, !tbaa !9
  %293 = fmul float %292, %292
  %294 = load float, ptr %281, align 4, !tbaa !9
  %295 = fmul float %294, %294
  %296 = fadd float %293, %295
  %297 = load float, ptr %286, align 4, !tbaa !9
  %298 = fmul float %297, %297
  %299 = fadd float %296, %298
  %300 = fmul float %290, %290
  %301 = fadd float %300, %299
  %302 = fmul float %273, %273
  %303 = fdiv float %301, %302
  %304 = fadd float %292, %294
  %305 = fadd float %304, %297
  %306 = fadd float %290, %305
  %307 = fdiv float %306, %273
  %308 = fpext float %303 to double
  %309 = fmul double %308, 5.000000e-01
  %310 = fmul float %307, %307
  %311 = fpext float %310 to double
  %312 = fmul double %311, 6.250000e-02
  %313 = fsub double %309, %312
  %314 = fptrunc double %313 to float
  %315 = fpext float %307 to double
  %316 = fmul double %315, 2.500000e-01
  %317 = fadd double %316, 1.000000e+00
  %318 = fptrunc double %317 to float
  %319 = fmul float %318, %318
  %320 = fdiv float %314, %319
  %321 = fsub float %320, %101
  %322 = fdiv float %321, %104
  %323 = fpext float %322 to double
  %324 = fadd double %323, 1.000000e+00
  %325 = fdiv double 1.000000e+00, %324
  %326 = fptrunc double %325 to float
  %327 = getelementptr inbounds [1024 x float], ptr %6, i64 %265, i64 %271
  store float %326, ptr %327, align 4, !tbaa !9
  %328 = fcmp olt float %326, 0.000000e+00
  br i1 %328, label %331, label %329

329:                                              ; preds = %270
  %330 = fcmp ogt float %326, 1.000000e+00
  br i1 %330, label %331, label %333

331:                                              ; preds = %329, %270
  %332 = phi float [ 0.000000e+00, %270 ], [ 1.000000e+00, %329 ]
  store float %332, ptr %327, align 4, !tbaa !9
  br label %333

333:                                              ; preds = %331, %329
  %334 = icmp eq i64 %287, 1023
  br i1 %334, label %268, label %270, !llvm.loop !21

335:                                              ; preds = %354
  %336 = load float, ptr %33, align 4, !tbaa !9
  %337 = load float, ptr %28, align 4, !tbaa !9
  %338 = fmul float %336, %337
  %339 = load float, ptr %29, align 4, !tbaa !9
  %340 = fmul float %336, %339
  %341 = fadd float %338, %340
  %342 = load float, ptr %31, align 4, !tbaa !9
  %343 = fmul float %336, %342
  %344 = fadd float %341, %343
  %345 = load float, ptr %32, align 4, !tbaa !9
  %346 = fmul float %336, %345
  %347 = fadd float %344, %346
  %348 = load float, ptr %26, align 4, !tbaa !9
  %349 = fpext float %348 to double
  %350 = fpext float %347 to double
  %351 = fmul double %350, 1.250000e-01
  %352 = fadd double %351, %349
  %353 = fptrunc double %352 to float
  store float %353, ptr %26, align 4, !tbaa !9
  br label %386

354:                                              ; preds = %354, %268
  %355 = phi i64 [ %357, %354 ], [ 0, %268 ]
  %356 = getelementptr inbounds [1024 x float], ptr %6, i64 2047, i64 %355
  %357 = add nuw nsw i64 %355, 1
  %358 = getelementptr inbounds [1024 x float], ptr %0, i64 2047, i64 %355
  %359 = load float, ptr %358, align 4, !tbaa !9
  %360 = getelementptr inbounds [1024 x float], ptr %1, i64 2047, i64 %355
  %361 = load float, ptr %360, align 4, !tbaa !9
  %362 = getelementptr inbounds [1024 x float], ptr %2, i64 2047, i64 %355
  %363 = load float, ptr %362, align 4, !tbaa !9
  %364 = getelementptr inbounds [1024 x float], ptr %3, i64 2047, i64 %355
  %365 = load float, ptr %364, align 4, !tbaa !9
  %366 = load <2 x float>, ptr %356, align 4, !tbaa !9
  %367 = extractelement <2 x float> %366, i64 0
  %368 = fmul float %367, %359
  %369 = fmul float %367, %361
  %370 = fadd float %368, %369
  %371 = insertelement <2 x float> poison, float %363, i64 0
  ...
  %378 = getelementptr inbounds [1024 x float], ptr %5, i64 2047, i64 %355
  %379 = load float, ptr %378, align 4, !tbaa !9
  %380 = fpext float %379 to double
  %381 = fpext float %377 to double
  %382 = fmul double %381, 1.250000e-01
  %383 = fadd double %382, %380
  %384 = fptrunc double %383 to float
  store float %384, ptr %378, align 4, !tbaa !9
  %385 = icmp eq i64 %357, 1023
  br i1 %385, label %335, label %354, !llvm.loop !22

386:                                              ; preds = %392, %335
  %387 = phi i64 [ 0, %335 ], [ %388, %392 ]
  %388 = add nuw nsw i64 %387, 1
  br label %394

389:                                              ; preds = %392
  %390 = add nuw nsw i32 %35, 1
  %391 = icmp eq i32 %390, 10
  br i1 %391, label %428, label %34, !llvm.loop !23

392:                                              ; preds = %394
  %393 = icmp eq i64 %388, 2047
  br i1 %393, label %389, label %386, !llvm.loop !24

394:                                              ; preds = %394, %386
  %395 = phi i64 [ 0, %386 ], [ %399, %394 ]
  %396 = getelementptr inbounds [1024 x float], ptr %6, i64 %387, i64 %395
  %397 = getelementptr inbounds [1024 x float], ptr %6, i64 %388, i64 %395
  %398 = load float, ptr %397, align 4, !tbaa !9
  %399 = add nuw nsw i64 %395, 1
  %400 = getelementptr inbounds [1024 x float], ptr %0, i64 %387, i64 %395
  %401 = load float, ptr %400, align 4, !tbaa !9
  %402 = getelementptr inbounds [1024 x float], ptr %1, i64 %387, i64 %395
  %403 = load float, ptr %402, align 4, !tbaa !9
  %404 = fmul float %398, %403
  %405 = getelementptr inbounds [1024 x float], ptr %2, i64 %387, i64 %395
  %406 = load float, ptr %405, align 4, !tbaa !9
  %407 = getelementptr inbounds [1024 x float], ptr %3, i64 %387, i64 %395
  %408 = load float, ptr %407, align 4, !tbaa !9
  %409 = load <2 x float>, ptr %396, align 4, !tbaa !9
  %410 = extractelement <2 x float> %409, i64 0
  %411 = fmul float %410, %401
  %412 = fadd float %411, %404
  %413 = insertelement <2 x float> poison, float %406, i64 0
  %414 = insertelement <2 x float> %413, float %408, i64 1
  %415 = fmul <2 x float> %409, %414
  %416 = extractelement <2 x float> %415, i64 0
  %417 = fadd float %412, %416
  %418 = extractelement <2 x float> %415, i64 1
  %419 = fadd float %417, %418
  %420 = getelementptr inbounds [1024 x float], ptr %5, i64 %387, i64 %395
  %421 = load float, ptr %420, align 4, !tbaa !9
  %422 = fpext float %421 to double
  %423 = fpext float %419 to double
  %424 = fmul double %423, 1.250000e-01
  %425 = fadd double %424, %422
  %426 = fptrunc double %425 to float
  store float %426, ptr %420, align 4, !tbaa !9
  %427 = icmp eq i64 %399, 1023
  br i1 %427, label %392, label %394, !llvm.loop !25
