...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 49, ptr nonnull %3) #14
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %4) #14
  store i32 0, ptr %4, align 4, !tbaa !7
  %5 = load ptr, ptr @stderr, align 8, !tbaa !11
  %6 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7) #15
  %7 = load ptr, ptr @stderr, align 8, !tbaa !11
  %8 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.9) #15
  %9 = getelementptr inbounds ptr, ptr %1, i64 1
  %10 = load ptr, ptr %9, align 8, !tbaa !11
  %11 = tail call noalias ptr @fopen(ptr noundef %10, ptr noundef nonnull @.str.10) #16
  %12 = icmp eq ptr %11, null
  br i1 %12, label %13, label %18

13:                                               ; preds = %2
  %14 = tail call noalias ptr @fopen(ptr noundef nonnull @.str.11, ptr noundef nonnull @.str.10) #16
...
18:                                               ; preds = %13, %2
  ...
  %22 = call i32 @fclose(ptr noundef nonnull %19) #16
  %23 = load i32, ptr @DEPTH, align 4, !tbaa !7
  %24 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.14, i32 noundef %23) #16
  %25 = load i32, ptr %4, align 4, !tbaa !7
  %26 = icmp eq i32 %25, 0
  %27 = select i1 %26, ptr @.str.17, ptr @.str.16
  %28 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, ptr noundef nonnull %27) #16
...
90:                                               ; preds = %132, %82
  %91 = call i32 @putchar(i32 noundef 32) #16
  br label %92
...
92:                                               ; preds = %92, %90
  ...
  %97 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %96) #16
  %98 = add nuw nsw i64 %93, 1
  %99 = icmp eq i64 %98, 7
  br i1 %99, label %100, label %92, !llvm.loop !21

100:                                              ; preds = %92
  %101 = call i32 @putchar(i32 noundef 10) #16
  br label %102

102:                                              ; preds = %114, %100
  %103 = phi i64 [ 5, %100 ], [ %116, %114 ]
  %104 = trunc i64 %103 to i32
  %105 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %104) #16
  br label %106
...
106:                                              ; preds = %106, %102
  ...
  %111 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %110) #16
  %112 = add nuw nsw i64 %107, 1
  %113 = icmp eq i64 %112, 7
  br i1 %113, label %114, label %106, !llvm.loop !22

114:                                              ; preds = %106
  %115 = call i32 @putchar(i32 noundef 10) #16
  %116 = add nsw i64 %103, -1
  %117 = icmp eq i64 %103, 0
  br i1 %117, label %118, label %102, !llvm.loop !23

118:                                              ; preds = %114
  %119 = call i32 @putchar(i32 noundef 32) #16
  br label %120

120:                                              ; preds = %120, %118
  %121 = phi i32 [ 0, %118 ], [ %123, %120 ]
  %122 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %121) #16
  %123 = add nuw nsw i32 %121, 1
  %124 = icmp eq i32 %123, 7
  br i1 %124, label %125, label %120, !llvm.loop !24

125:                                              ; preds = %120
  %126 = call i32 @putchar(i32 noundef 10) #16
  %127 = call i32 @puts(ptr nonnull dereferenceable(1) @str)
  %128 = call fastcc i32 @find_winner_p(ptr noundef nonnull %3) #16, !range !25
...
129:                                              ; preds = %125
  %130 = call fastcc i32 @find_winner_c(ptr noundef nonnull %3) #16, !range !25
  %131 = icmp eq i32 %130, 0
  br i1 %131, label %132, label %142

132:                                              ; preds = %129
  %133 = load i32, ptr %4, align 4, !tbaa !7
  %134 = call fastcc i32 @think(ptr noundef nonnull %3, i32 noundef 1, i32 noundef %133) #16
  call fastcc void @place_piece(i32 noundef %134, i32 noundef 1, ptr noundef nonnull %3) #16
  %135 = load i32, ptr %4, align 4, !tbaa !7
  %136 = call fastcc i32 @think(ptr noundef nonnull %3, i32 noundef 2, i32 noundef %135) #16
  call fastcc void @place_piece(i32 noundef %136, i32 noundef 2, ptr noundef nonnull %3) #16
  br label %90, !llvm.loop !26

137:                                              ; preds = %125
  %138 = call fastcc i32 @find_winner_c(ptr noundef nonnull %3) #16, !range !25
...
142:                                              ; preds = %140, %137, %129, %125
  %143 = call fastcc i32 @find_winner_c(ptr noundef nonnull %3) #16, !range !25
  %144 = icmp eq i32 %143, 1
  br i1 %144, label %145, label %150

145:                                              ; preds = %142
  %146 = call fastcc i32 @find_winner_p(ptr noundef nonnull %3) #16, !range !25
...
150:                                              ; preds = %148, %145, %142
  %151 = call fastcc i32 @find_winner_p(ptr noundef nonnull %3) #16, !range !25
  %152 = icmp eq i32 %151, 2
  br i1 %152, label %158, label %153

153:                                              ; preds = %150
  %154 = call fastcc i32 @find_winner_c(ptr noundef nonnull %3) #16, !range !25
...
160:                                              ; preds = %158, %153
  ...
  call void @llvm.lifetime.end.p0(i64 49, ptr nonnull %3) #14
  ret i32 0
}
...
2:                                                ; preds = %2, %1
  %3 = phi i64 [ 0, %1 ], [ %6, %2 ]
  %4 = phi i32 [ 0, %1 ], [ %5, %2 ]
  %5 = call i32 @_wyvern_slice_find_winner_c__867859968(ptr %0, i64 %3, i32 %4)
...
8:                                                ; preds = %2
  %.lcssa1 = phi i32 [ %5, %2 ]
  %9 = icmp eq i32 %.lcssa1, 42
  br i1 %9, label %91, label %10

10:                                               ; preds = %28, %8
  %11 = phi i64 [ %29, %28 ], [ 0, %8 ]
  %12 = phi i64 [ %.lcssa, %28 ], [ 0, %8 ]
  %13 = mul nuw nsw i64 %11, 7
  br label %16

14:                                               ; preds = %28
  %.lcssa.lcssa = phi i64 [ %.lcssa, %28 ]
  %15 = load i64, ptr @C4VERT, align 8, !tbaa !13
  br label %37

16:                                               ; preds = %16, %10
  %17 = phi i64 [ 0, %10 ], [ %26, %16 ]
  %18 = phi i64 [ %12, %10 ], [ %25, %16 ]
  %19 = getelementptr inbounds [7 x i8], ptr %0, i64 %17, i64 %11
  %20 = load i8, ptr %19, align 1, !tbaa !19
  %21 = icmp eq i8 %20, 111
  %22 = add nuw nsw i64 %17, %13
  %23 = shl nuw nsw i64 1, %22
  %24 = select i1 %21, i64 %23, i64 0
  %25 = or i64 %24, %18
  %26 = add nuw nsw i64 %17, 1
  %27 = icmp eq i64 %26, 7
  br i1 %27, label %28, label %16, !llvm.loop !28

28:                                               ; preds = %16
  %.lcssa = phi i64 [ %25, %16 ]
  %29 = add nuw nsw i64 %11, 1
  %30 = icmp eq i64 %29, 6
  br i1 %30, label %14, label %10, !llvm.loop !29

31:                                               ; preds = %37
  %32 = add nuw nsw i64 %38, 1
  %33 = icmp eq i64 %32, 21
  br i1 %33, label %34, label %37, !llvm.loop !30

34:                                               ; preds = %31
  %35 = load i1, ptr @C4HORIZ, align 8
  %36 = select i1 %35, i64 15, i64 0
  br label %42

37:                                               ; preds = %31, %14
  %38 = phi i64 [ 0, %14 ], [ %32, %31 ]
  %39 = shl i64 %15, %38
  %40 = and i64 %39, %.lcssa.lcssa
  %41 = icmp eq i64 %40, %39
  br i1 %41, label %91, label %31

42:                                               ; preds = %56, %34
  %43 = phi i64 [ 0, %34 ], [ %57, %56 ]
  %44 = mul nuw nsw i64 %43, 7
  br label %50

45:                                               ; preds = %56
  %46 = load i64, ptr @C4UP_R, align 8, !tbaa !13
  br label %59

47:                                               ; preds = %50
  %48 = add nuw nsw i64 %51, 1
  %49 = icmp eq i64 %48, 4
  br i1 %49, label %56, label %50, !llvm.loop !31

50:                                               ; preds = %47, %42
  %51 = phi i64 [ 0, %42 ], [ %48, %47 ]
  %52 = add nuw nsw i64 %51, %44
  %53 = shl i64 %36, %52
  %54 = and i64 %53, %.lcssa.lcssa
  %55 = icmp eq i64 %54, %53
  br i1 %55, label %91, label %47

56:                                               ; preds = %47
  %57 = add nuw nsw i64 %43, 1
  %58 = icmp eq i64 %57, 6
  br i1 %58, label %45, label %42, !llvm.loop !32
...
62:                                               ; preds = %73
  %63 = load i64, ptr @C4UP_L, align 8, !tbaa !13
  br label %76

64:                                               ; preds = %67
  %65 = add nuw nsw i64 %68, 1
  %66 = icmp eq i64 %65, 4
  br i1 %66, label %73, label %67, !llvm.loop !33

67:                                               ; preds = %64, %59
  %68 = phi i64 [ 0, %59 ], [ %65, %64 ]
  %69 = add nuw nsw i64 %68, %61
  %70 = shl i64 %46, %69
  %71 = and i64 %70, %.lcssa.lcssa
  %72 = icmp eq i64 %71, %70
  br i1 %72, label %91, label %64

73:                                               ; preds = %64
  %74 = add nuw nsw i64 %60, 1
  %75 = icmp eq i64 %74, 3
  br i1 %75, label %62, label %59, !llvm.loop !34
...
79:                                               ; preds = %82
  ...
  %81 = icmp eq i64 %80, 4
  br i1 %81, label %88, label %82, !llvm.loop !35

82:                                               ; preds = %79, %76
  %83 = phi i64 [ 0, %76 ], [ %80, %79 ]
  %84 = add nuw nsw i64 %83, %78
  %85 = shl i64 %63, %84
  %86 = and i64 %85, %.lcssa.lcssa
...
88:                                               ; preds = %79
  ...
  %90 = icmp eq i64 %89, 3
  br i1 %90, label %91, label %76, !llvm.loop !36

91:                                               ; preds = %88, %82, %67, %50, %37, %8
  %92 = phi i32 [ 2, %8 ], [ 1, %82 ], [ 0, %88 ], [ 1, %67 ], [ 1, %50 ], [ 1, %37 ]
  ret i32 %92
}
...
16:                                               ; preds = %16, %10
  ...
  %26 = add nuw nsw i64 %17, 1
  %27 = icmp eq i64 %26, 7
  br i1 %27, label %28, label %16, !llvm.loop !37

28:                                               ; preds = %16
  %.lcssa = phi i64 [ %25, %16 ]
  %29 = add nuw nsw i64 %11, 1
  %30 = icmp eq i64 %29, 6
  br i1 %30, label %14, label %10, !llvm.loop !38

31:                                               ; preds = %37
  %32 = add nuw nsw i64 %38, 1
  %33 = icmp eq i64 %32, 21
  br i1 %33, label %34, label %37, !llvm.loop !39
...
47:                                               ; preds = %50
  %48 = add nuw nsw i64 %51, 1
  %49 = icmp eq i64 %48, 4
  br i1 %49, label %56, label %50, !llvm.loop !40
...
56:                                               ; preds = %47
  %57 = add nuw nsw i64 %43, 1
  %58 = icmp eq i64 %57, 6
  br i1 %58, label %45, label %42, !llvm.loop !41
...
64:                                               ; preds = %67
  %65 = add nuw nsw i64 %68, 1
  %66 = icmp eq i64 %65, 4
  br i1 %66, label %73, label %67, !llvm.loop !42
...
73:                                               ; preds = %64
  %74 = add nuw nsw i64 %60, 1
  %75 = icmp eq i64 %74, 3
  br i1 %75, label %62, label %59, !llvm.loop !43
...
79:                                               ; preds = %82
  %80 = add nuw nsw i64 %83, 1
  %81 = icmp eq i64 %80, 4
  br i1 %81, label %88, label %82, !llvm.loop !44
...
88:                                               ; preds = %79
  %89 = add nuw nsw i64 %77, 1
  %90 = icmp eq i64 %89, 3
  br i1 %90, label %91, label %76, !llvm.loop !45
...
45:                                               ; preds = %44
  %46 = call fastcc i32 @minimax_comp_ab(i32 noundef 1, i64 noundef %.lcssa1.lcssa.lcssa, i64 noundef %.lcssa.lcssa, ptr noundef nonnull %4, i32 noundef -100000, i32 noundef 100000) #16
  br label %59

47:                                               ; preds = %44
  %48 = call fastcc i32 @minimax_player_ab(i32 noundef 1, i64 noundef %.lcssa1.lcssa.lcssa, i64 noundef %.lcssa.lcssa, ptr noundef nonnull %4, i32 noundef -100000, i32 noundef 100000) #16
  br label %59
...
50:                                               ; preds = %49
  %51 = call fastcc i32 @minimax_comp_ab2(i32 noundef 1, i64 noundef %.lcssa1.lcssa.lcssa, i64 noundef %.lcssa.lcssa, ptr noundef nonnull %4, i32 noundef 100000) #16
  br label %59

52:                                               ; preds = %49
  %53 = call fastcc i32 @minimax_player_ab2(i32 noundef 1, i64 noundef %.lcssa1.lcssa.lcssa, i64 noundef %.lcssa.lcssa, ptr noundef nonnull %4, i32 noundef -100000) #16
  br label %59
...
55:                                               ; preds = %54
  %56 = call fastcc i32 @minimax_comp(i32 noundef 1, i64 noundef %.lcssa1.lcssa.lcssa, i64 noundef %.lcssa.lcssa, ptr noundef nonnull %4) #16
  br label %59

57:                                               ; preds = %54
  %58 = call fastcc i32 @minimax_player(i32 noundef 1, i64 noundef %.lcssa1.lcssa.lcssa, i64 noundef %.lcssa.lcssa, ptr noundef nonnull %4) #16
  br label %59
...
5:                                                ; preds = %3
  %6 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i32 noundef %0) #16
  br label %22
...
14:                                               ; preds = %6
  %15 = tail call fastcc i32 @value(i64 noundef %1, i64 noundef %2) #16
  br label %48
...
32:                                               ; preds = %23
  %.lcssa = phi i64 [ %29, %23 ]
  %33 = or i64 %.lcssa, %2
  %34 = tail call fastcc i32 @minimax_player_ab(i32 noundef %13, i64 noundef %1, i64 noundef %33, ptr noundef %3, i32 noundef %18, i32 noundef %5) #16
...
32:                                               ; preds = %23
  %.lcssa = phi i64 [ %29, %23 ]
  %33 = or i64 %.lcssa, %1
  %34 = tail call fastcc i32 @minimax_comp_ab(i32 noundef %13, i64 noundef %33, i64 noundef %2, ptr noundef %3, i32 noundef %4, i32 noundef %18) #16
  %35 = icmp sgt i32 %34, %18
...
11:                                               ; preds = %5
  %12 = tail call fastcc i32 @value(i64 noundef %1, i64 noundef %2) #16
  br label %42
...
29:                                               ; preds = %20
  %.lcssa = phi i64 [ %26, %20 ]
  %30 = or i64 %.lcssa, %2
  %31 = tail call fastcc i32 @minimax_player_ab2(i32 noundef %10, i64 noundef %1, i64 noundef %30, ptr noundef %3, i32 noundef %15) #16
...
29:                                               ; preds = %20
  %.lcssa = phi i64 [ %26, %20 ]
  %30 = or i64 %.lcssa, %1
  %31 = tail call fastcc i32 @minimax_comp_ab2(i32 noundef %10, i64 noundef %30, i64 noundef %2, ptr noundef %3, i32 noundef %15) #16
  %32 = icmp sgt i32 %31, %15
...
10:                                               ; preds = %4
  %11 = tail call fastcc i32 @value(i64 noundef %1, i64 noundef %2) #16
  br label %40
...
28:                                               ; preds = %19
  %.lcssa = phi i64 [ %25, %19 ]
  %29 = or i64 %.lcssa, %2
  %30 = tail call fastcc i32 @minimax_player(i32 noundef %9, i64 noundef %1, i64 noundef %29, ptr noundef %3) #16
...
28:                                               ; preds = %19
  %.lcssa = phi i64 [ %25, %19 ]
  %29 = or i64 %.lcssa, %1
  %30 = tail call fastcc i32 @minimax_comp(i32 noundef %9, i64 noundef %29, i64 noundef %2, ptr noundef %3) #16
  %31 = icmp sgt i32 %30, %14
...
define internal i32 @_wyvern_slice_find_winner_c__867859968(ptr %0, i64 %1, i32 %2) #13 {
sliceclone_:
  %3 = getelementptr inbounds [7 x i8], ptr %0, i64 %1, i64 6
