...
11:                                               ; preds = %8, %4
  ...
  %14 = tail call i32 @atoi(ptr nocapture noundef %13) #14
...
27:                                               ; preds = %25, %16
  ...
  %30 = tail call i32 @atoi(ptr nocapture noundef %29) #14
  br label %31
...
10:                                               ; preds = %8
  %11 = tail call noalias dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #15
  %12 = icmp eq i32 %1, 0
  %13 = sdiv i32 %0, 2
  %14 = sdiv i32 %3, 2
  %15 = add nsw i32 %14, %2
...
16:                                               ; preds = %10
  %17 = tail call fastcc double @median(double noundef %4, double noundef %5) #14
  %18 = tail call ptr @build_tree(i32 noundef %13, i32 noundef 0, i32 noundef %15, i32 noundef %14, double noundef %4, double noundef %17, double noundef %6, double noundef %7) #14
  %19 = tail call ptr @build_tree(i32 noundef %13, i32 noundef 0, i32 noundef %2, i32 noundef %14, double noundef %17, double noundef %5, double noundef %6, double noundef %7) #14
  %20 = call double @_wyvern_slice_build_tree__130743622(double %6, double %7)
  %21 = fadd double %20, %6
  br label %28

22:                                               ; preds = %10
  %23 = tail call fastcc double @median(double noundef %6, double noundef %7) #14
  %24 = tail call ptr @build_tree(i32 noundef %13, i32 noundef 1, i32 noundef %15, i32 noundef %14, double noundef %4, double noundef %5, double noundef %6, double noundef %23) #14
  %25 = tail call ptr @build_tree(i32 noundef %13, i32 noundef 1, i32 noundef %2, i32 noundef %14, double noundef %4, double noundef %5, double noundef %23, double noundef %7) #14
  %26 = call double @_wyvern_slice_build_tree__130743622(double %4, double %5)
  %27 = fadd double %26, %4
  br label %28

28:                                               ; preds = %22, %16
  %29 = phi ptr [ %24, %22 ], [ %18, %16 ]
  %30 = phi ptr [ %25, %22 ], [ %19, %16 ]
  %31 = phi double [ %23, %22 ], [ %21, %16 ]
  %32 = phi double [ %27, %22 ], [ %17, %16 ]
  %33 = getelementptr inbounds %struct.tree, ptr %11, i64 0, i32 3
  store ptr %29, ptr %33, align 8
  %34 = getelementptr inbounds %struct.tree, ptr %11, i64 0, i32 4
  store ptr %30, ptr %34, align 8
  %35 = getelementptr inbounds %struct.tree, ptr %11, i64 0, i32 2
  store double %31, ptr %35, align 8
  %36 = getelementptr inbounds %struct.tree, ptr %11, i64 0, i32 1
  store double %32, ptr %36, align 8
  store i32 %0, ptr %11, align 8, !tbaa !15
  %37 = getelementptr inbounds %struct.tree, ptr %11, i64 0, i32 5
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %37, i8 0, i64 16, i1 false)
  br label %38

38:                                               ; preds = %28, %8
  %39 = phi ptr [ %11, %28 ], [ null, %8 ]
  ret ptr %39
}
...
3:                                                ; preds = %1
  ...
  %8 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %5, double noundef %7) #14
...
12:                                               ; preds = %12, %3
  ...
  %18 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %15, double noundef %17) #14
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #2 {
  %3 = tail call i32 @dealwithargs(i32 noundef %0, ptr noundef %1) #16
  %4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %3) #14
  %5 = load i32, ptr @NumNodes, align 4, !tbaa !11
  %6 = tail call ptr @build_tree(i32 noundef %3, i32 noundef 0, i32 noundef 0, i32 noundef %5, double noundef 0.000000e+00, double noundef 1.000000e+00, double noundef 0.000000e+00, double noundef 1.000000e+00) #16
...
19:                                               ; preds = %17, %13, %9
  ...
  %21 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, i32 noundef 150, i32 noundef %20) #14
  %22 = load i32, ptr @NumNodes, align 4, !tbaa !11
  %23 = tail call ptr @tsp(ptr noundef %6, i32 noundef 150, i32 noundef %22) #16
  %24 = load i32, ptr @flag, align 4, !tbaa !11
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %31, label %26

26:                                               ; preds = %19
  tail call void @print_list(ptr noundef %6) #14
...
6:                                                ; preds = %3
  %7 = tail call fastcc ptr @makelist(ptr noundef nonnull %0) #14
...
109:                                              ; preds = %3
  ...
  %115 = tail call ptr @tsp(ptr noundef %112, i32 noundef %1, i32 noundef %110) #14
  %116 = tail call ptr @tsp(ptr noundef %114, i32 noundef %1, i32 noundef %110) #14
...
3:                                                ; preds = %1
  ...
  %6 = tail call fastcc ptr @makelist(ptr noundef %5) #14
  %7 = getelementptr inbounds %struct.tree, ptr %0, i64 0, i32 4
  %8 = load ptr, ptr %7, align 8, !tbaa !26
  %9 = tail call fastcc ptr @makelist(ptr noundef %8) #14
...
define internal double @_wyvern_slice_build_tree__130743622(double %0, double %1) #13 {
sliceclone_:
  %2 = tail call double @drand48() #16
  %3 = fsub double %1, %0
  %4 = fmul double %3, %2
  ret double %4
}
