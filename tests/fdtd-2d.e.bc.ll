...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readnone %1) #0 {
  %3 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 1000000) #9
  %4 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 1000000) #9
  %5 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 1000000) #9
  %6 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 1000000) #9
  %7 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 1000000) #9
  %8 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 1000000) #9
  %9 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 50) #9
  tail call fastcc void @init_array(ptr noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %9) #9
  br label %10
...
22:                                               ; preds = %22, %19
  ...
  store double %31, ptr %24, align 8, !tbaa !7
...
39:                                               ; preds = %39, %37
  ...
  store double %49, ptr %41, align 8, !tbaa !7
...
58:                                               ; preds = %58, %55
  ...
  store double %74, ptr %60, align 8, !tbaa !7
  %75 = icmp eq i64 %62, 999
  br i1 %75, label %76, label %58, !llvm.loop !17

76:                                               ; preds = %58
  %77 = icmp eq i64 %57, 999
  br i1 %77, label %78, label %55, !llvm.loop !18

78:                                               ; preds = %76
  %79 = add nuw nsw i64 %11, 1
  %80 = icmp eq i64 %79, 50
  br i1 %80, label %81, label %10, !llvm.loop !19

81:                                               ; preds = %78
  tail call fastcc void @init_array(ptr noundef %6, ptr noundef %7, ptr noundef %8, ptr noundef %9) #9
  br label %82
...
85:                                               ; preds = %85, %82
  ...
  %87 = load double, ptr %84, align 8, !tbaa !7
...
94:                                               ; preds = %94, %91
  ...
  store double %104, ptr %96, align 8, !tbaa !7
  %105 = add nuw nsw i64 %95, 1
  %106 = icmp eq i64 %105, 1000
  br i1 %106, label %107, label %94, !llvm.loop !21

107:                                              ; preds = %94
  %108 = add nuw nsw i64 %92, 1
  %109 = icmp eq i64 %108, 1000
  br i1 %109, label %110, label %91, !llvm.loop !22
...
126:                                              ; preds = %112
  ...
  br i1 %128, label %129, label %110, !llvm.loop !24
...
132:                                              ; preds = %132, %129
  ...
  store double %149, ptr %134, align 8, !tbaa !7
...
153:                                              ; preds = %151
  ...
  br i1 %155, label %156, label %82, !llvm.loop !27

156:                                              ; preds = %153
  %157 = tail call noalias dereferenceable_or_null(16001) ptr @malloc(i64 noundef 16001) #10
...
161:                                              ; preds = %161, %159
  ...
  store i8 %168, ptr %170, align 1, !tbaa !28
  %171 = lshr i64 %164, 8
  %172 = trunc i64 %171 to i8
  %173 = and i8 %172, 15
  %174 = or i8 %173, 48
  %175 = getelementptr inbounds i8, ptr %169, i64 2
  store i8 %174, ptr %175, align 1, !tbaa !28
  %176 = getelementptr inbounds i8, ptr %169, i64 3
  store i8 %174, ptr %176, align 1, !tbaa !28
  %177 = lshr i64 %164, 16
  ...
  store i8 %180, ptr %182, align 1, !tbaa !28
  %183 = lshr i64 %164, 24
  ...
  store i8 %186, ptr %188, align 1, !tbaa !28
  %189 = lshr i64 %164, 32
  ...
  store i8 %192, ptr %194, align 1, !tbaa !28
  %195 = lshr i64 %164, 40
  ...
  store i8 %198, ptr %200, align 1, !tbaa !28
  %201 = lshr i64 %164, 48
  %202 = trunc i64 %201 to i8
  %203 = and i8 %202, 15
  %204 = or i8 %203, 48
  %205 = getelementptr inbounds i8, ptr %169, i64 12
  store i8 %204, ptr %205, align 1, !tbaa !28
  %206 = getelementptr inbounds i8, ptr %169, i64 13
  store i8 %204, ptr %206, align 1, !tbaa !28
  %207 = lshr i64 %164, 56
  ...
  store i8 %210, ptr %212, align 1, !tbaa !28
  %213 = add nuw nsw i64 %162, 1
  %214 = icmp eq i64 %213, 1000
  br i1 %214, label %215, label %161, !llvm.loop !29

215:                                              ; preds = %161
  %216 = load ptr, ptr @stderr, align 8, !tbaa !30
  %217 = tail call i32 @fputs(ptr noundef nonnull %157, ptr noundef %216) #11
  br label %218
...
218:                                              ; preds = %218, %215
  ...
  store i8 %225, ptr %227, align 1, !tbaa !28
  %228 = lshr i64 %221, 8
  ...
  store i8 %231, ptr %233, align 1, !tbaa !28
  %234 = lshr i64 %221, 16
  ...
  store i8 %237, ptr %239, align 1, !tbaa !28
  %240 = lshr i64 %221, 24
  ...
  store i8 %243, ptr %245, align 1, !tbaa !28
  %246 = lshr i64 %221, 32
  ...
  store i8 %255, ptr %257, align 1, !tbaa !28
  %258 = lshr i64 %221, 48
  %259 = trunc i64 %258 to i8
  %260 = and i8 %259, 15
  %261 = or i8 %260, 48
  %262 = getelementptr inbounds i8, ptr %226, i64 12
  store i8 %261, ptr %262, align 1, !tbaa !28
  %263 = getelementptr inbounds i8, ptr %226, i64 13
  store i8 %261, ptr %263, align 1, !tbaa !28
  %264 = lshr i64 %221, 56
  ...
  store i8 %267, ptr %269, align 1, !tbaa !28
...
272:                                              ; preds = %218
  ...
  %274 = tail call i32 @fputs(ptr noundef nonnull %157, ptr noundef %273) #11
  br label %275
...
275:                                              ; preds = %275, %272
  ...
  store i8 %306, ptr %308, align 1, !tbaa !28
  %309 = lshr i64 %278, 40
  ...
  store i8 %312, ptr %314, align 1, !tbaa !28
  %315 = lshr i64 %278, 48
  %316 = trunc i64 %315 to i8
  %317 = and i8 %316, 15
  %318 = or i8 %317, 48
  %319 = getelementptr inbounds i8, ptr %283, i64 12
  store i8 %318, ptr %319, align 1, !tbaa !28
  %320 = getelementptr inbounds i8, ptr %283, i64 13
  store i8 %318, ptr %320, align 1, !tbaa !28
  %321 = lshr i64 %278, 56
...
329:                                              ; preds = %275
  %330 = load ptr, ptr @stderr, align 8, !tbaa !30
  %331 = tail call i32 @fputs(ptr noundef nonnull %157, ptr noundef %330) #11
...
define internal fastcc ptr @polybench_alloc_data(i64 noundef %0) unnamed_addr #0 {
  ...
  %4 = call i32 @posix_memalign(ptr noundef nonnull %2, i64 noundef 32, i64 noundef %3) #12
...
define internal fastcc void @init_array(ptr nocapture noundef writeonly %0, ptr nocapture noundef writeonly %1, ptr nocapture noundef writeonly %2, ptr nocapture noundef writeonly %3) unnamed_addr #1 {
  br label %5
...
5:                                                ; preds = %5, %4
  ...
  store <2 x double> %8, ptr %9, align 8, !tbaa !7
...
17:                                               ; preds = %17, %13
  ...
  %35 = getelementptr inbounds [1000 x double], ptr %2, i64 %14, i64 %18
  store double %34, ptr %35, align 8, !tbaa !7
  %36 = icmp eq i64 %19, 1000
  br i1 %36, label %37, label %17, !llvm.loop !38

37:                                               ; preds = %17
  %38 = add nuw nsw i64 %14, 1
  %39 = icmp eq i64 %38, 1000
  br i1 %39, label %40, label %13, !llvm.loop !39
...
attributes #1 = { nofree norecurse nosync nounwind optsize memory(argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
