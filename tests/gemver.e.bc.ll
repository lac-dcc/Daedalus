...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readnone %1) #0 {
  %3 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 16000000) #6
  %4 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 16000000) #6
  %5 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #6
  %6 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #6
  %7 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #6
  %8 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #6
  %9 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #6
  %10 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #6
  %11 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #6
  %12 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #6
  br label %13
...
33:                                               ; preds = %33, %13
  ...
  store <2 x double> %38, ptr %39, align 8, !tbaa !7
...
43:                                               ; preds = %33
  ...
  br i1 %45, label %46, label %13, !llvm.loop !15
...
50:                                               ; preds = %50, %46
  ...
  %54 = load double, ptr %48, align 8, !tbaa !7
  ...
  br i1 %66, label %67, label %50, !llvm.loop !16
...
73:                                               ; preds = %73, %70
  ...
  store double %82, ptr %72, align 8, !tbaa !7
...
88:                                               ; preds = %88, %85
  ...
  store double %94, ptr %90, align 8, !tbaa !7
  %95 = add nuw nsw i64 %89, 1
  %96 = icmp eq i64 %95, 4000
  br i1 %96, label %97, label %88, !llvm.loop !20
...
113:                                              ; preds = %101
  ...
  br i1 %115, label %116, label %97, !llvm.loop !22
...
116:                                              ; preds = %128, %113
  ...
  %121 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %118, ptr noundef nonnull @.str.2, double noundef %120) #7
...
define internal fastcc ptr @polybench_alloc_data(i64 noundef %0) unnamed_addr #0 {
  ...
  %4 = call i32 @posix_memalign(ptr noundef nonnull %2, i64 noundef 32, i64 noundef %3) #8
