...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readnone %1) #0 {
  ...
  %5 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4225) #9
  %6 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4225) #9
  %7 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4225) #9
  %8 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4225) #9
  %9 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 274625) #9
  %10 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 274625) #9
  %11 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 274625) #9
  %12 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 274625) #9
  %13 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 274625) #9
  %14 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 274625) #9
  %15 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 274625) #9
  %16 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 274625) #9
  %17 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 65) #9
  %18 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 65) #9
  %19 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 65) #9
  %20 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 65) #9
  %21 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 65) #9
  %22 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 65) #9
  call fastcc void @init_array(ptr noundef nonnull %3, ptr noundef nonnull %4, ptr noundef %5, ptr noundef %6, ptr noundef %10, ptr noundef %11, ptr noundef %12, ptr noundef %17, ptr noundef %18, ptr noundef %19, ptr noundef %20, ptr noundef %21, ptr noundef %22) #9
...
47:                                               ; preds = %47, %40
  ...
  store double %60, ptr %43, align 8, !tbaa !7
  %61 = load double, ptr %44, align 8, !tbaa !7
  %62 = load double, ptr %45, align 8, !tbaa !7
  ...
  store double %68, ptr %46, align 8, !tbaa !7
  ...
  %76 = load double, ptr %32, align 8, !tbaa !7
  ...
  %82 = load double, ptr %64, align 8, !tbaa !7
  %83 = fneg double %81
  ...
  %87 = load double, ptr %46, align 8, !tbaa !7
  store double %87, ptr %64, align 8, !tbaa !7
  %88 = icmp eq i64 %54, 64
  br i1 %88, label %89, label %47, !llvm.loop !11
...
89:                                               ; preds = %47
  ...
  %101 = load double, ptr %44, align 8, !tbaa !7
  %102 = load double, ptr %45, align 8, !tbaa !7
  ...
  store double %108, ptr %46, align 8, !tbaa !7
  %109 = load double, ptr %26, align 8, !tbaa !7
  %110 = load double, ptr %27, align 8, !tbaa !7
  ...
  %114 = load double, ptr %32, align 8, !tbaa !7
  ...
  %119 = load double, ptr %33, align 8, !tbaa !7
  ...
  store double %124, ptr %112, align 8, !tbaa !7
  %125 = load double, ptr %46, align 8, !tbaa !7
  store double %125, ptr %104, align 8, !tbaa !7
  br label %126
...
126:                                              ; preds = %126, %89
  ...
  store double %139, ptr %43, align 8, !tbaa !7
  %140 = load double, ptr %28, align 8, !tbaa !7
  %141 = load double, ptr %45, align 8, !tbaa !7
  ...
  store double %147, ptr %46, align 8, !tbaa !7
  ...
  %155 = load double, ptr %32, align 8, !tbaa !7
  ...
  store double %166, ptr %153, align 8, !tbaa !7
  %167 = load double, ptr %46, align 8, !tbaa !7
  store double %167, ptr %161, align 8, !tbaa !7
  %168 = icmp eq i64 %133, 64
  br i1 %168, label %169, label %126, !llvm.loop !13

169:                                              ; preds = %126
  %170 = load double, ptr %34, align 8, !tbaa !7
  %171 = load double, ptr %35, align 8, !tbaa !7
  %172 = fsub double %170, %171
  %173 = load double, ptr %36, align 8, !tbaa !7
  %174 = fadd double %172, %173
  %175 = load double, ptr %37, align 8, !tbaa !7
  %176 = fsub double %174, %175
  store double %176, ptr %43, align 8, !tbaa !7
  %177 = load double, ptr %28, align 8, !tbaa !7
  %178 = load double, ptr %29, align 8, !tbaa !7
  %179 = fdiv double %177, %178
  %180 = load double, ptr %38, align 8, !tbaa !7
  %181 = fdiv double %25, %178
  %182 = fmul double %176, %181
  %183 = tail call double @llvm.fmuladd.f64(double %179, double %180, double %182)
  store double %183, ptr %46, align 8, !tbaa !7
  %184 = load double, ptr %26, align 8, !tbaa !7
  %185 = load double, ptr %27, align 8, !tbaa !7
  %186 = fdiv double %184, %185
  %187 = load double, ptr %39, align 8, !tbaa !7
  ...
  %193 = load double, ptr %33, align 8, !tbaa !7
  %194 = load double, ptr %38, align 8, !tbaa !7
  %195 = fneg double %193
  %196 = fmul double %23, %195
  %197 = fdiv double %196, %185
  %198 = tail call double @llvm.fmuladd.f64(double %197, double %194, double %192)
  store double %198, ptr %39, align 8, !tbaa !7
  %199 = load double, ptr %46, align 8, !tbaa !7
  store double %199, ptr %38, align 8, !tbaa !7
  %200 = icmp eq i64 %42, 64
  br i1 %200, label %201, label %40, !llvm.loop !14

201:                                              ; preds = %169
  %202 = add nuw nsw i64 %31, 1
  %203 = icmp eq i64 %202, 64
  br i1 %203, label %204, label %30, !llvm.loop !15

204:                                              ; preds = %201
  call fastcc void @init_array(ptr noundef nonnull %3, ptr noundef nonnull %4, ptr noundef nonnull %5, ptr noundef nonnull %6, ptr noundef %14, ptr noundef %15, ptr noundef %16, ptr noundef nonnull %17, ptr noundef nonnull %18, ptr noundef nonnull %19, ptr noundef nonnull %20, ptr noundef nonnull %21, ptr noundef nonnull %22) #9
  %205 = load double, ptr %3, align 8, !tbaa !7
...
225:                                              ; preds = %225, %218
  ...
  store double %238, ptr %221, align 8, !tbaa !7
  %239 = load double, ptr %222, align 8, !tbaa !7
  %240 = load double, ptr %223, align 8, !tbaa !7
  ...
  store double %252, ptr %224, align 8, !tbaa !7
  ...
  %259 = load double, ptr %210, align 8, !tbaa !7
  %260 = fmul double %205, %259
  %261 = fdiv double %260, %256
  %262 = fmul double %252, %261
  %263 = load double, ptr %211, align 8, !tbaa !7
  %264 = fmul double %205, %263
  %265 = load double, ptr %241, align 8, !tbaa !7
  ...
  store double %277, ptr %257, align 8, !tbaa !7
  %278 = load double, ptr %224, align 8, !tbaa !7
  store double %278, ptr %241, align 8, !tbaa !7
  %279 = icmp eq i64 %232, 64
  br i1 %279, label %280, label %225, !llvm.loop !16
...
280:                                              ; preds = %225
  ...
  store double %291, ptr %221, align 8, !tbaa !7
  %292 = load double, ptr %222, align 8, !tbaa !7
  %293 = load double, ptr %223, align 8, !tbaa !7
  ...
  store double %305, ptr %224, align 8, !tbaa !7
  %306 = load double, ptr %26, align 8, !tbaa !7
  %307 = load double, ptr %27, align 8, !tbaa !7
  %308 = getelementptr inbounds [65 x [65 x double]], ptr %16, i64 %209, i64 %219, i64 64
  %309 = load double, ptr %308, align 8, !tbaa !7
  %310 = load double, ptr %210, align 8, !tbaa !7
  %311 = fmul double %205, %310
  %312 = fdiv double %311, %307
  %313 = fmul double %305, %312
  %314 = load double, ptr %211, align 8, !tbaa !7
  %315 = fmul double %205, %314
  %316 = load double, ptr %294, align 8, !tbaa !7
  ...
  %326 = fadd double %313, %325
  %327 = extractelement <2 x double> %324, i64 1
  %328 = fsub double %326, %327
  store double %328, ptr %308, align 8, !tbaa !7
  %329 = load double, ptr %224, align 8, !tbaa !7
  store double %329, ptr %294, align 8, !tbaa !7
  br label %330
...
330:                                              ; preds = %330, %280
  ...
  store double %343, ptr %221, align 8, !tbaa !7
  %344 = load double, ptr %28, align 8, !tbaa !7
  %345 = load double, ptr %223, align 8, !tbaa !7
  ...
  store double %357, ptr %224, align 8, !tbaa !7
  ...
  %364 = load double, ptr %210, align 8, !tbaa !7
  %365 = fmul double %205, %364
  %366 = fdiv double %365, %361
  %367 = fmul double %357, %366
  %368 = load double, ptr %211, align 8, !tbaa !7
  ...
  store double %383, ptr %362, align 8, !tbaa !7
  %384 = load double, ptr %224, align 8, !tbaa !7
  store double %384, ptr %370, align 8, !tbaa !7
  %385 = icmp eq i64 %337, 64
  br i1 %385, label %386, label %330, !llvm.loop !17

386:                                              ; preds = %330
  %387 = load double, ptr %212, align 8, !tbaa !7
  %388 = load double, ptr %213, align 8, !tbaa !7
  %389 = fsub double %387, %388
  %390 = load double, ptr %214, align 8, !tbaa !7
  %391 = fadd double %389, %390
  %392 = load double, ptr %215, align 8, !tbaa !7
  %393 = fsub double %391, %392
  store double %393, ptr %221, align 8, !tbaa !7
  %394 = load double, ptr %28, align 8, !tbaa !7
  %395 = load double, ptr %29, align 8, !tbaa !7
  %396 = load double, ptr %216, align 8, !tbaa !7
  ...
  store double %406, ptr %224, align 8, !tbaa !7
  %407 = load double, ptr %26, align 8, !tbaa !7
  %408 = load double, ptr %27, align 8, !tbaa !7
  %409 = load double, ptr %217, align 8, !tbaa !7
  %410 = load double, ptr %210, align 8, !tbaa !7
  %411 = fmul double %205, %410
  %412 = fdiv double %411, %408
  %413 = fmul double %406, %412
  %414 = load double, ptr %211, align 8, !tbaa !7
  %415 = fmul double %205, %414
  %416 = load double, ptr %216, align 8, !tbaa !7
  ...
  %426 = fadd double %413, %425
  %427 = extractelement <2 x double> %424, i64 1
  %428 = fsub double %426, %427
  store double %428, ptr %217, align 8, !tbaa !7
  %429 = load double, ptr %224, align 8, !tbaa !7
  store double %429, ptr %216, align 8, !tbaa !7
  %430 = icmp eq i64 %220, 64
  br i1 %430, label %431, label %218, !llvm.loop !18

431:                                              ; preds = %386
  %432 = add nuw nsw i64 %209, 1
  %433 = icmp eq i64 %432, 64
  br i1 %433, label %434, label %208, !llvm.loop !19
...
447:                                              ; preds = %438
  ...
  %451 = load ptr, ptr @stderr, align 8, !tbaa !20
  %452 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %451, ptr noundef nonnull @.str.2, i32 noundef %448, i32 noundef %449, i32 noundef %450, double noundef %.lcssa32, i32 noundef %448, i32 noundef %449, i32 noundef %450, double noundef %.lcssa30, double noundef 1.000000e-05) #10
  br label %588
...
475:                                              ; preds = %466
  ...
  %479 = load ptr, ptr @stderr, align 8, !tbaa !20
  %480 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %479, ptr noundef nonnull @.str.2, i32 noundef %476, i32 noundef %477, i32 noundef %478, double noundef %.lcssa22, i32 noundef %476, i32 noundef %477, i32 noundef %478, double noundef %.lcssa20, double noundef 1.000000e-05) #10
  br label %588
...
503:                                              ; preds = %494
  ...
  %507 = load ptr, ptr @stderr, align 8, !tbaa !20
  %508 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %507, ptr noundef nonnull @.str.2, i32 noundef %504, i32 noundef %505, i32 noundef %506, double noundef %.lcssa12, i32 noundef %504, i32 noundef %505, i32 noundef %506, double noundef %.lcssa10, double noundef 1.000000e-05) #10
  br label %588
...
531:                                              ; preds = %522
  ...
  %536 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %535, ptr noundef nonnull @.str.2, i32 noundef %532, i32 noundef %533, i32 noundef %534, double noundef %.lcssa2, i32 noundef %532, i32 noundef %533, i32 noundef %534, double noundef %.lcssa, double noundef 1.000000e-05) #10
  br label %588
...
555:                                              ; preds = %576, %549
  ...
  %557 = load ptr, ptr @stderr, align 8, !tbaa !20
  %558 = getelementptr inbounds [65 x [65 x double]], ptr %13, i64 %547, i64 %550, i64 %556
  %559 = load double, ptr %558, align 8, !tbaa !7
  %560 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %557, ptr noundef nonnull @.str.3, double noundef %559) #10
  %561 = load ptr, ptr @stderr, align 8, !tbaa !20
  %562 = getelementptr inbounds [65 x [65 x double]], ptr %14, i64 %547, i64 %550, i64 %556
  %563 = load double, ptr %562, align 8, !tbaa !7
  %564 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %561, ptr noundef nonnull @.str.3, double noundef %563) #10
  %565 = load ptr, ptr @stderr, align 8, !tbaa !20
  %566 = getelementptr inbounds [65 x [65 x double]], ptr %15, i64 %547, i64 %550, i64 %556
  %567 = load double, ptr %566, align 8, !tbaa !7
  %568 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %565, ptr noundef nonnull @.str.3, double noundef %567) #10
  %569 = load ptr, ptr @stderr, align 8, !tbaa !20
  %570 = getelementptr inbounds [65 x [65 x double]], ptr %16, i64 %547, i64 %550, i64 %556
  %571 = load double, ptr %570, align 8, !tbaa !7
  %572 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %569, ptr noundef nonnull @.str.3, double noundef %571) #10
...
define internal fastcc void @init_array(ptr nocapture noundef writeonly %0, ptr nocapture noundef writeonly %1, ptr nocapture noundef writeonly %2, ptr nocapture noundef writeonly %3, ptr nocapture noundef writeonly %4, ptr nocapture noundef writeonly %5, ptr nocapture noundef writeonly %6, ptr nocapture noundef writeonly %7, ptr nocapture noundef writeonly %8, ptr nocapture noundef writeonly %9, ptr nocapture noundef writeonly %10, ptr nocapture noundef writeonly %11, ptr nocapture noundef writeonly %12) unnamed_addr #2 {
  store double 2.341000e+03, ptr %0, align 8, !tbaa !7
  store double 4.200000e+01, ptr %1, align 8, !tbaa !7
  br label %14
...
54:                                               ; preds = %81
  ...
  br i1 %55, label %99, label %56, !llvm.loop !31
...
81:                                               ; preds = %81, %56
  %82 = phi i64 [ 0, %56 ], [ %97, %81 ]
  %83 = trunc i64 %82 to i32
  %84 = sitofp i32 %83 to double
  %85 = fadd double %74, %84
  %86 = fadd double %85, 1.000000e+00
  %87 = fmul double %86, 1.562500e-02
  %88 = getelementptr inbounds [65 x [65 x double]], ptr %4, i64 %51, i64 %57, i64 %82
  store double %87, ptr %88, align 8, !tbaa !7
  %89 = fadd double %77, %84
  %90 = fadd double %89, 2.000000e+00
  %91 = fmul double %90, 1.562500e-02
  %92 = getelementptr inbounds [65 x [65 x double]], ptr %5, i64 %51, i64 %57, i64 %82
  store double %91, ptr %92, align 8, !tbaa !7
  %93 = fadd double %80, %84
  %94 = fadd double %93, 3.000000e+00
  %95 = fmul double %94, 1.562500e-02
  %96 = getelementptr inbounds [65 x [65 x double]], ptr %6, i64 %51, i64 %57, i64 %82
  store double %95, ptr %96, align 8, !tbaa !7
  %97 = add nuw nsw i64 %82, 1
  %98 = icmp eq i64 %97, 65
  br i1 %98, label %54, label %81, !llvm.loop !32

99:                                               ; preds = %54
  %100 = add nuw nsw i64 %51, 1
  %101 = icmp eq i64 %100, 65
  br i1 %101, label %102, label %50, !llvm.loop !33
...
attributes #2 = { nofree norecurse nosync nounwind optsize memory(argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
