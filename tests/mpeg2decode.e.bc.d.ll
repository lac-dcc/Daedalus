...
3:                                                ; preds = %1
  %4 = tail call i32 @Get_Bits(i32 noundef 12) #33
  store i32 %4, ptr @horizontal_size, align 4, !tbaa !7
  %5 = tail call i32 @Get_Bits(i32 noundef 12) #33
  store i32 %5, ptr @vertical_size, align 4, !tbaa !7
  %6 = tail call i32 @Get_Bits(i32 noundef 4) #33
  store i32 %6, ptr @aspect_ratio_information, align 4, !tbaa !7
  %7 = tail call i32 @Get_Bits(i32 noundef 4) #33
  store i32 %7, ptr @frame_rate_code, align 4, !tbaa !7
  %8 = tail call i32 @Get_Bits(i32 noundef 18) #33
  store i32 %8, ptr @bit_rate_value, align 4, !tbaa !7
  %9 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %10 = tail call i32 @Get_Bits(i32 noundef 10) #33
  store i32 %10, ptr @vbv_buffer_size, align 4, !tbaa !7
  %11 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %11, ptr @constrained_parameters_flag, align 4, !tbaa !7
  %12 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
16:                                               ; preds = %16, %3
  ...
  %18 = tail call i32 @Get_Bits(i32 noundef 8) #33
...
34:                                               ; preds = %26, %16
  %35 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
44:                                               ; preds = %44, %34
  ...
  %46 = tail call i32 @Get_Bits(i32 noundef 8) #33
...
66:                                               ; preds = %56
  tail call fastcc void @extension_and_user_data() #32
  br label %140
...
73:                                               ; preds = %70, %67
  %74 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %74, ptr @drop_flag, align 4, !tbaa !7
  %75 = tail call i32 @Get_Bits(i32 noundef 5) #33
  store i32 %75, ptr @hour, align 4, !tbaa !7
  %76 = tail call i32 @Get_Bits(i32 noundef 6) #33
  store i32 %76, ptr @minute, align 4, !tbaa !7
  %77 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %78 = tail call i32 @Get_Bits(i32 noundef 6) #33
  store i32 %78, ptr @sec, align 4, !tbaa !7
  %79 = tail call i32 @Get_Bits(i32 noundef 6) #33
  store i32 %79, ptr @frame, align 4, !tbaa !7
  %80 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %80, ptr @closed_gop, align 4, !tbaa !7
  %81 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
82:                                               ; preds = %1
  ...
  %85 = tail call i32 @Get_Bits(i32 noundef 10) #33
  store i32 %85, ptr @temporal_reference, align 4, !tbaa !7
  %86 = tail call i32 @Get_Bits(i32 noundef 3) #33
  store i32 %86, ptr @picture_coding_type, align 4, !tbaa !7
  %87 = tail call i32 @Get_Bits(i32 noundef 16) #33
...
91:                                               ; preds = %82
  %92 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %92, ptr @full_pel_forward_vector, align 4, !tbaa !7
  %93 = tail call i32 @Get_Bits(i32 noundef 3) #33
...
98:                                               ; preds = %95
  %99 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %99, ptr @full_pel_backward_vector, align 4, !tbaa !7
  %100 = tail call i32 @Get_Bits(i32 noundef 3) #33
  store i32 %100, ptr @backward_f_code, align 4, !tbaa !7
  br label %101

101:                                              ; preds = %98, %95
  tail call fastcc void @extra_bit_information() #32
  tail call fastcc void @extension_and_user_data() #32
...
141:                                              ; preds = %137
  ...
  %143 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %142, ptr noundef nonnull @.str, i32 noundef %2) #34
  br label %140
...
5:                                                ; preds = %5, %0
  %6 = phi i32 [ %4, %0 ], [ 8, %5 ]
  tail call void @Flush_Buffer(i32 noundef %6) #33
  %7 = tail call i32 @Show_Bits(i32 noundef 24) #33
  %8 = icmp eq i32 %7, 1
...
1:                                                ; preds = %276, %0
  tail call void @next_start_code() #32
  %2 = tail call i32 @Show_Bits(i32 noundef 32) #33
...
3:                                                ; preds = %1
  tail call void @Flush_Buffer32() #33
  %4 = tail call i32 @Get_Bits(i32 noundef 4) #33
...
5:                                                ; preds = %3
  ...
  %9 = tail call i32 @Get_Bits(i32 noundef 8) #33
  store i32 %9, ptr @profile_and_level_indication, align 4, !tbaa !7
  %10 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %10, ptr @progressive_sequence, align 4, !tbaa !7
  %11 = tail call i32 @Get_Bits(i32 noundef 2) #33
  store i32 %11, ptr @chroma_format, align 4, !tbaa !7
  %12 = tail call i32 @Get_Bits(i32 noundef 2) #33
  %13 = tail call i32 @Get_Bits(i32 noundef 2) #33
  %14 = tail call i32 @Get_Bits(i32 noundef 12) #33
  %15 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %16 = tail call i32 @Get_Bits(i32 noundef 8) #33
  %17 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %17, ptr @low_delay, align 4, !tbaa !7
  %18 = tail call i32 @Get_Bits(i32 noundef 2) #33
  store i32 %18, ptr @frame_rate_extension_n, align 4, !tbaa !7
  %19 = tail call i32 @Get_Bits(i32 noundef 5) #33
...
59:                                               ; preds = %3
  %60 = tail call i32 @Get_Bits(i32 noundef 3) #33
  store i32 %60, ptr @video_format, align 4, !tbaa !7
  %61 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %61, ptr @color_description, align 4, !tbaa !7
  %62 = icmp eq i32 %61, 0
  br i1 %62, label %67, label %63

63:                                               ; preds = %59
  %64 = tail call i32 @Get_Bits(i32 noundef 8) #33
  store i32 %64, ptr @color_primaries, align 4, !tbaa !7
  %65 = tail call i32 @Get_Bits(i32 noundef 8) #33
  store i32 %65, ptr @transfer_characteristics, align 4, !tbaa !7
  %66 = tail call i32 @Get_Bits(i32 noundef 8) #33
  store i32 %66, ptr @matrix_coefficients, align 4, !tbaa !7
  br label %67

67:                                               ; preds = %63, %59
  %68 = tail call i32 @Get_Bits(i32 noundef 14) #33
  store i32 %68, ptr @display_horizontal_size, align 4, !tbaa !7
  %69 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %70 = tail call i32 @Get_Bits(i32 noundef 14) #33
  store i32 %70, ptr @display_vertical_size, align 4, !tbaa !7
  br label %276

71:                                               ; preds = %3
  %72 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
76:                                               ; preds = %76, %71
  ...
  %78 = tail call i32 @Get_Bits(i32 noundef 8) #33
...
89:                                               ; preds = %76, %71
  %90 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
94:                                               ; preds = %94, %89
  ...
  %96 = tail call i32 @Get_Bits(i32 noundef 8) #33
...
107:                                              ; preds = %94, %89
  %108 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
112:                                              ; preds = %112, %107
  ...
  %114 = tail call i32 @Get_Bits(i32 noundef 8) #33
...
122:                                              ; preds = %112, %107
  %123 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
127:                                              ; preds = %127, %122
  ...
  %129 = tail call i32 @Get_Bits(i32 noundef 8) #33
...
137:                                              ; preds = %3
  %138 = tail call i32 @Get_Bits(i32 noundef 2) #33
  %139 = add i32 %138, 1
  ...
  %142 = tail call i32 @Get_Bits(i32 noundef 4) #33
...
161:                                              ; preds = %158
  tail call void @Error(ptr noundef nonnull @.str.6) #33
  br label %276
...
191:                                              ; preds = %3
  ...
  %204 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %204, ptr @intra_vlc_format, align 4, !tbaa !7
  %205 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
219:                                              ; preds = %3
  ...
  %222 = tail call i32 @Get_Bits(i32 noundef 10) #33
  store i32 %222, ptr @lower_layer_temporal_reference, align 4, !tbaa !7
  %223 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %224 = tail call i32 @Get_Bits(i32 noundef 15) #33
  ...
  %228 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %229 = tail call i32 @Get_Bits(i32 noundef 15) #33
...
237:                                              ; preds = %3
  ...
  %241 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %241, ptr @copyright_flag, align 4, !tbaa !7
  %242 = tail call i32 @Get_Bits(i32 noundef 8) #33
  store i32 %242, ptr @copyright_identifier, align 4, !tbaa !7
  %243 = tail call i32 @Get_Bits(i32 noundef 1) #33
  store i32 %243, ptr @original_or_copy, align 4, !tbaa !7
  %244 = tail call i32 @Get_Bits(i32 noundef 7) #33
  %245 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %246 = tail call i32 @Get_Bits(i32 noundef 20) #33
  store i32 %246, ptr @copyright_number_1, align 4, !tbaa !7
  %247 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %248 = tail call i32 @Get_Bits(i32 noundef 22) #33
  store i32 %248, ptr @copyright_number_2, align 4, !tbaa !7
  %249 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %250 = tail call i32 @Get_Bits(i32 noundef 22) #33
...
253:                                              ; preds = %237
  ...
  %256 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.15, i32 noundef %255) #32
...
259:                                              ; preds = %253
  ...
  %261 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.16, i32 noundef %260) #32
  %262 = load i32, ptr @copyright_identifier, align 4, !tbaa !7
  %263 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.17, i32 noundef %262) #32
  %264 = load i32, ptr @original_or_copy, align 4, !tbaa !7
  %265 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.18, i32 noundef %264) #32
  %266 = load i32, ptr @copyright_number_1, align 4, !tbaa !7
  %267 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.19, i32 noundef %266) #32
  %268 = load i32, ptr @copyright_number_2, align 4, !tbaa !7
  %269 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.20, i32 noundef %268) #32
  %270 = load i32, ptr @copyright_number_3, align 4, !tbaa !7
  %271 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.21, i32 noundef %270) #32
  br label %276

272:                                              ; preds = %3
  %273 = load ptr, ptr @stderr, align 8, !tbaa !11
  %274 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %273, ptr noundef nonnull @.str.2, i32 noundef %4) #34
  br label %276
...
1:                                                ; preds = %4, %0
  %2 = tail call i32 @Get_Bits1() #33
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %5, label %4

4:                                                ; preds = %1
  tail call void @Flush_Buffer(i32 noundef 8) #33
...
8:                                                ; preds = %0
  %9 = tail call i32 @Get_Bits(i32 noundef 3) #33
...
17:                                               ; preds = %11
  %18 = tail call i32 @Get_Bits(i32 noundef 7) #33
  %19 = load ptr, ptr @ld, align 8, !tbaa !11
...
21:                                               ; preds = %17, %11
  %22 = tail call i32 @Get_Bits(i32 noundef 5) #33
...
38:                                               ; preds = %36, %31, %21
  ...
  %41 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %42 = icmp eq i32 %41, 0
  br i1 %42, label %49, label %43

43:                                               ; preds = %38
  %44 = tail call i32 @Get_Bits(i32 noundef 1) #33
  ...
  %47 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %48 = tail call i32 @Get_Bits(i32 noundef 6) #33
  tail call fastcc void @extra_bit_information() #32
  br label %52
...
define internal void @marker_bit(ptr nocapture noundef readnone %0) #0 {
  %2 = tail call i32 @Get_Bits(i32 noundef 1) #33
  ret void
}
...
4:                                                ; preds = %2
  %5 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6.5, ptr noundef nonnull @Version, ptr noundef nonnull @Author) #32
  %6 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7) #32
...
27:                                               ; preds = %20
  %28 = tail call ptr @__ctype_toupper_loc() #36
...
71:                                               ; preds = %27
  ...
  %73 = tail call i32 @atoi(ptr nocapture noundef nonnull %72) #37
...
104:                                              ; preds = %27
  ...
  %107 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %106, ptr noundef nonnull @.str.18.6, i32 noundef %105) #34
  tail call void @exit(i32 noundef -1) #35
  unreachable
...
127:                                              ; preds = %126, %117
  ...
  %129 = tail call i32 (ptr, i32, ...) @open(ptr noundef %128, i32 noundef 0) #33
...
131:                                              ; preds = %127
  ...
  %134 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %132, ptr noundef nonnull @.str.12, ptr noundef %133) #34
  tail call void @exit(i32 noundef 1) #35
  unreachable
...
137:                                              ; preds = %135
  tail call void @Initialize_Buffer() #33
  %138 = tail call i32 @Show_Bits(i32 noundef 8) #33
...
140:                                              ; preds = %137
  ...
  %142 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %141, ptr noundef nonnull @Error_Text) #34
  tail call void @exit(i32 noundef 1) #35
  unreachable

143:                                              ; preds = %137
  tail call void @next_start_code() #33
  %144 = tail call i32 @Show_Bits(i32 noundef 32) #33
...
146:                                              ; preds = %143
  ...
  %148 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %147, ptr noundef nonnull @Error_Text) #34
  tail call void @exit(i32 noundef 1) #35
  unreachable

149:                                              ; preds = %145, %143
  %150 = load i32, ptr @base, align 8, !tbaa !53
  %151 = tail call i64 @lseek(i32 noundef %150, i64 noundef 0, i32 noundef 0) #33
  tail call void @Initialize_Buffer() #33
...
154:                                              ; preds = %149
  %155 = tail call i64 @lseek(i32 noundef %152, i64 noundef 0, i32 noundef 0) #33
  br label %156
...
159:                                              ; preds = %156
  ...
  %161 = tail call i32 (ptr, i32, ...) @open(ptr noundef %160, i32 noundef 0) #33
...
163:                                              ; preds = %159
  ...
  %165 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @Error_Text, ptr noundef nonnull dereferenceable(1) @.str.3, ptr noundef %164) #33
  %166 = load ptr, ptr @stderr, align 8, !tbaa !11
  %167 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %166, ptr noundef nonnull @Error_Text) #34
  tail call void @exit(i32 noundef 1) #35
  unreachable
...
169:                                              ; preds = %168, %156
  %170 = tail call noalias dereferenceable_or_null(1024) ptr @malloc(i64 noundef 1024) #38
...
172:                                              ; preds = %169
  ...
  %174 = tail call i64 @fwrite(ptr nonnull @.str.5, i64 21, i64 1, ptr %173) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable
...
190:                                              ; preds = %187
  tail call void @Initialize_Reference_IDCT() #33
  br label %192

191:                                              ; preds = %187
  tail call void @Initialize_Fast_IDCT() #33
  br label %192

192:                                              ; preds = %359, %362, %190, %191
  %193 = phi i32 [ 0, %191 ], [ 0, %190 ], [ %.lcssa, %362 ], [ %.lcssa, %359 ]
  %194 = tail call fastcc i32 @Headers() #32
  %195 = icmp eq i32 %194, 1
  br i1 %195, label %196, label %364

196:                                              ; preds = %192
  %197 = load i32, ptr @Two_Streams, align 4, !tbaa !7
  %198 = icmp ne i32 %197, 0
  %199 = load i32, ptr getelementptr inbounds (%struct.layer_data, ptr @enhan, i64 0, i32 17), align 4
  %200 = icmp ne i32 %199, 3
  %201 = select i1 %198, i1 %200, i1 false
  %202 = load i32, ptr getelementptr inbounds (%struct.layer_data, ptr @base, i64 0, i32 17), align 4
...
205:                                              ; preds = %196
  ...
  %207 = tail call i64 @fwrite(ptr nonnull @.str.21.14, i64 29, i64 1, ptr %206) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable

208:                                              ; preds = %196
  %209 = load i32, ptr getelementptr inbounds (%struct.layer_data, ptr @base, i64 0, i32 16), align 8, !tbaa !28
...
211:                                              ; preds = %208
  ...
  %212 = call i32 @_wyvern_slice_main__326851271()
  store i32 %212, ptr @mb_width, align 4, !tbaa !7
  br label %222

213:                                              ; preds = %208
  %214 = load i32, ptr @progressive_sequence, align 4
  %215 = icmp eq i32 %214, 0
  %216 = call i32 @_wyvern_slice_main__326851271()
  store i32 %216, ptr @mb_width, align 4, !tbaa !7
  br i1 %215, label %217, label %222

217:                                              ; preds = %213
  %218 = load i32, ptr @vertical_size, align 4, !tbaa !7
...
222:                                              ; preds = %213, %211
  %223 = phi i32 [ %212, %211 ], [ %216, %213 ]
  %224 = load i32, ptr @vertical_size, align 4, !tbaa !7
  %225 = add nsw i32 %224, 15
  %226 = sdiv i32 %225, 16
  br label %227

227:                                              ; preds = %222, %217
  %228 = phi i32 [ %216, %217 ], [ %223, %222 ]
  %229 = phi i32 [ %221, %217 ], [ %226, %222 ]
  store i32 %229, ptr @mb_height, align 4, !tbaa !7
  %230 = shl nsw i32 %228, 4
  store i32 %230, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %231 = shl nsw i32 %229, 4
  store i32 %231, ptr @Coded_Picture_Height, align 4, !tbaa !7
  %232 = load i32, ptr @chroma_format, align 4, !tbaa !7
  %233 = icmp eq i32 %232, 3
  %234 = shl nsw i32 %228, 3
  %235 = select i1 %233, i32 %230, i32 %234
  store i32 %235, ptr @Chroma_Width, align 4, !tbaa !7
  %236 = icmp eq i32 %232, 1
  %237 = zext i1 %236 to i32
  %238 = ashr i32 %231, %237
  store i32 %238, ptr @Chroma_Height, align 4, !tbaa !7
  %239 = add nsw i32 %232, -1
  %240 = sext i32 %239 to i64
  %241 = getelementptr inbounds [3 x i32], ptr @Initialize_Sequence.Table_6_20, i64 0, i64 %240
  %242 = load i32, ptr %241, align 4, !tbaa !7
  store i32 %242, ptr @block_count, align 4, !tbaa !7
  %243 = mul nsw i32 %231, %230
  %244 = mul nsw i32 %238, %235
  %245 = load i32, ptr @Ersatz_Flag, align 4
  %246 = icmp eq i32 %245, 0
  %247 = icmp eq i32 %202, 2
  %248 = load i32, ptr @lower_layer_prediction_horizontal_size, align 4
  %249 = load i32, ptr @lower_layer_prediction_vertical_size, align 4
  %250 = mul nsw i32 %249, %248
  br label %251

251:                                              ; preds = %302, %305, %227
  %252 = phi i64 [ 0, %227 ], [ %303, %302 ], [ %306, %305 ]
  %253 = icmp eq i64 %252, 0
  %254 = select i1 %253, i32 %243, i32 %244
  %255 = sext i32 %254 to i64
  %256 = tail call noalias ptr @malloc(i64 noundef %255) #38
  %257 = getelementptr inbounds [3 x ptr], ptr @backward_reference_frame, i64 0, i64 %252
  store ptr %256, ptr %257, align 8, !tbaa !11
  %258 = icmp eq ptr %256, null
  br i1 %258, label %259, label %262

259:                                              ; preds = %251
  %260 = load ptr, ptr @stderr, align 8, !tbaa !11
  %261 = tail call i64 @fwrite(ptr nonnull @.str.22, i64 41, i64 1, ptr %260) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable

262:                                              ; preds = %251
  %263 = tail call noalias ptr @malloc(i64 noundef %255) #38
  %264 = getelementptr inbounds [3 x ptr], ptr @forward_reference_frame, i64 0, i64 %252
  store ptr %263, ptr %264, align 8, !tbaa !11
  %265 = icmp eq ptr %263, null
  br i1 %265, label %266, label %269

266:                                              ; preds = %262
  %267 = load ptr, ptr @stderr, align 8, !tbaa !11
  %268 = tail call i64 @fwrite(ptr nonnull @.str.23, i64 40, i64 1, ptr %267) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable

269:                                              ; preds = %262
  %270 = tail call noalias ptr @malloc(i64 noundef %255) #38
  %271 = getelementptr inbounds [3 x ptr], ptr @auxframe, i64 0, i64 %252
...
273:                                              ; preds = %269
  ...
  %275 = tail call i64 @fwrite(ptr nonnull @.str.24, i64 25, i64 1, ptr %274) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable

276:                                              ; preds = %269
  br i1 %246, label %284, label %277

277:                                              ; preds = %276
  %278 = tail call noalias ptr @malloc(i64 noundef %255) #38
  %279 = getelementptr inbounds [3 x ptr], ptr @substitute_frame, i64 0, i64 %252
...
281:                                              ; preds = %277
  ...
  %283 = tail call i64 @fwrite(ptr nonnull @.str.25, i64 33, i64 1, ptr %282) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable

284:                                              ; preds = %277, %276
  br i1 %247, label %285, label %305

285:                                              ; preds = %284
  %286 = select i1 %253, i32 1, i32 4
  %287 = sdiv i32 %250, %286
  %288 = sext i32 %287 to i64
  %289 = tail call noalias ptr @malloc(i64 noundef %288) #38
  %290 = getelementptr inbounds [3 x ptr], ptr @llframe0, i64 0, i64 %252
...
292:                                              ; preds = %285
  ...
  %294 = tail call i64 @fwrite(ptr nonnull @.str.26, i64 23, i64 1, ptr %293) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable

295:                                              ; preds = %285
  %296 = tail call noalias ptr @malloc(i64 noundef %288) #38
  %297 = getelementptr inbounds [3 x ptr], ptr @llframe1, i64 0, i64 %252
...
299:                                              ; preds = %295
  ...
  %301 = tail call i64 @fwrite(ptr nonnull @.str.27, i64 23, i64 1, ptr %300) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable

302:                                              ; preds = %295
  %303 = add nuw nsw i64 %252, 1
  %304 = icmp eq i64 %303, 3
  br i1 %304, label %308, label %251, !llvm.loop !55

305:                                              ; preds = %284
  %306 = add nuw nsw i64 %252, 1
  %307 = icmp eq i64 %306, 3
  br i1 %307, label %321, label %251, !llvm.loop !55

308:                                              ; preds = %302
  %309 = load i32, ptr @vertical_subsampling_factor_n, align 4, !tbaa !7
  %310 = mul nsw i32 %309, %249
  %311 = load i32, ptr @vertical_subsampling_factor_m, align 4, !tbaa !7
  %312 = sdiv i32 %310, %311
  %313 = mul nsw i32 %312, %248
  %314 = sext i32 %313 to i64
  %315 = shl nsw i64 %314, 1
  %316 = tail call noalias ptr @malloc(i64 noundef %315) #38
  store ptr %316, ptr @lltmp, align 8, !tbaa !11
  %317 = icmp eq ptr %316, null
  br i1 %317, label %318, label %321

318:                                              ; preds = %308
  %319 = load ptr, ptr @stderr, align 8, !tbaa !11
  %320 = tail call i64 @fwrite(ptr nonnull @.str.28, i64 20, i64 1, ptr %319) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable

321:                                              ; preds = %308, %305
  tail call void @Decode_Picture(i32 noundef %193, i32 noundef 0) #33
  %322 = load i32, ptr @Second_Field, align 4, !tbaa !7
  %323 = icmp eq i32 %322, 0
  %324 = zext i1 %323 to i32
  %325 = add nsw i32 %193, %324
  br label %326

326:                                              ; preds = %331, %321
  %327 = phi i32 [ %324, %321 ], [ %335, %331 ]
  %328 = phi i32 [ %325, %321 ], [ %336, %331 ]
  %329 = tail call fastcc i32 @Headers() #32
  %330 = icmp eq i32 %329, 0
  br i1 %330, label %337, label %331

331:                                              ; preds = %326
  tail call void @Decode_Picture(i32 noundef %328, i32 noundef %327) #33
  %332 = load i32, ptr @Second_Field, align 4, !tbaa !7
  %333 = icmp eq i32 %332, 0
  %334 = zext i1 %333 to i32
  %335 = add nuw nsw i32 %327, %334
  %336 = add nsw i32 %328, %334
  br label %326, !llvm.loop !56

337:                                              ; preds = %326
  %.lcssa1 = phi i32 [ %327, %326 ]
  %.lcssa = phi i32 [ %328, %326 ]
  %338 = icmp eq i32 %.lcssa1, 0
  br i1 %338, label %340, label %339

339:                                              ; preds = %337
  tail call void @Output_Last_Frame_of_Sequence(i32 noundef %.lcssa) #33
  br label %340
...
341:                                              ; preds = %356, %340
  %342 = phi i64 [ 0, %340 ], [ %357, %356 ]
  %343 = getelementptr inbounds [3 x ptr], ptr @backward_reference_frame, i64 0, i64 %342
  %344 = load ptr, ptr %343, align 8, !tbaa !11
  tail call void @free(ptr noundef %344) #33
  %345 = getelementptr inbounds [3 x ptr], ptr @forward_reference_frame, i64 0, i64 %342
  %346 = load ptr, ptr %345, align 8, !tbaa !11
  tail call void @free(ptr noundef %346) #33
  %347 = getelementptr inbounds [3 x ptr], ptr @auxframe, i64 0, i64 %342
  %348 = load ptr, ptr %347, align 8, !tbaa !11
  tail call void @free(ptr noundef %348) #33
  %349 = load i32, ptr getelementptr inbounds (%struct.layer_data, ptr @base, i64 0, i32 17), align 4, !tbaa !29
  %350 = icmp eq i32 %349, 2
  br i1 %350, label %351, label %356

351:                                              ; preds = %341
  %352 = getelementptr inbounds [3 x ptr], ptr @llframe0, i64 0, i64 %342
  %353 = load ptr, ptr %352, align 8, !tbaa !11
  tail call void @free(ptr noundef %353) #33
  %354 = getelementptr inbounds [3 x ptr], ptr @llframe1, i64 0, i64 %342
  %355 = load ptr, ptr %354, align 8, !tbaa !11
  tail call void @free(ptr noundef %355) #33
  br label %356

356:                                              ; preds = %351, %341
  %357 = add nuw nsw i64 %342, 1
  %358 = icmp eq i64 %357, 3
  br i1 %358, label %359, label %341, !llvm.loop !57

359:                                              ; preds = %356
  %360 = load i32, ptr getelementptr inbounds (%struct.layer_data, ptr @base, i64 0, i32 17), align 4, !tbaa !29
  %361 = icmp eq i32 %360, 2
  br i1 %361, label %362, label %192

362:                                              ; preds = %359
  %363 = load ptr, ptr @lltmp, align 8, !tbaa !11
  tail call void @free(ptr noundef %363) #33
  br label %192

364:                                              ; preds = %192
  %365 = load i32, ptr @base, align 8, !tbaa !53
  %366 = tail call i32 @close(i32 noundef %365) #33
  %367 = load i32, ptr @Two_Streams, align 4, !tbaa !7
  %368 = icmp eq i32 %367, 0
  br i1 %368, label %372, label %369

369:                                              ; preds = %364
  %370 = load i32, ptr @enhan, align 8, !tbaa !53
  %371 = tail call i32 @close(i32 noundef %370) #33
  br label %372
...
10:                                               ; preds = %4
  ...
  %12 = tail call i64 @fwrite(ptr nonnull @.str.20.39, i64 20, i64 1, ptr %11) #39
  br label %13
...
define internal void @Error(ptr nocapture noundef readonly %0) #15 {
  ...
  %3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef %0) #34
  tail call void @exit(i32 noundef 1) #35
  unreachable
}
...
define internal void @Write_Frame(ptr nocapture noundef readonly %0, i32 noundef %1) #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %3) #40
...
13:                                               ; preds = %2
  %14 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(1) %12, i32 noundef %1, i32 noundef 102) #33
  %15 = load i32, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %16 = load i32, ptr @vertical_size, align 4, !tbaa !7
  call fastcc void @store_one(ptr noundef nonnull %3, ptr noundef %0, i32 noundef 0, i32 noundef %15, i32 noundef %16) #32
  br label %29

17:                                               ; preds = %2
  %18 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(1) %12, i32 noundef %1, i32 noundef 97) #33
  %19 = load i32, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %20 = shl i32 %19, 1
  %21 = load i32, ptr @vertical_size, align 4, !tbaa !7
  %22 = ashr i32 %21, 1
  call fastcc void @store_one(ptr noundef nonnull %3, ptr noundef %0, i32 noundef 0, i32 noundef %20, i32 noundef %22) #32
  %23 = load ptr, ptr @Output_Picture_Filename, align 8, !tbaa !11
  %24 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(1) %23, i32 noundef %1, i32 noundef 98) #33
  %25 = load i32, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %26 = shl i32 %25, 1
  %27 = load i32, ptr @vertical_size, align 4, !tbaa !7
  %28 = ashr i32 %27, 1
  call fastcc void @store_one(ptr noundef nonnull %3, ptr noundef %0, i32 noundef %25, i32 noundef %26, i32 noundef %28) #32
  br label %29

29:                                               ; preds = %17, %13
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %3) #40
  ret void
}
...
8:                                                ; preds = %5
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %6) #40
  %9 = load i32, ptr @horizontal_size, align 4, !tbaa !7
  %10 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(1) @.str.176, ptr noundef %0) #33
  %11 = load ptr, ptr %1, align 8, !tbaa !11
  call fastcc void @store_yuv1(ptr noundef nonnull %6, ptr noundef %11, i32 noundef %2, i32 noundef %3, i32 noundef %9, i32 noundef %4) #32
  ...
  %19 = zext i1 %18 to i32
  %20 = ashr i32 %4, %19
  %21 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(1) @.str.1.177, ptr noundef %0) #33
  %22 = getelementptr inbounds ptr, ptr %1, i64 1
  %23 = load ptr, ptr %22, align 8, !tbaa !11
  call fastcc void @store_yuv1(ptr noundef nonnull %6, ptr noundef %23, i32 noundef %15, i32 noundef %16, i32 noundef %17, i32 noundef %20) #32
  %24 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(1) @.str.2.178, ptr noundef %0) #33
  %25 = getelementptr inbounds ptr, ptr %1, i64 2
  %26 = load ptr, ptr %25, align 8, !tbaa !11
  call fastcc void @store_yuv1(ptr noundef nonnull %6, ptr noundef %26, i32 noundef %15, i32 noundef %16, i32 noundef %17, i32 noundef %20) #32
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %6) #40
  br label %181
...
30:                                               ; preds = %27
  tail call void @Error(ptr noundef nonnull @.str.5.179) #33
...
43:                                               ; preds = %40
  ...
  %49 = tail call noalias ptr @malloc(i64 noundef %48) #38
  store ptr %49, ptr @store_sif.u422, align 8, !tbaa !11
  %50 = icmp eq ptr %49, null
  br i1 %50, label %51, label %57

51:                                               ; preds = %43
  tail call void @Error(ptr noundef nonnull @.str.6.180) #33
...
57:                                               ; preds = %51, %43
  ...
  %59 = tail call noalias ptr @malloc(i64 noundef %58) #38
...
62:                                               ; preds = %61, %57, %40
  ...
  tail call fastcc void @conv420to422(ptr noundef %64, ptr noundef %65) #32
  %66 = getelementptr inbounds ptr, ptr %1, i64 2
  %67 = load ptr, ptr %66, align 8, !tbaa !11
  %68 = load ptr, ptr @store_sif.v422, align 8, !tbaa !11
  tail call fastcc void @conv420to422(ptr noundef %67, ptr noundef %68) #32
  br label %69
...
74:                                               ; preds = %69
  ...
  %76 = tail call ptr @strrchr(ptr noundef nonnull dereferenceable(1) %0, i32 noundef 47) #37
  %77 = icmp eq ptr %76, null
  %78 = getelementptr inbounds i8, ptr %76, i64 1
  %79 = select i1 %77, ptr %0, ptr %78
  %80 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %75, ptr noundef nonnull @.str.3.182, ptr noundef %79) #32
  br label %81

81:                                               ; preds = %74, %69
  %82 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %0, i32 noundef 577, i32 noundef 438) #33
  store i32 %82, ptr @outfile, align 4, !tbaa !7
  %83 = icmp eq i32 %82, -1
  br i1 %83, label %84, label %86

84:                                               ; preds = %81
  %85 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @Error_Text, ptr noundef nonnull dereferenceable(1) @.str.4, ptr noundef nonnull %0) #33
  tail call void @Error(ptr noundef nonnull @Error_Text) #33
  br label %86
...
128:                                              ; preds = %116
  ...
  %130 = tail call i64 @write(i32 noundef %129, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %131
...
137:                                              ; preds = %131
  ...
  %139 = tail call i64 @write(i32 noundef %138, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %140
...
146:                                              ; preds = %140
  ...
  %148 = tail call i64 @write(i32 noundef %147, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %149
...
155:                                              ; preds = %149
  ...
  %157 = tail call i64 @write(i32 noundef %156, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  store ptr @obfr, ptr @optr, align 8, !tbaa !11
  br label %158
...
171:                                              ; preds = %168
  ...
  %174 = tail call i64 @write(i32 noundef %170, ptr noundef nonnull @obfr, i64 noundef %173) #33
  %175 = load i32, ptr @outfile, align 4, !tbaa !7
  br label %176

176:                                              ; preds = %171, %168, %88
  %177 = phi i32 [ %175, %171 ], [ %170, %168 ], [ %89, %88 ]
  %178 = tail call i32 @close(i32 noundef %177) #33
  br label %181

179:                                              ; preds = %5
  tail call fastcc void @store_ppm_tga(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef 1) #32
  br label %181

180:                                              ; preds = %5
  tail call fastcc void @store_ppm_tga(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef 0) #32
  br label %181
...
9:                                                ; preds = %6
  ...
  %11 = tail call ptr @strrchr(ptr noundef nonnull dereferenceable(1) %0, i32 noundef 47) #37
  %12 = icmp eq ptr %11, null
  %13 = getelementptr inbounds i8, ptr %11, i64 1
  %14 = select i1 %12, ptr %0, ptr %13
  %15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %10, ptr noundef nonnull @.str.3.182, ptr noundef %14) #32
  br label %16

16:                                               ; preds = %9, %6
  %17 = tail call i32 (ptr, i32, ...) @open(ptr noundef %0, i32 noundef 577, i32 noundef 438) #33
  store i32 %17, ptr @outfile, align 4, !tbaa !7
  %18 = icmp eq i32 %17, -1
  br i1 %18, label %19, label %21

19:                                               ; preds = %16
  %20 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @Error_Text, ptr noundef nonnull dereferenceable(1) @.str.4, ptr noundef %0) #33
  tail call void @Error(ptr noundef nonnull @Error_Text) #33
  br label %21
...
45:                                               ; preds = %37
  ...
  %47 = tail call i64 @write(i32 noundef %46, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  store ptr @obfr, ptr @optr, align 8, !tbaa !11
  br label %48
...
59:                                               ; preds = %56
  ...
  %62 = tail call i64 @write(i32 noundef %58, ptr noundef nonnull @obfr, i64 noundef %61) #33
  %63 = load i32, ptr @outfile, align 4, !tbaa !7
  br label %64

64:                                               ; preds = %59, %56, %23
  %65 = phi i32 [ %63, %59 ], [ %58, %56 ], [ %24, %23 ]
  %66 = tail call i32 @close(i32 noundef %65) #33
  ret void
}
...
define internal fastcc void @store_ppm_tga(ptr noundef %0, ptr nocapture noundef readonly %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef %5) unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %7) #40
...
22:                                               ; preds = %18
  ...
  %26 = tail call noalias ptr @malloc(i64 noundef %25) #38
...
34:                                               ; preds = %28, %22
  ...
  %38 = tail call noalias ptr @malloc(i64 noundef %35) #38
...
43:                                               ; preds = %40, %34, %18
  ...
  %48 = tail call noalias ptr @malloc(i64 noundef %47) #38
...
50:                                               ; preds = %43
  tail call void @Error(ptr noundef nonnull @.str.6.180) #33
  %51 = call i32 @_wyvern_slice_Read_Frame__807793023()
  %52 = sext i32 %51 to i64
  br label %53

53:                                               ; preds = %50, %43
  %54 = phi i64 [ %52, %50 ], [ %47, %43 ]
  %55 = tail call noalias ptr @malloc(i64 noundef %54) #38
  store ptr %55, ptr @store_ppm_tga.v444, align 8, !tbaa !11
...
58:                                               ; preds = %57, %53
  %59 = load i32, ptr @chroma_format, align 4, !tbaa !7
  br label %60

60:                                               ; preds = %58, %15
  %61 = phi i32 [ %59, %58 ], [ %8, %15 ]
  %62 = icmp eq i32 %61, 1
  %63 = getelementptr inbounds ptr, ptr %1, i64 1
  %64 = load ptr, ptr %63, align 8, !tbaa !11
...
66:                                               ; preds = %60
  %67 = load ptr, ptr @store_ppm_tga.u422, align 8, !tbaa !11
  tail call fastcc void @conv420to422(ptr noundef %64, ptr noundef %67) #32
  %68 = load ptr, ptr %65, align 8, !tbaa !11
  %69 = load ptr, ptr @store_ppm_tga.v422, align 8, !tbaa !11
  tail call fastcc void @conv420to422(ptr noundef %68, ptr noundef %69) #32
  %70 = load ptr, ptr @store_ppm_tga.u444, align 8, !tbaa !11
  tail call fastcc void @conv422to444(ptr noundef %67, ptr noundef %70) #32
  %71 = load ptr, ptr @store_ppm_tga.v444, align 8, !tbaa !11
  tail call fastcc void @conv422to444(ptr noundef %69, ptr noundef %71) #32
  br label %76

72:                                               ; preds = %60
  %73 = load ptr, ptr @store_ppm_tga.u444, align 8, !tbaa !11
  tail call fastcc void @conv422to444(ptr noundef %64, ptr noundef %73) #32
  %74 = load ptr, ptr %65, align 8, !tbaa !11
  %75 = load ptr, ptr @store_ppm_tga.v444, align 8, !tbaa !11
  tail call fastcc void @conv422to444(ptr noundef %74, ptr noundef %75) #32
  br label %76

76:                                               ; preds = %72, %66, %10
  %77 = icmp eq i32 %5, 0
  %78 = select i1 %77, ptr @.str.9, ptr @.str.8
  %79 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0)
  %80 = getelementptr inbounds i8, ptr %0, i64 %79
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(5) %80, ptr noundef nonnull align 1 dereferenceable(5) %78, i64 5, i1 false)
  %81 = load i32, ptr @Quiet_Flag, align 4, !tbaa !7
  %82 = icmp eq i32 %81, 0
  br i1 %82, label %83, label %90

83:                                               ; preds = %76
  %84 = load ptr, ptr @stdout, align 8, !tbaa !11
  %85 = tail call ptr @strrchr(ptr noundef nonnull dereferenceable(1) %0, i32 noundef 47) #37
  %86 = icmp eq ptr %85, null
  %87 = getelementptr inbounds i8, ptr %85, i64 1
  %88 = select i1 %86, ptr %0, ptr %87
  %89 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %84, ptr noundef nonnull @.str.3.182, ptr noundef %88) #32
  br label %90

90:                                               ; preds = %83, %76
  %91 = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %0, i32 noundef 577, i32 noundef 438) #33
  store i32 %91, ptr @outfile, align 4, !tbaa !7
  %92 = icmp eq i32 %91, -1
  br i1 %92, label %93, label %95

93:                                               ; preds = %90
  %94 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @Error_Text, ptr noundef nonnull dereferenceable(1) @.str.4, ptr noundef nonnull %0) #33
  tail call void @Error(ptr noundef nonnull @Error_Text) #33
  br label %95

95:                                               ; preds = %93, %90
  store ptr @obfr, ptr @optr, align 8, !tbaa !11
  br i1 %77, label %125, label %96

96:                                               ; preds = %106, %95
  %97 = phi ptr [ %107, %106 ], [ @obfr, %95 ]
  %98 = phi i64 [ %108, %106 ], [ 0, %95 ]
  %99 = getelementptr inbounds [14 x i8], ptr @store_ppm_tga.tga24, i64 0, i64 %98
  %100 = load i8, ptr %99, align 1, !tbaa !15
  %101 = getelementptr inbounds i8, ptr %97, i64 1
  store ptr %101, ptr @optr, align 8, !tbaa !11
  store i8 %100, ptr %97, align 1, !tbaa !15
  %102 = icmp eq ptr %101, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %102, label %103, label %106

103:                                              ; preds = %96
  %104 = load i32, ptr @outfile, align 4, !tbaa !7
  %105 = tail call i64 @write(i32 noundef %104, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  store ptr @obfr, ptr @optr, align 8, !tbaa !11
  br label %106

106:                                              ; preds = %103, %96
  %107 = phi ptr [ %101, %96 ], [ @obfr, %103 ]
  %108 = add nuw nsw i64 %98, 1
  %109 = icmp eq i64 %108, 12
  br i1 %109, label %110, label %96, !llvm.loop !66

110:                                              ; preds = %106
  %111 = load i32, ptr @horizontal_size, align 4, !tbaa !7
  tail call fastcc void @putword(i32 noundef %111) #32
  tail call fastcc void @putword(i32 noundef %4) #32
  %112 = load ptr, ptr @optr, align 8, !tbaa !11
  %113 = getelementptr inbounds i8, ptr %112, i64 1
  store ptr %113, ptr @optr, align 8, !tbaa !11
  store i8 24, ptr %112, align 1, !tbaa !15
  %114 = icmp eq ptr %113, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %114, label %115, label %118

115:                                              ; preds = %110
  %116 = load i32, ptr @outfile, align 4, !tbaa !7
  %117 = tail call i64 @write(i32 noundef %116, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %118

118:                                              ; preds = %115, %110
  %119 = phi ptr [ %113, %110 ], [ @obfr, %115 ]
  %120 = getelementptr inbounds i8, ptr %119, i64 1
  store ptr %120, ptr @optr, align 8, !tbaa !11
  store i8 32, ptr %119, align 1, !tbaa !15
  %121 = icmp eq ptr %120, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %121, label %122, label %147

122:                                              ; preds = %118
  %123 = load i32, ptr @outfile, align 4, !tbaa !7
  %124 = tail call i64 @write(i32 noundef %123, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  store ptr @obfr, ptr @optr, align 8, !tbaa !11
  br label %147

125:                                              ; preds = %95
  %126 = load i32, ptr @horizontal_size, align 4, !tbaa !7
  %127 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %7, ptr noundef nonnull dereferenceable(1) @.str.10, i32 noundef %126, i32 noundef %4) #33
  %128 = load i8, ptr %7, align 16, !tbaa !15
  %129 = icmp eq i8 %128, 0
  br i1 %129, label %147, label %130

130:                                              ; preds = %125
  %131 = load ptr, ptr @optr, align 8, !tbaa !11
  br label %132

132:                                              ; preds = %141, %130
  %133 = phi ptr [ %131, %130 ], [ %142, %141 ]
  %134 = phi i64 [ 0, %130 ], [ %143, %141 ]
  %135 = phi i8 [ %128, %130 ], [ %145, %141 ]
  %136 = getelementptr inbounds i8, ptr %133, i64 1
  store ptr %136, ptr @optr, align 8, !tbaa !11
  store i8 %135, ptr %133, align 1, !tbaa !15
  %137 = icmp eq ptr %136, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %137, label %138, label %141

138:                                              ; preds = %132
  %139 = load i32, ptr @outfile, align 4, !tbaa !7
  %140 = tail call i64 @write(i32 noundef %139, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  store ptr @obfr, ptr @optr, align 8, !tbaa !11
  br label %141

141:                                              ; preds = %138, %132
  %142 = phi ptr [ %136, %132 ], [ @obfr, %138 ]
  %143 = add nuw i64 %134, 1
  %144 = getelementptr inbounds [256 x i8], ptr %7, i64 0, i64 %143
  %145 = load i8, ptr %144, align 1, !tbaa !15
  %146 = icmp eq i8 %145, 0
  br i1 %146, label %147, label %132, !llvm.loop !67

147:                                              ; preds = %141, %125, %122, %118
  %148 = load i32, ptr @matrix_coefficients, align 4, !tbaa !7
  %149 = sext i32 %148 to i64
  %150 = getelementptr inbounds [8 x [4 x i32]], ptr @Inverse_Table_6_9, i64 0, i64 %149
  %151 = load i32, ptr %150, align 16, !tbaa !7
  %152 = getelementptr inbounds [8 x [4 x i32]], ptr @Inverse_Table_6_9, i64 0, i64 %149, i64 1
  %153 = load i32, ptr %152, align 4, !tbaa !7
  %154 = getelementptr inbounds [8 x [4 x i32]], ptr @Inverse_Table_6_9, i64 0, i64 %149, i64 2
  %155 = load i32, ptr %154, align 8, !tbaa !7
  %156 = getelementptr inbounds [8 x [4 x i32]], ptr @Inverse_Table_6_9, i64 0, i64 %149, i64 3
  %157 = load i32, ptr %156, align 4, !tbaa !7
  %158 = icmp sgt i32 %4, 0
...
159:                                              ; preds = %147
  ...
  %163 = load i32, ptr @horizontal_size, align 4, !tbaa !7
  br label %164

164:                                              ; preds = %257, %159
  %165 = phi i32 [ %163, %159 ], [ %258, %257 ]
  %166 = phi i64 [ 0, %159 ], [ %259, %257 ]
  %167 = icmp sgt i32 %165, 0
  br i1 %167, label %168, label %257

168:                                              ; preds = %164
  %169 = load ptr, ptr @store_ppm_tga.v444, align 8, !tbaa !11
  %170 = getelementptr inbounds i8, ptr %169, i64 %160
  %171 = mul nsw i64 %166, %161
  %172 = getelementptr inbounds i8, ptr %170, i64 %171
  %173 = load ptr, ptr @store_ppm_tga.u444, align 8, !tbaa !11
...
179:                                              ; preds = %253, %168
  %180 = phi ptr [ %186, %253 ], [ %172, %168 ]
  %181 = phi ptr [ %184, %253 ], [ %175, %168 ]
  %182 = phi ptr [ %188, %253 ], [ %178, %168 ]
  %183 = phi i32 [ %254, %253 ], [ 0, %168 ]
  %184 = getelementptr inbounds i8, ptr %181, i64 1
  %185 = call i32 @_wyvern_slice_store_ppm_tga__393286742(ptr %181)
  %186 = getelementptr inbounds i8, ptr %180, i64 1
  %187 = call i32 @_wyvern_slice_store_ppm_tga__393286742(ptr %180)
  %188 = getelementptr inbounds i8, ptr %182, i64 1
  %189 = load i8, ptr %182, align 1, !tbaa !15
  %190 = zext i8 %189 to i32
  %191 = mul nuw nsw i32 %190, 76309
  %192 = add nsw i32 %191, -1220944
  %193 = load ptr, ptr @Clip, align 8, !tbaa !11
  %194 = mul nsw i32 %187, %151
  ...
  %202 = mul i32 %187, %157
  %203 = add i32 %202, %201
  %204 = add nsw i32 %191, -1188176
  %205 = sub i32 %204, %203
  %206 = ashr i32 %205, 16
  %207 = sext i32 %206 to i64
  %208 = getelementptr inbounds i8, ptr %193, i64 %207
  %209 = load i8, ptr %208, align 1, !tbaa !15
  %210 = mul nsw i32 %185, %153
  %211 = add i32 %210, 32786
  %212 = add i32 %211, %192
  %213 = ashr i32 %212, 16
  %214 = sext i32 %213 to i64
  %215 = getelementptr inbounds i8, ptr %193, i64 %214
  %216 = load i8, ptr %215, align 1, !tbaa !15
  %217 = load ptr, ptr @optr, align 8, !tbaa !11
  %218 = getelementptr inbounds i8, ptr %217, i64 1
  store ptr %218, ptr @optr, align 8, !tbaa !11
  %219 = icmp eq ptr %218, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %77, label %235, label %220
...
221:                                              ; preds = %220
  %222 = load i32, ptr @outfile, align 4, !tbaa !7
  %223 = tail call i64 @write(i32 noundef %222, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %224

224:                                              ; preds = %221, %220
  %225 = phi ptr [ %218, %220 ], [ @obfr, %221 ]
  %226 = getelementptr inbounds i8, ptr %225, i64 1
  store ptr %226, ptr @optr, align 8, !tbaa !11
  store i8 %209, ptr %225, align 1, !tbaa !15
  %227 = icmp eq ptr %226, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %227, label %228, label %231

228:                                              ; preds = %224
  %229 = load i32, ptr @outfile, align 4, !tbaa !7
  %230 = tail call i64 @write(i32 noundef %229, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %231

231:                                              ; preds = %228, %224
  %232 = phi ptr [ %226, %224 ], [ @obfr, %228 ]
  %233 = getelementptr inbounds i8, ptr %232, i64 1
  store ptr %233, ptr @optr, align 8, !tbaa !11
  store i8 %200, ptr %232, align 1, !tbaa !15
  %234 = icmp eq ptr %233, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %234, label %250, label %253

235:                                              ; preds = %179
  store i8 %200, ptr %217, align 1, !tbaa !15
  br i1 %219, label %236, label %239

236:                                              ; preds = %235
  %237 = load i32, ptr @outfile, align 4, !tbaa !7
  %238 = tail call i64 @write(i32 noundef %237, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %239

239:                                              ; preds = %236, %235
  %240 = phi ptr [ %218, %235 ], [ @obfr, %236 ]
  %241 = getelementptr inbounds i8, ptr %240, i64 1
  store ptr %241, ptr @optr, align 8, !tbaa !11
  store i8 %209, ptr %240, align 1, !tbaa !15
  %242 = icmp eq ptr %241, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %242, label %243, label %246

243:                                              ; preds = %239
  %244 = load i32, ptr @outfile, align 4, !tbaa !7
  %245 = tail call i64 @write(i32 noundef %244, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %246

246:                                              ; preds = %243, %239
  %247 = phi ptr [ %241, %239 ], [ @obfr, %243 ]
  %248 = getelementptr inbounds i8, ptr %247, i64 1
  store ptr %248, ptr @optr, align 8, !tbaa !11
  store i8 %216, ptr %247, align 1, !tbaa !15
  %249 = icmp eq ptr %248, getelementptr inbounds ([4096 x i8], ptr @obfr, i64 1, i64 0)
  br i1 %249, label %250, label %253

250:                                              ; preds = %246, %231
  %251 = load i32, ptr @outfile, align 4, !tbaa !7
  %252 = tail call i64 @write(i32 noundef %251, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  store ptr @obfr, ptr @optr, align 8, !tbaa !11
  br label %253

253:                                              ; preds = %250, %246, %231
  %254 = add nuw nsw i32 %183, 1
  %255 = load i32, ptr @horizontal_size, align 4, !tbaa !7
  %256 = icmp slt i32 %254, %255
  br i1 %256, label %179, label %257, !llvm.loop !68

257:                                              ; preds = %253, %164
  %258 = phi i32 [ %165, %164 ], [ %255, %253 ]
  %259 = add nuw nsw i64 %166, 1
  %260 = icmp eq i64 %259, %162
  br i1 %260, label %261, label %164, !llvm.loop !69

261:                                              ; preds = %257, %147
  %262 = load ptr, ptr @optr, align 8, !tbaa !11
  %263 = icmp eq ptr %262, @obfr
  br i1 %263, label %269, label %264

264:                                              ; preds = %261
  %265 = load i32, ptr @outfile, align 4, !tbaa !7
  %266 = ptrtoint ptr %262 to i64
  %267 = sub i64 %266, ptrtoint (ptr @obfr to i64)
  %268 = tail call i64 @write(i32 noundef %265, ptr noundef nonnull @obfr, i64 noundef %267) #33
  br label %269

269:                                              ; preds = %264, %261
  %270 = load i32, ptr @outfile, align 4, !tbaa !7
  %271 = tail call i32 @close(i32 noundef %270) #33
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %7) #40
  ret void
}
...
6:                                                ; preds = %1
  ...
  %8 = tail call i64 @write(i32 noundef %7, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  br label %9
...
15:                                               ; preds = %9
  ...
  %17 = tail call i64 @write(i32 noundef %16, ptr noundef nonnull @obfr, i64 noundef 4096) #33
  store ptr @obfr, ptr @optr, align 8, !tbaa !11
  br label %18
...
define internal void @Initialize_Buffer() #0 {
  ...
  tail call void @Flush_Buffer(i32 noundef 0) #32
  ret void
}
...
28:                                               ; preds = %20
  tail call void @Next_Packet() #33
  br label %29

29:                                               ; preds = %28, %20
  %30 = tail call i32 @Get_Byte() #32, !range !77
...
6:                                                ; preds = %6, %0
  ...
  %10 = tail call i64 @read(i32 noundef %9, ptr noundef nonnull %8, i64 noundef 2048) #33
...
define internal void @Fill_Buffer() #20 {
  ...
  %4 = tail call i64 @read(i32 noundef %2, ptr noundef nonnull %3, i64 noundef 2048) #33
...
define internal i32 @Get_Word() #20 {
  %1 = tail call i32 @Get_Byte() #32, !range !77
  %2 = shl nuw nsw i32 %1, 8
  %3 = tail call i32 @Get_Byte() #32, !range !77
  %4 = or i32 %2, %3
  ret i32 %4
}
...
define internal i32 @Show_Bits(i32 noundef %0) #21 {
  %2 = call i32 @_wyvern_slice_Get_Bits__795675944(i32 %0)
  ret i32 %2
}
...
63:                                               ; preds = %60
  tail call void @Substitute_Frame_Buffer(i32 noundef %0, i32 noundef %1) #33
...
71:                                               ; preds = %65
  tail call void @Spatial_Prediction() #33
  br label %72
...
87:                                               ; preds = %767, %72
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %10) #40
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %11) #40
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %12) #40
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %13) #40
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %14) #40
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %15) #40
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %16) #40
  ...
  call void @next_start_code() #33
  %88 = call i32 @Show_Bits(i32 noundef 32) #33
  %89 = add i32 %88, -432
...
94:                                               ; preds = %87
  call void @Flush_Buffer32() #33
  %95 = call i32 @slice_header() #33
...
98:                                               ; preds = %94
  store ptr @enhan, ptr @ld, align 8, !tbaa !11
  call void @next_start_code() #33
  %99 = call i32 @Show_Bits(i32 noundef 32) #33
  %100 = add i32 %99, -432
...
110:                                              ; preds = %109, %105, %94
  ...
  %113 = call i32 @Get_macroblock_address_increment() #33
...
141:                                              ; preds = %140, %134
  %142 = call i32 @Show_Bits(i32 noundef 23) #33
...
155:                                              ; preds = %154, %148
  %156 = call i32 @Get_macroblock_address_increment() #33
...
162:                                              ; preds = %159
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %8) #40
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %9) #40
...
169:                                              ; preds = %165, %162
  call fastcc void @macroblock_modes(ptr noundef nonnull %10, ptr noundef nonnull %17, ptr noundef nonnull %18, ptr noundef nonnull %11, ptr noundef nonnull %6, ptr noundef nonnull %7, ptr noundef nonnull %8, ptr noundef nonnull %9, ptr noundef nonnull %12) #32
...
176:                                              ; preds = %172
  %177 = call i32 @Get_Bits(i32 noundef 5) #33
...
213:                                              ; preds = %208
  ...
  call void @motion_vectors(ptr noundef nonnull %14, ptr noundef nonnull %16, ptr noundef nonnull %15, i32 noundef 0, i32 noundef %214, i32 noundef %215, i32 noundef %217, i32 noundef %219, i32 noundef %220, i32 noundef %221) #33
  br label %226
...
222:                                              ; preds = %208
  ...
  call void @motion_vector(ptr noundef nonnull %14, ptr noundef nonnull %16, i32 noundef %224, i32 noundef %224, i32 noundef 0, i32 noundef 0, i32 noundef %225) #33
  br label %226
...
237:                                              ; preds = %232
  ...
  call void @motion_vectors(ptr noundef nonnull %14, ptr noundef nonnull %16, ptr noundef nonnull %15, i32 noundef 1, i32 noundef %238, i32 noundef %239, i32 noundef %241, i32 noundef %243, i32 noundef 0, i32 noundef %244) #33
  br label %249
...
245:                                              ; preds = %232
  ...
  call void @motion_vector(ptr noundef nonnull %86, ptr noundef nonnull %16, i32 noundef %247, i32 noundef %247, i32 noundef 0, i32 noundef 0, i32 noundef %248) #33
  br label %249
...
258:                                              ; preds = %252
  call void @Flush_Buffer(i32 noundef 1) #33
  br label %259
...
269:                                              ; preds = %266
  %270 = call i32 @Get_coded_block_pattern() #33
...
272:                                              ; preds = %269
  %273 = shl i32 %270, 2
  %274 = call i32 @Get_Bits(i32 noundef 2) #33
  %275 = or i32 %274, %273
  br label %286

276:                                              ; preds = %269
  %277 = shl i32 %270, 6
  %278 = call i32 @Get_Bits(i32 noundef 6) #33
  %279 = or i32 %278, %277
  br label %286
...
317:                                              ; preds = %316
  call void @Decode_MPEG2_Intra_Block(i32 noundef %298, ptr noundef nonnull %13) #33
  br label %322

318:                                              ; preds = %316
  call void @Decode_MPEG1_Intra_Block(i32 noundef %298, ptr noundef nonnull %13) #33
  br label %322
...
320:                                              ; preds = %319
  call void @Decode_MPEG2_Non_Intra_Block(i32 noundef %298) #33
  br label %322

321:                                              ; preds = %319
  call void @Decode_MPEG1_Non_Intra_Block(i32 noundef %298) #33
  br label %322
...
333:                                              ; preds = %330
  call void @marker_bit(ptr noundef nonnull @.str.6.196) #33
  br label %334
...
358:                                              ; preds = %322, %286, %249, %226, %169
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %9) #40
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %8) #40
...
397:                                              ; preds = %395
  %398 = call i32 @Show_Bits(i32 noundef 23) #33
  %399 = icmp eq i32 %398, 0
  br i1 %399, label %400, label %409

400:                                              ; preds = %397
  call void @next_start_code() #33
  %401 = call i32 @Show_Bits(i32 noundef 32) #33
  %402 = add i32 %401, -432
...
416:                                              ; preds = %409
  %417 = call i32 @Get_macroblock_address_increment() #33
  br label %418
...
421:                                              ; preds = %400
  call void @Flush_Buffer32() #33
  %422 = call i32 @slice_header() #33
  %423 = call i32 @Get_macroblock_address_increment() #33
  %424 = shl i32 %422, 7
  %425 = and i32 %401, 255
...
450:                                              ; preds = %440, %421
  call fastcc void @macroblock_modes(ptr noundef nonnull %3, ptr noundef nonnull %5, ptr noundef nonnull %5, ptr noundef nonnull %5, ptr noundef nonnull %5, ptr noundef nonnull %5, ptr noundef nonnull %5, ptr noundef nonnull %5, ptr noundef nonnull %4) #32
...
459:                                              ; preds = %456
  %460 = call i32 @Get_Bits(i32 noundef 5) #33
...
476:                                              ; preds = %475
  %477 = call i32 @Get_coded_block_pattern() #33
...
480:                                              ; preds = %479, %476
  ...
  %482 = shl i32 %477, %481
  %483 = call i32 @Get_Bits(i32 noundef %481) #33
  %484 = or i32 %483, %482
  br label %485
...
502:                                              ; preds = %491
  call void @Decode_MPEG2_Non_Intra_Block(i32 noundef %495) #33
...
527:                                              ; preds = %516
  ...
  call void @form_predictions(i32 noundef %522, i32 noundef %524, i32 noundef %389, i32 noundef %529, ptr noundef nonnull %14, ptr noundef nonnull %15, ptr noundef nonnull %16, i32 noundef %528) #33
  br label %530
...
596:                                              ; preds = %591
  call void @Reference_IDCT(ptr noundef nonnull %595) #33
  br label %598

597:                                              ; preds = %591
  call void @Fast_IDCT(ptr noundef nonnull %595) #33
  br label %598
...
767:                                              ; preds = %147, %116
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %16) #40
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %15) #40
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %14) #40
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %13) #40
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %12) #40
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %11) #40
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %10) #40
  br label %87
...
782:                                              ; preds = %779
  %783 = add nsw i32 %0, -1
  call void @Write_Frame(ptr noundef nonnull @auxframe, i32 noundef %783) #33
  br label %791
...
784:                                              ; preds = %779
  ...
  %787 = add nsw i32 %0, -1
  call void @Write_Frame(ptr noundef nonnull @forward_reference_frame, i32 noundef %787) #33
...
define internal fastcc void @macroblock_modes(ptr nocapture noundef writeonly %0, ptr nocapture noundef writeonly %1, ptr nocapture noundef writeonly %2, ptr nocapture noundef writeonly %3, ptr nocapture noundef writeonly %4, ptr nocapture noundef writeonly %5, ptr nocapture noundef writeonly %6, ptr nocapture noundef writeonly %7, ptr nocapture noundef writeonly %8) unnamed_addr #0 {
  %10 = tail call i32 @Get_macroblock_type() #33
...
19:                                               ; preds = %16
  %20 = tail call i32 @Get_Bits(i32 noundef 2) #33
...
55:                                               ; preds = %39
  %56 = tail call i32 @Get_Bits(i32 noundef 2) #33
  br label %57
...
94:                                               ; preds = %77
  %95 = tail call i32 @Get_Bits(i32 noundef 1) #33
  br label %96
...
6:                                                ; preds = %1
  %7 = add nsw i32 %0, -1
  tail call void @Write_Frame(ptr noundef nonnull @backward_reference_frame, i32 noundef %7) #33
  br label %8
...
8:                                                ; preds = %8, %1
  ...
  %13 = fmul double %7, %12
  %14 = tail call double @cos(double noundef %13) #33
  %15 = fmul double %4, %14
...
define internal void @Reference_IDCT(ptr nocapture noundef %0) #25 {
  ...
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %2) #40
  br label %3
...
59:                                               ; preds = %56
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %2) #40
  ret void
}
...
25:                                               ; preds = %23
  ...
  tail call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef 0, i32 noundef 0, i32 noundef %26, i32 noundef %27, i32 noundef 8, i32 noundef %0, i32 noundef %1, i32 noundef %28, i32 noundef %30, i32 noundef %10) #32
  br label %31
...
33:                                               ; preds = %31
  ...
  tail call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef 1, i32 noundef 1, i32 noundef %34, i32 noundef %35, i32 noundef 8, i32 noundef %0, i32 noundef %1, i32 noundef %36, i32 noundef %38, i32 noundef %11) #32
  br label %172
...
42:                                               ; preds = %40
  ...
  %50 = ashr i32 %49, 1
  tail call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef %43, i32 noundef 0, i32 noundef %45, i32 noundef %45, i32 noundef 8, i32 noundef %0, i32 noundef %46, i32 noundef %47, i32 noundef %50, i32 noundef %10) #32
  br label %51
...
53:                                               ; preds = %51
  ...
  %63 = ashr i32 %62, 1
  tail call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef %55, i32 noundef 1, i32 noundef %57, i32 noundef %57, i32 noundef 8, i32 noundef %0, i32 noundef %58, i32 noundef %60, i32 noundef %63, i32 noundef %11) #32
  br label %172
...
64:                                               ; preds = %39
  ...
  %68 = ashr i32 %67, 1
  call void @Dual_Prime_Arithmetic(ptr noundef nonnull %9, ptr noundef %6, i32 noundef %65, i32 noundef %68) #33
...
70:                                               ; preds = %64
  ...
  %76 = ashr i32 %75, 1
  call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef 0, i32 noundef 0, i32 noundef %72, i32 noundef %72, i32 noundef 8, i32 noundef %0, i32 noundef %73, i32 noundef %74, i32 noundef %76, i32 noundef 0) #32
  ...
  call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef 1, i32 noundef 0, i32 noundef %78, i32 noundef %78, i32 noundef 8, i32 noundef %0, i32 noundef %73, i32 noundef %79, i32 noundef %81, i32 noundef 1) #32
  br label %82
...
84:                                               ; preds = %82
  ...
  %90 = ashr i32 %89, 1
  call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef 1, i32 noundef 1, i32 noundef %86, i32 noundef %86, i32 noundef 8, i32 noundef %0, i32 noundef %87, i32 noundef %88, i32 noundef %90, i32 noundef 0) #32
  ...
  call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef 0, i32 noundef 1, i32 noundef %92, i32 noundef %92, i32 noundef 8, i32 noundef %0, i32 noundef %87, i32 noundef %94, i32 noundef %96, i32 noundef 1) #32
  br label %172
...
115:                                              ; preds = %113
  ...
  tail call fastcc void @form_prediction(ptr noundef nonnull %110, i32 noundef %116, i32 noundef 0, i32 noundef %118, i32 noundef %118, i32 noundef 16, i32 noundef %0, i32 noundef %1, i32 noundef %119, i32 noundef %121, i32 noundef %10) #32
  br label %172
...
125:                                              ; preds = %123
  ...
  tail call fastcc void @form_prediction(ptr noundef nonnull %110, i32 noundef %126, i32 noundef 0, i32 noundef %128, i32 noundef %128, i32 noundef 8, i32 noundef %0, i32 noundef %1, i32 noundef %129, i32 noundef %131, i32 noundef %10) #32
...
143:                                              ; preds = %141, %139
  ...
  tail call fastcc void @form_prediction(ptr noundef nonnull %145, i32 noundef %144, i32 noundef 0, i32 noundef %147, i32 noundef %147, i32 noundef 8, i32 noundef %0, i32 noundef %148, i32 noundef %150, i32 noundef %152, i32 noundef %10) #32
  br label %172
...
153:                                              ; preds = %122
  ...
  call void @Dual_Prime_Arithmetic(ptr noundef nonnull %9, ptr noundef %6, i32 noundef %156, i32 noundef %158) #33
  %159 = load i32, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %160 = shl i32 %159, 1
  %161 = load i32, ptr %4, align 4, !tbaa !7
  %162 = load i32, ptr %157, align 4, !tbaa !7
  call fastcc void @form_prediction(ptr noundef nonnull @forward_reference_frame, i32 noundef %101, i32 noundef 0, i32 noundef %160, i32 noundef %160, i32 noundef 16, i32 noundef %0, i32 noundef %1, i32 noundef %161, i32 noundef %162, i32 noundef 0) #32
  %163 = xor i1 %100, true
  ...
  call fastcc void @form_prediction(ptr noundef nonnull %155, i32 noundef %164, i32 noundef 0, i32 noundef %166, i32 noundef %166, i32 noundef 16, i32 noundef %0, i32 noundef %1, i32 noundef %167, i32 noundef %169, i32 noundef 1) #32
  br label %172
...
184:                                              ; preds = %183
  ...
  call fastcc void @form_prediction(ptr noundef nonnull @backward_reference_frame, i32 noundef 0, i32 noundef 0, i32 noundef %185, i32 noundef %186, i32 noundef 8, i32 noundef %0, i32 noundef %1, i32 noundef %188, i32 noundef %190, i32 noundef %173) #32
  br label %191
...
193:                                              ; preds = %191
  ...
  call fastcc void @form_prediction(ptr noundef nonnull @backward_reference_frame, i32 noundef 1, i32 noundef 1, i32 noundef %194, i32 noundef %195, i32 noundef 8, i32 noundef %0, i32 noundef %1, i32 noundef %197, i32 noundef %199, i32 noundef %174) #32
  br label %255
...
201:                                              ; preds = %200
  ...
  %211 = ashr i32 %210, 1
  call fastcc void @form_prediction(ptr noundef nonnull @backward_reference_frame, i32 noundef %203, i32 noundef 0, i32 noundef %205, i32 noundef %205, i32 noundef 8, i32 noundef %0, i32 noundef %206, i32 noundef %208, i32 noundef %211, i32 noundef %173) #32
  br label %212
...
214:                                              ; preds = %212
  ...
  %224 = ashr i32 %223, 1
  call fastcc void @form_prediction(ptr noundef nonnull @backward_reference_frame, i32 noundef %216, i32 noundef 1, i32 noundef %218, i32 noundef %218, i32 noundef 8, i32 noundef %0, i32 noundef %219, i32 noundef %221, i32 noundef %224, i32 noundef %174) #32
  br label %255
...
226:                                              ; preds = %225
  ...
  call fastcc void @form_prediction(ptr noundef nonnull @backward_reference_frame, i32 noundef %228, i32 noundef 0, i32 noundef %230, i32 noundef %230, i32 noundef 16, i32 noundef %0, i32 noundef %1, i32 noundef %232, i32 noundef %234, i32 noundef %173) #32
  br label %255
...
235:                                              ; preds = %225
  ...
  call fastcc void @form_prediction(ptr noundef nonnull @backward_reference_frame, i32 noundef %237, i32 noundef 0, i32 noundef %239, i32 noundef %239, i32 noundef 8, i32 noundef %0, i32 noundef %1, i32 noundef %241, i32 noundef %243, i32 noundef %173) #32
  ...
  call fastcc void @form_prediction(ptr noundef nonnull @backward_reference_frame, i32 noundef %245, i32 noundef 0, i32 noundef %247, i32 noundef %247, i32 noundef 8, i32 noundef %0, i32 noundef %248, i32 noundef %250, i32 noundef %252, i32 noundef %173) #32
  br label %255
...
define internal fastcc void @form_prediction(ptr nocapture noundef readonly %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7, i32 noundef %8, i32 noundef %9, i32 noundef %10) unnamed_addr #26 {
  ...
  tail call fastcc void @form_component_prediction(ptr noundef %17, ptr noundef %22, i32 noundef %3, i32 noundef %4, i32 noundef 16, i32 noundef %5, i32 noundef %6, i32 noundef %7, i32 noundef %8, i32 noundef %9, i32 noundef %10) #32
...
34:                                               ; preds = %30, %25, %11
  ...
  tail call fastcc void @form_component_prediction(ptr noundef %48, ptr noundef %52, i32 noundef %35, i32 noundef %39, i32 noundef %38, i32 noundef %40, i32 noundef %37, i32 noundef %41, i32 noundef %36, i32 noundef %42, i32 noundef %10) #32
  ...
  tail call fastcc void @form_component_prediction(ptr noundef %55, ptr noundef %57, i32 noundef %35, i32 noundef %39, i32 noundef %38, i32 noundef %40, i32 noundef %37, i32 noundef %41, i32 noundef %36, i32 noundef %42, i32 noundef %10) #32
  ret void
}
...
14:                                               ; preds = %13
  ...
  tail call fastcc void @Read_Frame(ptr noundef %16, ptr noundef nonnull @forward_reference_frame, i32 noundef %15) #32
  br label %41
...
21:                                               ; preds = %17
  ...
  tail call fastcc void @Read_Frame(ptr noundef %27, ptr noundef nonnull @backward_reference_frame, i32 noundef %26) #32
  br label %41
...
38:                                               ; preds = %32, %29
  ...
  tail call fastcc void @Read_Frame(ptr noundef %40, ptr noundef nonnull @current_frame, i32 noundef %39) #32
  br label %41
...
7:                                                ; preds = %3
  %8 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.207, i32 noundef %2) #32
  br label %9
...
12:                                               ; preds = %9
  %13 = tail call noalias ptr @fopen(ptr noundef %0, ptr noundef nonnull @.str.2.208) #32
  %14 = icmp eq ptr %13, null
  br i1 %14, label %91, label %15

15:                                               ; preds = %12
  %16 = call i32 @_wyvern_slice_Read_Frame__807793023()
  %17 = load i32, ptr @chroma_format, align 4, !tbaa !7
...
25:                                               ; preds = %15
  %26 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4.209, i32 noundef %17) #32
  br label %27

27:                                               ; preds = %25, %22, %20, %18
  %28 = phi i32 [ %19, %18 ], [ %21, %20 ], [ %24, %22 ], [ %16, %25 ]
  %29 = mul nsw i32 %28, %2
  %30 = sext i32 %29 to i64
  %31 = tail call i32 @fseek(ptr noundef nonnull %13, i64 noundef %30, i32 noundef 0) #32
  %32 = load i32, ptr @Coded_Picture_Height, align 4, !tbaa !7
  %33 = icmp sgt i32 %32, 0
  br i1 %33, label %37, label %34

34:                                               ; preds = %37, %27
  %35 = load i32, ptr @Chroma_Height, align 4, !tbaa !7
  %36 = icmp sgt i32 %35, 0
  br i1 %36, label %51, label %75

37:                                               ; preds = %37, %27
  %38 = phi i32 [ %46, %37 ], [ 0, %27 ]
  %39 = load ptr, ptr @substitute_frame, align 16, !tbaa !11
  %40 = load i32, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %41 = mul nsw i32 %40, %38
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds i8, ptr %39, i64 %42
  %44 = sext i32 %40 to i64
  %45 = tail call i64 @fread(ptr noundef %43, i64 noundef 1, i64 noundef %44, ptr noundef nonnull %13) #32
  %46 = add nuw nsw i32 %38, 1
  %47 = load i32, ptr @Coded_Picture_Height, align 4, !tbaa !7
  %48 = icmp slt i32 %46, %47
  br i1 %48, label %37, label %34, !llvm.loop !118

49:                                               ; preds = %51
  %.lcssa = phi i32 [ %61, %51 ]
  %50 = icmp sgt i32 %.lcssa, 0
  br i1 %50, label %63, label %75

51:                                               ; preds = %51, %34
  %52 = phi i32 [ %60, %51 ], [ 0, %34 ]
  %53 = load ptr, ptr getelementptr inbounds ([3 x ptr], ptr @substitute_frame, i64 0, i64 1), align 8, !tbaa !11
  %54 = load i32, ptr @Chroma_Width, align 4, !tbaa !7
  %55 = mul nsw i32 %54, %52
  %56 = sext i32 %55 to i64
  %57 = getelementptr inbounds i8, ptr %53, i64 %56
  %58 = sext i32 %54 to i64
  %59 = tail call i64 @fread(ptr noundef %57, i64 noundef 1, i64 noundef %58, ptr noundef nonnull %13) #32
  %60 = add nuw nsw i32 %52, 1
  %61 = load i32, ptr @Chroma_Height, align 4, !tbaa !7
  %62 = icmp slt i32 %60, %61
  br i1 %62, label %51, label %49, !llvm.loop !119

63:                                               ; preds = %63, %49
  %64 = phi i32 [ %72, %63 ], [ 0, %49 ]
  %65 = load ptr, ptr getelementptr inbounds ([3 x ptr], ptr @substitute_frame, i64 0, i64 2), align 16, !tbaa !11
  %66 = load i32, ptr @Chroma_Width, align 4, !tbaa !7
  %67 = mul nsw i32 %66, %64
  %68 = sext i32 %67 to i64
  %69 = getelementptr inbounds i8, ptr %65, i64 %68
  %70 = sext i32 %66 to i64
  %71 = tail call i64 @fread(ptr noundef %69, i64 noundef 1, i64 noundef %70, ptr noundef nonnull %13) #32
  %72 = add nuw nsw i32 %64, 1
  %73 = load i32, ptr @Chroma_Height, align 4, !tbaa !7
  %74 = icmp slt i32 %72, %73
  br i1 %74, label %63, label %75, !llvm.loop !120

75:                                               ; preds = %63, %49, %34
  %76 = tail call i32 @fclose(ptr noundef nonnull %13) #32
  br label %94

77:                                               ; preds = %9
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %4) #40
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %5) #40
  %78 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %0, i32 noundef %2) #33
  %79 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %5, ptr noundef nonnull dereferenceable(1) @.str.5.210, ptr noundef nonnull %4) #33
  %80 = load ptr, ptr @substitute_frame, align 16, !tbaa !11
  %81 = load i32, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %82 = load i32, ptr @Coded_Picture_Height, align 4, !tbaa !7
  call fastcc void @Read_Component(ptr noundef nonnull %5, ptr noundef %80, i32 noundef %81, i32 noundef %82) #32
  %83 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %5, ptr noundef nonnull dereferenceable(1) @.str.6.211, ptr noundef nonnull %4) #33
  %84 = load ptr, ptr getelementptr inbounds ([3 x ptr], ptr @substitute_frame, i64 0, i64 1), align 8, !tbaa !11
  %85 = load i32, ptr @Chroma_Width, align 4, !tbaa !7
  %86 = load i32, ptr @Chroma_Height, align 4, !tbaa !7
  call fastcc void @Read_Component(ptr noundef nonnull %5, ptr noundef %84, i32 noundef %85, i32 noundef %86) #32
  %87 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %5, ptr noundef nonnull dereferenceable(1) @.str.7.212, ptr noundef nonnull %4) #33
  %88 = load ptr, ptr getelementptr inbounds ([3 x ptr], ptr @substitute_frame, i64 0, i64 2), align 16, !tbaa !11
  %89 = load i32, ptr @Chroma_Width, align 4, !tbaa !7
  %90 = load i32, ptr @Chroma_Height, align 4, !tbaa !7
  call fastcc void @Read_Component(ptr noundef nonnull %5, ptr noundef %88, i32 noundef %89, i32 noundef %90) #32
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %5) #40
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %4) #40
  br label %94

91:                                               ; preds = %12
  %92 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @Error_Text, ptr noundef nonnull dereferenceable(1) @.str.3.213, ptr noundef %0) #33
  %93 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.214)
  br label %94

94:                                               ; preds = %91, %77, %75
  %95 = load i32, ptr @Second_Field, align 4, !tbaa !7
  %96 = icmp ne i32 %95, 0
  %97 = load i32, ptr @picture_coding_type, align 4
  %98 = icmp eq i32 %97, 2
  %99 = select i1 %96, i1 %98, i1 false
  br i1 %99, label %100, label %106

100:                                              ; preds = %94
  %101 = load i32, ptr @picture_structure, align 4, !tbaa !7
...
106:                                              ; preds = %100, %94
  %107 = phi i32 [ %103, %100 ], [ 0, %94 ]
  %108 = phi i32 [ %105, %100 ], [ 0, %94 ]
  %109 = load ptr, ptr @substitute_frame, align 16, !tbaa !11
  %110 = load ptr, ptr %1, align 8, !tbaa !11
  %111 = load i32, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %112 = load i32, ptr @Coded_Picture_Height, align 4, !tbaa !7
  call fastcc void @Copy_Frame(ptr noundef %109, ptr noundef %110, i32 noundef %111, i32 noundef %112, i32 noundef %107, i32 noundef %108) #32
  %113 = load ptr, ptr getelementptr inbounds ([3 x ptr], ptr @substitute_frame, i64 0, i64 1), align 8, !tbaa !11
  %114 = getelementptr inbounds ptr, ptr %1, i64 1
  %115 = load ptr, ptr %114, align 8, !tbaa !11
  %116 = load i32, ptr @Chroma_Width, align 4, !tbaa !7
  %117 = load i32, ptr @Chroma_Height, align 4, !tbaa !7
  call fastcc void @Copy_Frame(ptr noundef %113, ptr noundef %115, i32 noundef %116, i32 noundef %117, i32 noundef %107, i32 noundef %108) #32
  %118 = load ptr, ptr getelementptr inbounds ([3 x ptr], ptr @substitute_frame, i64 0, i64 2), align 16, !tbaa !11
  %119 = getelementptr inbounds ptr, ptr %1, i64 2
  %120 = load ptr, ptr %119, align 8, !tbaa !11
  %121 = load i32, ptr @Chroma_Width, align 4, !tbaa !7
  %122 = load i32, ptr @Chroma_Height, align 4, !tbaa !7
  call fastcc void @Copy_Frame(ptr noundef %118, ptr noundef %120, i32 noundef %121, i32 noundef %122, i32 noundef %107, i32 noundef %108) #32
  ret void
}
...
define internal fastcc void @Read_Component(ptr noundef %0, ptr nocapture noundef %1, i32 noundef %2, i32 noundef %3) unnamed_addr #0 {
  %5 = mul nsw i32 %3, %2
  %6 = tail call i32 (ptr, i32, ...) @open(ptr noundef %0, i32 noundef 0) #33
  %7 = sext i32 %5 to i64
  %8 = tail call i64 @read(i32 noundef %6, ptr noundef %1, i64 noundef %7) #33
  %9 = trunc i64 %8 to i32
  %10 = icmp eq i32 %5, %9
  br i1 %10, label %13, label %11

11:                                               ; preds = %4
  %12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.9.215, i32 noundef %9, i32 noundef %5, ptr noundef %0) #32
  br label %13

13:                                               ; preds = %11, %4
  %14 = tail call i32 @close(i32 noundef %6) #33
  ret void
}
...
7:                                                ; preds = %2
  %8 = call i32 @_wyvern_slice_Decode_MPEG1_Intra_Block__554320646(ptr %1)
  store i32 %8, ptr %1, align 4, !tbaa !7
  br label %20

9:                                                ; preds = %2
  %10 = icmp eq i32 %0, 4
  %11 = tail call i32 @Get_Chroma_DC_dct_diff() #33
...
20:                                               ; preds = %16, %12, %7
  %21 = phi i32 [ %15, %12 ], [ %19, %16 ], [ %8, %7 ]
  %22 = trunc i32 %21 to i16
  %23 = shl i16 %22, 3
  store i16 %23, ptr %5, align 2, !tbaa !47
  %24 = load i32, ptr @Fault_Flag, align 4, !tbaa !7
  %25 = icmp ne i32 %24, 0
  %26 = load i32, ptr @picture_coding_type, align 4
  %27 = icmp eq i32 %26, 4
  %28 = select i1 %25, i1 true, i1 %27
  br i1 %28, label %149, label %29

29:                                               ; preds = %144, %20
  %30 = phi i32 [ %147, %144 ], [ 1, %20 ]
  %31 = tail call i32 @Show_Bits(i32 noundef 16) #33
...
66:                                               ; preds = %61
  %67 = icmp ugt i32 %31, 15
  br i1 %67, label %68, label %70

68:                                               ; preds = %66
  %69 = add nsw i32 %31, -16
  br label %75

70:                                               ; preds = %66
  %71 = load i32, ptr @Quiet_Flag, align 4, !tbaa !7
  %72 = icmp eq i32 %71, 0
  br i1 %72, label %73, label %148

73:                                               ; preds = %70
  %74 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.218)
  br label %148

75:                                               ; preds = %68, %63, %58, %53, %48, %43, %38, %33
  %76 = phi i32 [ %40, %38 ], [ %50, %48 ], [ %60, %58 ], [ %69, %68 ], [ %65, %63 ], [ %55, %53 ], [ %45, %43 ], [ %35, %33 ]
  %77 = phi ptr [ @DCTtab0, %38 ], [ @DCTtab2, %48 ], [ @DCTtab4, %58 ], [ @DCTtab6, %68 ], [ @DCTtab5, %63 ], [ @DCTtab3, %53 ], [ @DCTtab1, %43 ], [ @DCTtabnext, %33 ]
  %78 = zext i32 %76 to i64
  %79 = getelementptr inbounds [0 x %struct.DCTtab], ptr %77, i64 0, i64 %78
  %80 = getelementptr inbounds [0 x %struct.DCTtab], ptr %77, i64 0, i64 %78, i32 2
  %81 = load i8, ptr %80, align 1, !tbaa !123
  %82 = sext i8 %81 to i32
  tail call void @Flush_Buffer(i32 noundef %82) #33
  %83 = load i8, ptr %79, align 1, !tbaa !125
...
84:                                               ; preds = %75
  %85 = tail call i32 @Get_Bits(i32 noundef 6) #33
  %86 = tail call i32 @Get_Bits(i32 noundef 8) #33
...
87:                                               ; preds = %84
  %88 = tail call i32 @Get_Bits(i32 noundef 8) #33
  br label %96

89:                                               ; preds = %84
  %90 = tail call i32 @Get_Bits(i32 noundef 8) #33
  %91 = add i32 %90, -256
  br label %96

92:                                               ; preds = %84
  %93 = icmp sgt i32 %86, 128
  %94 = add nsw i32 %86, -256
  %95 = select i1 %93, i32 %94, i32 %86
  br label %96

96:                                               ; preds = %92, %89, %87
  %97 = phi i32 [ %88, %87 ], [ %91, %89 ], [ %95, %92 ]
  %98 = lshr i32 %97, 31
  %99 = tail call i32 @llvm.abs.i32(i32 %97, i1 true)
  br label %106

100:                                              ; preds = %75
  %101 = sext i8 %83 to i32
  %102 = getelementptr inbounds [0 x %struct.DCTtab], ptr %77, i64 0, i64 %78, i32 1
  %103 = load i8, ptr %102, align 1, !tbaa !126
  %104 = sext i8 %103 to i32
  %105 = tail call i32 @Get_Bits(i32 noundef 1) #33
  br label %106

106:                                              ; preds = %100, %96
  %107 = phi i32 [ %105, %100 ], [ %98, %96 ]
  %108 = phi i32 [ %101, %100 ], [ %85, %96 ]
  %109 = phi i32 [ %104, %100 ], [ %99, %96 ]
  %110 = add i32 %108, %30
  %111 = icmp sgt i32 %110, 63
  br i1 %111, label %112, label %118

112:                                              ; preds = %106
  %113 = load i32, ptr @Quiet_Flag, align 4, !tbaa !7
  %114 = icmp eq i32 %113, 0
  br i1 %114, label %115, label %148

115:                                              ; preds = %112
  %116 = load ptr, ptr @stdout, align 8, !tbaa !11
  %117 = tail call i64 @fwrite(ptr nonnull @.str.1.219, i64 42, i64 1, ptr %116)
  br label %148

118:                                              ; preds = %106
  %119 = sext i32 %110 to i64
  %120 = getelementptr inbounds [64 x i8], ptr @scan, i64 0, i64 %119
  %121 = load i8, ptr %120, align 1, !tbaa !15
  %122 = load ptr, ptr @ld, align 8, !tbaa !11
  %123 = getelementptr inbounds %struct.layer_data, ptr %122, i64 0, i32 22
  %124 = load i32, ptr %123, align 8, !tbaa !45
  %125 = mul nsw i32 %124, %109
  %126 = zext i8 %121 to i64
  %127 = getelementptr inbounds %struct.layer_data, ptr %122, i64 0, i32 8, i64 %126
  ...
  %133 = or i32 %132, 1
  %134 = select i1 %130, i32 0, i32 %133
  %135 = icmp eq i32 %107, 0
  br i1 %135, label %136, label %139

136:                                              ; preds = %118
  %137 = tail call i32 @llvm.smin.i32(i32 %134, i32 2047)
  %138 = trunc i32 %137 to i16
  br label %144

139:                                              ; preds = %118
  %140 = icmp sgt i32 %134, 2048
  %141 = trunc i32 %134 to i16
  %142 = sub i16 0, %141
  %143 = select i1 %140, i16 -2048, i16 %142
  br label %144

144:                                              ; preds = %139, %136
  %145 = phi i16 [ %138, %136 ], [ %143, %139 ]
  %146 = getelementptr inbounds i16, ptr %5, i64 %126
  store i16 %145, ptr %146, align 2
  %147 = add nsw i32 %110, 1
  br label %29

148:                                              ; preds = %115, %112, %73, %70
...
5:                                                ; preds = %139, %1
  ...
  %7 = tail call i32 @Show_Bits(i32 noundef 16) #33
...
71:                                               ; preds = %62, %55, %48, %41, %34, %27, %20, %16, %14
  ...
  tail call void @Flush_Buffer(i32 noundef %75) #33
...
77:                                               ; preds = %71
  %78 = tail call i32 @Get_Bits(i32 noundef 6) #33
  %79 = tail call i32 @Get_Bits(i32 noundef 8) #33
...
80:                                               ; preds = %77
  %81 = tail call i32 @Get_Bits(i32 noundef 8) #33
  br label %89

82:                                               ; preds = %77
  %83 = tail call i32 @Get_Bits(i32 noundef 8) #33
  %84 = add i32 %83, -256
  br label %89
...
93:                                               ; preds = %71
  ...
  %98 = tail call i32 @Get_Bits(i32 noundef 1) #33
  br label %99
...
24:                                               ; preds = %16
  %25 = call i32 @_wyvern_slice_Decode_MPEG1_Intra_Block__554320646(ptr %1)
...
26:                                               ; preds = %16
  %27 = and i32 %0, 1
  %28 = icmp eq i32 %27, 0
  %29 = tail call i32 @Get_Chroma_DC_dct_diff() #33
...
38:                                               ; preds = %34, %30, %24
  %39 = phi i32 [ %25, %24 ], [ %33, %30 ], [ %37, %34 ]
  %40 = load i32, ptr @Fault_Flag, align 4, !tbaa !7
  %41 = icmp eq i32 %40, 0
  br i1 %41, label %42, label %189

42:                                               ; preds = %38
  %43 = load i32, ptr @intra_dc_precision, align 4, !tbaa !7
  %44 = sub nsw i32 3, %43
  %45 = shl i32 %39, %44
  %46 = trunc i32 %45 to i16
  store i16 %46, ptr %9, align 2, !tbaa !47
  %47 = getelementptr inbounds %struct.layer_data, ptr %7, i64 0, i32 19
  %48 = getelementptr inbounds %struct.layer_data, ptr %7, i64 0, i32 22
  br label %49

49:                                               ; preds = %186, %42
  %50 = phi i32 [ 0, %42 ], [ %178, %186 ]
  %51 = phi i32 [ 1, %42 ], [ %187, %186 ]
  %52 = tail call i32 @Show_Bits(i32 noundef 16) #33
  %53 = icmp ult i32 %52, 16384
  %54 = load i32, ptr @intra_vlc_format, align 4
  %55 = icmp ne i32 %54, 0
...
57:                                               ; preds = %49
  ...
  %61 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtabnext, i64 0, i64 %60
  br label %121

62:                                               ; preds = %49
  %63 = icmp ugt i32 %52, 1023
...
68:                                               ; preds = %64
  %69 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab0a, i64 0, i64 %67
  br label %121

70:                                               ; preds = %64
  %71 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab0, i64 0, i64 %67
  br label %121

72:                                               ; preds = %62
  %73 = icmp ugt i32 %52, 511
...
78:                                               ; preds = %74
  %79 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab1a, i64 0, i64 %77
  br label %121

80:                                               ; preds = %74
  %81 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab1, i64 0, i64 %77
  br label %121

82:                                               ; preds = %72
  %83 = icmp ugt i32 %52, 255
...
84:                                               ; preds = %82
  ...
  %88 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab2, i64 0, i64 %87
  br label %121

89:                                               ; preds = %82
  %90 = icmp ugt i32 %52, 127
...
91:                                               ; preds = %89
  ...
  %95 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab3, i64 0, i64 %94
  br label %121

96:                                               ; preds = %89
  %97 = icmp ugt i32 %52, 63
...
98:                                               ; preds = %96
  ...
  %102 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab4, i64 0, i64 %101
  br label %121

103:                                              ; preds = %96
  %104 = icmp ugt i32 %52, 31
...
105:                                              ; preds = %103
  ...
  %109 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab5, i64 0, i64 %108
  br label %121

110:                                              ; preds = %103
  %111 = icmp ugt i32 %52, 15
  br i1 %111, label %112, label %116

112:                                              ; preds = %110
  %113 = add nsw i32 %52, -16
  %114 = zext i32 %113 to i64
  %115 = getelementptr inbounds [0 x %struct.DCTtab], ptr @DCTtab6, i64 0, i64 %114
  br label %121

116:                                              ; preds = %110
  %117 = load i32, ptr @Quiet_Flag, align 4, !tbaa !7
  %118 = icmp eq i32 %117, 0
  br i1 %118, label %119, label %188

119:                                              ; preds = %116
  %120 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.11.226)
  br label %188

121:                                              ; preds = %112, %105, %98, %91, %84, %80, %78, %70, %68, %57
  %122 = phi ptr [ %69, %68 ], [ %71, %70 ], [ %79, %78 ], [ %81, %80 ], [ %88, %84 ], [ %95, %91 ], [ %102, %98 ], [ %109, %105 ], [ %115, %112 ], [ %61, %57 ]
  %123 = getelementptr inbounds %struct.DCTtab, ptr %122, i64 0, i32 2
  %124 = load i8, ptr %123, align 1, !tbaa !123
  %125 = sext i8 %124 to i32
  tail call void @Flush_Buffer(i32 noundef %125) #33
  %126 = load i8, ptr %122, align 1, !tbaa !125
...
127:                                              ; preds = %121
  %128 = tail call i32 @Get_Bits(i32 noundef 6) #33
  %129 = tail call i32 @Get_Bits(i32 noundef 12) #33
  %130 = and i32 %129, 2047
  %131 = icmp eq i32 %130, 0
  br i1 %131, label %132, label %137

132:                                              ; preds = %127
  %133 = load i32, ptr @Quiet_Flag, align 4, !tbaa !7
  %134 = icmp eq i32 %133, 0
  br i1 %134, label %135, label %188

135:                                              ; preds = %132
  %136 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.13.227)
  br label %188

137:                                              ; preds = %127
  %138 = icmp sgt i32 %129, 2047
  %139 = zext i1 %138 to i32
  %140 = sub nsw i32 4096, %129
  %141 = select i1 %138, i32 %140, i32 %129
  br label %148

142:                                              ; preds = %121
  %143 = sext i8 %126 to i32
  %144 = getelementptr inbounds %struct.DCTtab, ptr %122, i64 0, i32 1
  %145 = load i8, ptr %144, align 1, !tbaa !126
  %146 = sext i8 %145 to i32
  %147 = tail call i32 @Get_Bits(i32 noundef 1) #33
  br label %148

148:                                              ; preds = %142, %137
  %149 = phi i32 [ %147, %142 ], [ %139, %137 ]
  %150 = phi i32 [ %143, %142 ], [ %128, %137 ]
  %151 = phi i32 [ %146, %142 ], [ %141, %137 ]
  %152 = add nsw i32 %150, %51
  %153 = icmp sgt i32 %152, 63
  br i1 %153, label %154, label %160

154:                                              ; preds = %148
  %155 = load i32, ptr @Quiet_Flag, align 4, !tbaa !7
  %156 = icmp eq i32 %155, 0
  br i1 %156, label %157, label %188

157:                                              ; preds = %154
  %158 = load ptr, ptr @stdout, align 8, !tbaa !11
  %159 = tail call i64 @fwrite(ptr nonnull @.str.6.228, i64 43, i64 1, ptr %158)
  br label %188

160:                                              ; preds = %148
  %161 = load i32, ptr %47, align 4, !tbaa !40
  %162 = sext i32 %161 to i64
  %163 = sext i32 %152 to i64
  %164 = getelementptr inbounds [2 x [64 x i8]], ptr @scan, i64 0, i64 %162, i64 %163
  %165 = load i8, ptr %164, align 1, !tbaa !15
  %166 = load i32, ptr %48, align 8, !tbaa !45
  %167 = mul nsw i32 %166, %151
  %168 = zext i8 %165 to i64
  %169 = getelementptr inbounds i32, ptr %23, i64 %168
  %170 = load i32, ptr %169, align 4, !tbaa !7
  %171 = mul nsw i32 %167, %170
  %172 = ashr i32 %171, 4
  %173 = icmp eq i32 %149, 0
  %174 = sub nsw i32 0, %172
  %175 = select i1 %173, i32 %172, i32 %174
  %176 = trunc i32 %175 to i16
  %177 = getelementptr inbounds i16, ptr %9, i64 %168
  store i16 %176, ptr %177, align 2, !tbaa !47
  %178 = add nuw nsw i32 %50, 1
  %179 = load i32, ptr getelementptr inbounds (%struct.layer_data, ptr @base, i64 0, i32 17), align 4, !tbaa !29
  %180 = icmp eq i32 %179, 1
  br i1 %180, label %181, label %186

181:                                              ; preds = %160
  %182 = load i32, ptr getelementptr inbounds (%struct.layer_data, ptr @base, i64 0, i32 21), align 4, !tbaa !44
  %183 = add i32 %182, -64
...
186:                                              ; preds = %185, %181, %160
  %187 = add nsw i32 %152, 1
  br label %49

188:                                              ; preds = %157, %154, %135, %132, %119, %116
  store i32 1, ptr @Fault_Flag, align 4, !tbaa !7
  br label %189

189:                                              ; preds = %188, %121, %38
  ret void
}
...
25:                                               ; preds = %159, %15
  ...
  %28 = tail call i32 @Show_Bits(i32 noundef 16) #33
...
92:                                               ; preds = %83, %76, %69, %62, %55, %48, %41, %37, %35
  ...
  tail call void @Flush_Buffer(i32 noundef %96) #33
...
98:                                               ; preds = %92
  %99 = tail call i32 @Get_Bits(i32 noundef 6) #33
  %100 = tail call i32 @Get_Bits(i32 noundef 12) #33
...
113:                                              ; preds = %92
  ...
  %118 = tail call i32 @Get_Bits(i32 noundef 1) #33
  br label %119
...
5:                                                ; preds = %0
  %6 = tail call i32 @Show_Bits(i32 noundef 3) #33
  %7 = icmp eq i32 %6, 0
...
14:                                               ; preds = %5
  ...
  tail call void @Flush_Buffer(i32 noundef %19) #33
...
28:                                               ; preds = %24
  %29 = tail call i32 @Show_Bits(i32 noundef 4) #33
  %30 = icmp eq i32 %29, 0
...
37:                                               ; preds = %28
  ...
  tail call void @Flush_Buffer(i32 noundef %42) #33
  %43 = load i8, ptr %39, align 2, !tbaa !129
  %44 = sext i8 %43 to i32
  br label %194

45:                                               ; preds = %24
  %46 = tail call i32 @Get_Bits1() #33
  %47 = icmp eq i32 %46, 0
  br i1 %47, label %48, label %194

48:                                               ; preds = %45
  %49 = tail call i32 @Get_Bits1() #33
  %50 = icmp eq i32 %49, 0
...
61:                                               ; preds = %57
  %62 = tail call i32 @Show_Bits(i32 noundef 7) #33
...
72:                                               ; preds = %70
  ...
  tail call void @Flush_Buffer(i32 noundef %78) #33
...
81:                                               ; preds = %70
  ...
  tail call void @Flush_Buffer(i32 noundef %86) #33
  %87 = load i8, ptr %83, align 2, !tbaa !129
  %88 = sext i8 %87 to i32
  br label %194

89:                                               ; preds = %57
  %90 = tail call i32 @Show_Bits(i32 noundef 6) #33
...
92:                                               ; preds = %89
  ...
  tail call void @Flush_Buffer(i32 noundef %98) #33
...
109:                                              ; preds = %101
  ...
  tail call void @Flush_Buffer(i32 noundef %114) #33
...
121:                                              ; preds = %117
  %122 = tail call i32 @Show_Bits(i32 noundef 9) #33
...
148:                                              ; preds = %138, %131, %124
  ...
  tail call void @Flush_Buffer(i32 noundef %152) #33
  %153 = load i8, ptr %149, align 1, !tbaa !129
  %154 = sext i8 %153 to i32
  br label %194

155:                                              ; preds = %117
  %156 = tail call i32 @Show_Bits(i32 noundef 6) #33
...
158:                                              ; preds = %155
  ...
  tail call void @Flush_Buffer(i32 noundef %164) #33
...
175:                                              ; preds = %167
  ...
  tail call void @Flush_Buffer(i32 noundef %180) #33
  %181 = load i8, ptr %177, align 2, !tbaa !129
  %182 = sext i8 %181 to i32
  br label %194

183:                                              ; preds = %22
  %184 = tail call i32 @Get_Bits1() #33
  %185 = icmp eq i32 %184, 0
...
define internal i32 @Get_motion_code() #0 {
  %1 = tail call i32 @Get_Bits1() #33
  %2 = icmp eq i32 %1, 0
  br i1 %2, label %3, label %57

3:                                                ; preds = %0
  %4 = tail call i32 @Show_Bits(i32 noundef 9) #33
  %5 = icmp sgt i32 %4, 63
...
6:                                                ; preds = %3
  ...
  tail call void @Flush_Buffer(i32 noundef %12) #33
  %13 = tail call i32 @Get_Bits1() #33
  %14 = icmp eq i32 %13, 0
...
21:                                               ; preds = %19
  ...
  tail call void @Flush_Buffer(i32 noundef %27) #33
  %28 = tail call i32 @Get_Bits1() #33
  %29 = icmp eq i32 %28, 0
...
39:                                               ; preds = %36
  ...
  %42 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1.237, i32 noundef %40, i32 noundef %41) #32
  br label %43
...
44:                                               ; preds = %34
  ...
  tail call void @Flush_Buffer(i32 noundef %50) #33
  %51 = tail call i32 @Get_Bits1() #33
  %52 = icmp eq i32 %51, 0
...
define internal i32 @Get_dmvector() #0 {
  %1 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %2 = icmp eq i32 %1, 0
  br i1 %2, label %7, label %3

3:                                                ; preds = %0
  %4 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %5 = icmp eq i32 %4, 0
...
define internal i32 @Get_coded_block_pattern() #0 {
  %1 = tail call i32 @Show_Bits(i32 noundef 9) #33
...
3:                                                ; preds = %0
  ...
  %9 = sext i8 %8 to i32
  tail call void @Flush_Buffer(i32 noundef %9) #33
...
14:                                               ; preds = %12
  ...
  tail call void @Flush_Buffer(i32 noundef %20) #33
...
31:                                               ; preds = %23
  ...
  tail call void @Flush_Buffer(i32 noundef %36) #33
...
1:                                                ; preds = %14, %0
  %2 = phi i32 [ 0, %0 ], [ %15, %14 ]
  %3 = tail call i32 @Show_Bits(i32 noundef 11) #33
  %4 = icmp slt i32 %3, 24
...
14:                                               ; preds = %6, %5
  %15 = phi i32 [ %7, %6 ], [ %2, %5 ]
  tail call void @Flush_Buffer(i32 noundef 11) #33
...
18:                                               ; preds = %16
  tail call void @Flush_Buffer(i32 noundef 1) #33
...
22:                                               ; preds = %20
  ...
  tail call void @Flush_Buffer(i32 noundef %28) #33
...
32:                                               ; preds = %20
  ...
  %38 = sext i8 %37 to i32
  tail call void @Flush_Buffer(i32 noundef %38) #33
...
define internal i32 @Get_Luma_DC_dct_diff() #0 {
  %1 = tail call i32 @Show_Bits(i32 noundef 5) #33
  %2 = icmp slt i32 %1, 31
...
7:                                                ; preds = %0
  %8 = tail call i32 @Show_Bits(i32 noundef 9) #33
  %9 = add i32 %8, -496
...
13:                                               ; preds = %7, %3
  ...
  tail call void @Flush_Buffer(i32 noundef %18) #33
  %19 = sext i8 %16 to i32
  %20 = icmp eq i8 %16, 0
  br i1 %20, label %31, label %21

21:                                               ; preds = %13
  %22 = tail call i32 @Get_Bits(i32 noundef %19) #33
  %23 = add nsw i32 %19, -1
  %24 = shl nuw i32 1, %23
  %25 = and i32 %22, %24
  %26 = icmp eq i32 %25, 0
...
7:                                                ; preds = %0
  %8 = tail call i32 @Show_Bits(i32 noundef 10) #33
  %9 = add i32 %8, -992
  %10 = sext i32 %9 to i64
...
17:                                               ; preds = %12
  %18 = tail call i32 @Get_Bits(i32 noundef 1) #33
...
22:                                               ; preds = %17, %15
  ...
  tail call void @motion_vector(ptr noundef %24, ptr noundef %1, i32 noundef %6, i32 noundef %7, i32 noundef %8, i32 noundef %9, i32 noundef 0) #32
...
27:                                               ; preds = %10
  %28 = tail call i32 @Get_Bits(i32 noundef 1) #33
  %29 = sext i32 %3 to i64
  ...
  tail call void @motion_vector(ptr noundef %31, ptr noundef %1, i32 noundef %6, i32 noundef %7, i32 noundef %8, i32 noundef %9, i32 noundef 0) #32
  %32 = tail call i32 @Get_Bits(i32 noundef 1) #33
  ...
  tail call void @motion_vector(ptr noundef nonnull %34, ptr noundef %1, i32 noundef %6, i32 noundef %7, i32 noundef %8, i32 noundef %9, i32 noundef 0) #32
  br label %35
...
define internal void @motion_vector(ptr nocapture noundef %0, ptr nocapture noundef writeonly %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef %6) #0 {
  %8 = tail call i32 @Get_motion_code() #33
  %9 = icmp ne i32 %2, 0
  %10 = icmp ne i32 %8, 0
...
14:                                               ; preds = %12, %7
  ...
  tail call fastcc void @decode_motion_vector(ptr noundef %0, i32 noundef %2, i32 noundef %8, i32 noundef %15, i32 noundef %6) #32
  %16 = icmp eq i32 %4, 0
  br i1 %16, label %19, label %17

17:                                               ; preds = %14
  %18 = tail call i32 @Get_dmvector() #33
  store i32 %18, ptr %1, align 4, !tbaa !7
  br label %19

19:                                               ; preds = %17, %14
  %20 = tail call i32 @Get_motion_code() #33
  %21 = icmp ne i32 %3, 0
  %22 = icmp ne i32 %20, 0
...
24:                                               ; preds = %19
  %25 = tail call i32 @Get_Bits(i32 noundef %3) #33
  br label %26
...
30:                                               ; preds = %26
  tail call fastcc void @decode_motion_vector(ptr noundef nonnull %29, i32 noundef %3, i32 noundef %20, i32 noundef %27, i32 noundef %6) #32
  br label %36
...
37:                                               ; preds = %36
  %38 = tail call i32 @Get_dmvector() #33
...
68:                                               ; preds = %4
  %69 = call i32 @_wyvern_slice_Dual_Prime_Arithmetic__440942178(i32 %2)
  %70 = ashr i32 %69, 1
  %71 = load i32, ptr %1, align 4, !tbaa !7
  %72 = add nsw i32 %71, %70
  store i32 %72, ptr %0, align 4, !tbaa !7
  %73 = call i32 @_wyvern_slice_Dual_Prime_Arithmetic__440942178(i32 %3)
  %74 = ashr i32 %73, 1
  %75 = getelementptr inbounds i32, ptr %1, i64 1
  %76 = load i32, ptr %75, align 4, !tbaa !7
  %77 = add nsw i32 %76, %74
  %78 = getelementptr inbounds [2 x i32], ptr %0, i64 0, i64 1
  %79 = load i32, ptr @picture_structure, align 4, !tbaa !7
  %80 = icmp eq i32 %79, 1
  br i1 %80, label %81, label %83

81:                                               ; preds = %68
  %82 = add nsw i32 %77, -1
  store i32 %82, ptr %78, align 4, !tbaa !7
  br label %85

83:                                               ; preds = %68
  %84 = add nsw i32 %77, 1
  store i32 %84, ptr %78, align 4, !tbaa !7
  br label %85

85:                                               ; preds = %83, %81, %39, %10
  ret void
}
...
5:                                                ; preds = %0
  tail call fastcc void @Read_Lower_Layer_Component_Framewise(i32 noundef 0, i32 noundef %3, i32 noundef %4) #32
  ...
  %9 = ashr i32 %8, 1
  tail call fastcc void @Read_Lower_Layer_Component_Framewise(i32 noundef 1, i32 noundef %7, i32 noundef %9) #32
  ...
  %13 = ashr i32 %12, 1
  tail call fastcc void @Read_Lower_Layer_Component_Framewise(i32 noundef 2, i32 noundef %11, i32 noundef %13) #32
  br label %23

14:                                               ; preds = %0
  tail call fastcc void @Read_Lower_Layer_Component_Fieldwise(i32 noundef 0, i32 noundef %3, i32 noundef %4) #32
  ...
  %18 = ashr i32 %17, 1
  tail call fastcc void @Read_Lower_Layer_Component_Fieldwise(i32 noundef 1, i32 noundef %16, i32 noundef %18) #32
  ...
  %22 = ashr i32 %21, 1
  tail call fastcc void @Read_Lower_Layer_Component_Fieldwise(i32 noundef 2, i32 noundef %20, i32 noundef %22) #32
  br label %23
...
define internal fastcc void @Read_Lower_Layer_Component_Framewise(i32 noundef %0, i32 noundef %1, i32 noundef %2) unnamed_addr #0 {
  ...
  %7 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %5, i32 noundef %6) #33
  %8 = zext i32 %0 to i64
  %9 = getelementptr inbounds [3 x [3 x i8]], ptr @__const.Read_Lower_Layer_Component_Fieldwise.ext, i64 0, i64 %8
  %10 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %9) #33
  %11 = call noalias ptr @fopen(ptr noundef nonnull %4, ptr noundef nonnull @.str.278) #32
  %12 = icmp eq ptr %11, null
...
27:                                               ; preds = %27, %24
  ...
  %29 = call i32 @getc(ptr noundef nonnull %11) #32
...
49:                                               ; preds = %49, %46
  ...
  %51 = call i32 @getc(ptr noundef nonnull %11) #32
...
62:                                               ; preds = %58, %13
  %63 = call i32 @fclose(ptr noundef nonnull %11) #32
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %4) #40
  ret void
}
...
define internal fastcc void @Read_Lower_Layer_Component_Fieldwise(i32 noundef %0, i32 noundef %1, i32 noundef %2) unnamed_addr #0 {
  ...
  %10 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %5, i32 noundef %6, i32 noundef %9) #33
  %11 = zext i32 %0 to i64
  %12 = getelementptr inbounds [3 x [3 x i8]], ptr @__const.Read_Lower_Layer_Component_Fieldwise.ext, i64 0, i64 %11
  %13 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %12) #33
  %14 = call noalias ptr @fopen(ptr noundef nonnull %4, ptr noundef nonnull @.str.278) #32
...
28:                                               ; preds = %28, %25
  ...
  %30 = call i32 @getc(ptr noundef nonnull %14) #32
...
43:                                               ; preds = %37, %16
  %44 = call i32 @fclose(ptr noundef nonnull %14) #32
...
47:                                               ; preds = %43
  ...
  %50 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %48, i32 noundef %49, i32 noundef 98) #33
  %51 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %12) #33
  %52 = call noalias ptr @fopen(ptr noundef nonnull %4, ptr noundef nonnull @.str.278) #32
...
67:                                               ; preds = %67, %65
  ...
  %69 = call i32 @getc(ptr noundef nonnull %52) #32
...
79:                                               ; preds = %76, %54
  %80 = call i32 @fclose(ptr noundef nonnull %52) #32
  br label %81
...
23:                                               ; preds = %17
  tail call fastcc void @Subsample_Vertical(ptr noundef %2, ptr noundef %4, i32 noundef %8, i32 noundef %9, i32 noundef %21, i32 noundef %12, i32 noundef %13, i32 noundef 0, i32 noundef 1) #32
  br label %32
...
29:                                               ; preds = %26
  tail call fastcc void @Deinterlace(ptr noundef %3, ptr noundef %2, i32 noundef 0, i32 noundef %8, i32 noundef %9, i32 noundef %16) #32
  tail call fastcc void @Subsample_Vertical(ptr noundef %3, ptr noundef %4, i32 noundef %8, i32 noundef %9, i32 noundef %21, i32 noundef %12, i32 noundef %13, i32 noundef 0, i32 noundef 1) #32
  br label %32

30:                                               ; preds = %26
  tail call fastcc void @Deinterlace(ptr noundef %2, ptr noundef %3, i32 noundef 1, i32 noundef %8, i32 noundef %9, i32 noundef %16) #32
  tail call fastcc void @Subsample_Vertical(ptr noundef %2, ptr noundef %4, i32 noundef %8, i32 noundef %9, i32 noundef %21, i32 noundef %12, i32 noundef %13, i32 noundef 0, i32 noundef 1) #32
  br label %32
...
31:                                               ; preds = %24
  tail call fastcc void @Deinterlace(ptr noundef %2, ptr noundef %3, i32 noundef 1, i32 noundef %8, i32 noundef %9, i32 noundef %16) #32
  tail call fastcc void @Deinterlace(ptr noundef %3, ptr noundef %2, i32 noundef 0, i32 noundef %8, i32 noundef %9, i32 noundef %16) #32
  tail call fastcc void @Subsample_Vertical(ptr noundef %2, ptr noundef %4, i32 noundef %8, i32 noundef %9, i32 noundef %21, i32 noundef %12, i32 noundef %13, i32 noundef 0, i32 noundef 2) #32
  tail call fastcc void @Subsample_Vertical(ptr noundef %3, ptr noundef %4, i32 noundef %8, i32 noundef %9, i32 noundef %21, i32 noundef %12, i32 noundef %13, i32 noundef 1, i32 noundef 2) #32
  br label %32
...
1:                                                ; preds = %17, %112, %0
  %2 = tail call i32 @Get_Word() #33
  %3 = shl i32 %2, 16
  %4 = tail call i32 @Get_Word() #33
  %5 = or i32 %3, %4
  %6 = and i32 %5, -256
  %7 = icmp eq i32 %6, 256
...
55:                                               ; preds = %53
  ...
  %57 = tail call i64 @fwrite(ptr nonnull @.str.1.282, i64 23, i64 1, ptr %56) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable
...
69:                                               ; preds = %67
  ...
  %71 = tail call i64 @fwrite(ptr nonnull @.str.1.282, i64 23, i64 1, ptr %70) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable
...
86:                                               ; preds = %84
  ...
  %88 = tail call i64 @fwrite(ptr nonnull @.str.1.282, i64 23, i64 1, ptr %87) #39
  tail call void @exit(i32 noundef 1) #35
  unreachable
...
119:                                              ; preds = %110
  ...
  %121 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %120, ptr noundef nonnull @.str.2.283, i32 noundef %.lcssa2) #34
  tail call void @exit(i32 noundef 1) #35
  unreachable

122:                                              ; preds = %104, %84, %79, %72, %33
  ret void
}
...
define internal i32 @Get_Bits32() #0 {
  %1 = tail call i32 @Show_Bits(i32 noundef 32) #33
  tail call void @Flush_Buffer32() #32
  ret i32 %1
}

; Function Attrs: noinline nounwind optsize willreturn
define internal i32 @_wyvern_slice_main__326851271() #31 {
sliceclone_:
  %0 = load i32, ptr @horizontal_size, align 4, !tbaa !7
  %1 = add nsw i32 %0, 15
  %2 = sdiv i32 %1, 16
  ret i32 %2
}
...
; Function Attrs: noinline nounwind optsize willreturn
define internal i32 @_wyvern_slice_store_ppm_tga__393286742(ptr %0) #31 {
sliceclone_:
...
; Function Attrs: noinline nounwind optsize willreturn
define internal i32 @_wyvern_slice_Read_Frame__807793023() #31 {
sliceclone_:
  %0 = load i32, ptr @Coded_Picture_Width, align 4, !tbaa !7
  %1 = load i32, ptr @Coded_Picture_Height, align 4, !tbaa !7
  %2 = mul nsw i32 %1, %0
  ret i32 %2
}

; Function Attrs: noinline nounwind optsize willreturn
define internal i32 @_wyvern_slice_Get_Bits__795675944(i32 %0) #31 {
sliceclone_:
  %1 = load ptr, ptr @ld, align 8, !tbaa !11
  %2 = getelementptr inbounds %struct.layer_data, ptr %1, i64 0, i32 4
  %3 = load i32, ptr %2, align 8, !tbaa !76
...
; Function Attrs: noinline nounwind optsize willreturn
define internal i32 @_wyvern_slice_Decode_MPEG1_Intra_Block__554320646(ptr %0) #31 {
sliceclone_:
  %1 = tail call i32 @Get_Luma_DC_dct_diff() #33
...
; Function Attrs: noinline nounwind optsize willreturn
define internal i32 @_wyvern_slice_Dual_Prime_Arithmetic__440942178(i32 %0) #31 {
sliceclone_:
  %1 = icmp sgt i32 %0, 0
  %2 = zext i1 %1 to i32
  %3 = add nsw i32 %2, %0
