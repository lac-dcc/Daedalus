...
30:                                               ; preds = %30, %24
  ...
  store <2 x double> %35, ptr %36, align 8, !tbaa !7
...
40:                                               ; preds = %30
  ...
  br i1 %42, label %43, label %24, !llvm.loop !17
...
49:                                               ; preds = %49, %43
  ...
  store <2 x double> %54, ptr %55, align 8, !tbaa !7
...
69:                                               ; preds = %69, %64
  ...
  store double %77, ptr %66, align 8, !tbaa !7
...
80:                                               ; preds = %69
  ...
  br i1 %82, label %83, label %64, !llvm.loop !21
...
93:                                               ; preds = %93, %88
  ...
  br i1 %104, label %105, label %93, !llvm.loop !23

105:                                              ; preds = %93
  %106 = add nuw nsw i64 %89, 1
  %107 = icmp eq i64 %106, 1024
  br i1 %107, label %108, label %88, !llvm.loop !24

108:                                              ; preds = %105
  %109 = add nuw nsw i64 %87, 1
  %110 = icmp eq i64 %109, 1024
  br i1 %110, label %111, label %86, !llvm.loop !25
...
122:                                              ; preds = %113
  ...
  %126 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %125, ptr noundef nonnull @.str.2, i32 noundef %123, i32 noundef %124, double noundef %.lcssa2, i32 noundef %123, i32 noundef %124, double noundef %.lcssa, double noundef 1.000000e-05) #9
  br label %198
...
133:                                              ; preds = %130
  %134 = tail call noalias dereferenceable_or_null(16385) ptr @malloc(i64 noundef 16385) #10
