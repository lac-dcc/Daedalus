...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 {
  ...
  call void @initParallel(ptr noundef nonnull %7, ptr noundef nonnull %8) #40
  call void @profileStart(i32 noundef 0) #40
  call void @timestampBarrier(ptr noundef nonnull @.str) #40
  %10 = load ptr, ptr @stdout, align 8, !tbaa !11
  call void @yamlAppInfo(ptr noundef %10) #40
  call void @llvm.lifetime.start.p0(i64 3144, ptr nonnull %9) #41
  %11 = load i32, ptr %7, align 4, !tbaa !7
  %12 = load ptr, ptr %8, align 8, !tbaa !11
  call void @parseCommandLine(ptr nonnull sret(%struct.CommandSt) align 8 %9, i32 noundef %11, ptr noundef %12) #40
  %13 = load ptr, ptr @stdout, align 8, !tbaa !11
  call void @printCmdYaml(ptr noundef %13, ptr noundef nonnull %9) #40
  ...
  %14 = call noalias dereferenceable_or_null(80) ptr @malloc(i64 noundef 80) #42
...
27:                                               ; preds = %2
  ...
  %30 = call ptr @initEamPot(ptr noundef nonnull %6, ptr noundef nonnull %29, ptr noundef nonnull %28) #40
  br label %33

31:                                               ; preds = %2
  %32 = call ptr @initLjPot() #40
  br label %33
...
42:                                               ; preds = %39, %33
  ...
  %60 = call i32 @getNRanks() #40
  %61 = icmp eq i32 %59, %60
  br i1 %61, label %68, label %62

62:                                               ; preds = %42
  %63 = call i32 @printRank() #40
  %64 = icmp eq i32 %63, 0
...
93:                                               ; preds = %89
  ...
  %97 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %94, ptr noundef nonnull @.str.6, double noundef %72, double noundef %95, double noundef %96) #43
  br label %98

98:                                               ; preds = %93, %89, %80
  %99 = phi i32 [ %90, %93 ], [ %90, %89 ], [ %69, %80 ]
  %100 = call i32 @strcasecmp(ptr noundef nonnull %45, ptr noundef nonnull @.str.7) #44
  %101 = icmp eq i32 %100, 0
  br i1 %101, label %110, label %102

102:                                              ; preds = %98
  %103 = or i32 %99, 4
  %104 = call i32 @printRank() #40
  %105 = icmp eq i32 %104, 0
  br i1 %105, label %109, label %106

106:                                              ; preds = %102
  %107 = load ptr, ptr @stdout, align 8, !tbaa !11
  %108 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %107, ptr noundef nonnull @.str.8, ptr noundef nonnull %45) #43
  br label %109

109:                                              ; preds = %106, %102
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %4) #41
  store i32 %103, ptr %4, align 4, !tbaa !7
  call void @bcastParallel(ptr noundef nonnull %4, i32 noundef 4, i32 noundef 0) #40
  br label %112
...
112:                                              ; preds = %110, %109
  ...
  call void @exit(i32 noundef %113) #45
  unreachable
...
114:                                              ; preds = %110
  ...
  %118 = call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #42
  %119 = getelementptr inbounds %struct.BasePotentialSt, ptr %117, i64 0, i32 4
  %120 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %118, ptr noundef nonnull dereferenceable(1) %119) #40
  ...
  %140 = call ptr @initDecomposition(i32 noundef %137, i32 noundef %138, i32 noundef %139, ptr noundef nonnull %5) #40
  store ptr %140, ptr %21, align 8, !tbaa !36
  %141 = load double, ptr %117, align 8, !tbaa !24
  %142 = call ptr @initLinkCells(ptr noundef %140, double noundef %141) #40
  store ptr %142, ptr %116, align 8, !tbaa !37
  %143 = call ptr @initAtoms(ptr noundef %142) #40
  ...
  call void @createFccLattice(i32 noundef %144, i32 noundef %145, i32 noundef %146, double noundef %43, ptr noundef nonnull %14) #40
  %147 = getelementptr inbounds %struct.CommandSt, ptr %6, i64 0, i32 14
  %148 = load double, ptr %147, align 8, !tbaa !41
  call void @setTemperature(ptr noundef nonnull %14, double noundef %148) #40
  %149 = getelementptr inbounds %struct.CommandSt, ptr %6, i64 0, i32 15
  %150 = load double, ptr %149, align 8, !tbaa !42
  call void @randomDisplacements(ptr noundef nonnull %14, double noundef %150) #40
  %151 = load ptr, ptr %21, align 8, !tbaa !36
  %152 = load ptr, ptr %116, align 8, !tbaa !37
  %153 = call ptr @initAtomHaloExchange(ptr noundef %151, ptr noundef %152) #40
  store ptr %153, ptr %23, align 8, !tbaa !18
  call void @profileStart(i32 noundef 5) #40
  call void @redistributeAtoms(ptr noundef nonnull %14) #40
  call void @profileStop(i32 noundef 5) #40
  call void @profileStart(i32 noundef 7) #40
  call void @computeForce(ptr noundef nonnull %14) #40
  call void @profileStop(i32 noundef 7) #40
  call void @kineticEnergy(ptr noundef nonnull %14) #40
  ...
  %156 = call i32 @maxOccupancy(ptr noundef %155) #40
  %157 = call i32 @printRank() #40
...
159:                                              ; preds = %114
  ...
  %164 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.21, i32 noundef %163) #43
  ...
  %172 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.22, double noundef %167, double noundef %169, double noundef %171) #43
  ...
  %180 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.23, double noundef %175, double noundef %177, double noundef %179) #43
  call void @printSeparator(ptr noundef %154) #40
  ...
  %188 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.25, i32 noundef %183, i32 noundef %185, i32 noundef %187) #43
  ...
  %197 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.26, i32 noundef %190, i32 noundef %192, i32 noundef %194, i32 noundef %196) #43
  ...
  %205 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.27, double noundef %200, double noundef %202, double noundef %204) #43
  ...
  %218 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.28, double noundef %211, double noundef %214, double noundef %217) #43
  %219 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.29, i32 noundef %156, i32 noundef 64) #43
  call void @printSeparator(ptr noundef %154) #40
  ...
  call void %223(ptr noundef %154, ptr noundef %221) #40
  ...
  %258 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.32, i32 noundef 88) #43
  %259 = fpext float %235 to double
  %260 = fpext float %229 to double
  %261 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.33, double noundef %259, double noundef %260) #43
  %262 = fpext float %252 to double
  %263 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.34, double noundef %262) #43
  %264 = fpext float %256 to double
  %265 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %154, ptr noundef nonnull @.str.35, double noundef %264) #43
  %266 = call i32 @fflush(ptr noundef %154) #43
  br label %267

267:                                              ; preds = %159, %114
  call fastcc void @sumAtoms(ptr noundef nonnull %14) #43
...
279:                                              ; preds = %267
  ...
  call void @printSeparator(ptr noundef %282) #40
  %283 = load ptr, ptr @stdout, align 8, !tbaa !11
  %284 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %283, ptr noundef nonnull @.str.10, double noundef %276, i32 noundef %274) #43
  %285 = load ptr, ptr @stdout, align 8, !tbaa !11
  %286 = call i32 @fputc(i32 10, ptr %285)
  br label %287

287:                                              ; preds = %279, %267
  call void @timestampBarrier(ptr noundef nonnull @.str.1) #40
  call void @timestampBarrier(ptr noundef nonnull @.str.2) #40
  %288 = load i32, ptr %14, align 8, !tbaa !49
  %289 = load i32, ptr %16, align 4, !tbaa !50
  call void @profileStart(i32 noundef 1) #40
  %290 = icmp sgt i32 %288, 0
  br i1 %290, label %291, label %298

291:                                              ; preds = %291, %287
  %292 = phi i32 [ %296, %291 ], [ 0, %287 ]
  call void @profileStart(i32 noundef 10) #40
  call fastcc void @sumAtoms(ptr noundef nonnull %14) #43
  call void @profileStop(i32 noundef 10) #40
  %293 = call double @getElapsedTime(i32 noundef 2) #40
  call fastcc void @printThings(ptr noundef nonnull %14, i32 noundef %292) #43
  call void @profileStart(i32 noundef 2) #40
  %294 = load double, ptr %20, align 8, !tbaa !16
  %295 = call double @timestep(ptr noundef nonnull %14, i32 noundef %289, double noundef %294) #40
  call void @profileStop(i32 noundef 2) #40
...
298:                                              ; preds = %291, %287
  ...
  call void @profileStop(i32 noundef 1) #40
  call fastcc void @sumAtoms(ptr noundef nonnull %14) #43
  %300 = call double @getElapsedTime(i32 noundef 2) #40
  call fastcc void @printThings(ptr noundef nonnull %14, i32 noundef %299) #43
  call void @timestampBarrier(ptr noundef nonnull @.str.3) #40
  %301 = call i32 @printRank() #40
...
303:                                              ; preds = %298
  ...
  %319 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %318, ptr noundef nonnull @.str.12, double noundef %276) #43
  %320 = load ptr, ptr @stdout, align 8, !tbaa !11
  %321 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %320, ptr noundef nonnull @.str.13, double noundef %311) #43
  %322 = load ptr, ptr @stdout, align 8, !tbaa !11
  %323 = fdiv double %311, %276
  %324 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %322, ptr noundef nonnull @.str.14, double noundef %323) #43
...
326:                                              ; preds = %303
  ...
  %331 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %327, ptr noundef nonnull @.str.15, i32 noundef %330) #43
  br label %340
...
332:                                              ; preds = %303
  ...
  %337 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %336, ptr noundef nonnull @.str.17, i32 noundef %333) #43
  %338 = load ptr, ptr @stdout, align 8, !tbaa !11
  %339 = call i64 @fwrite(ptr nonnull @.str.16, i64 30, i64 1, ptr %338)
  br label %340

340:                                              ; preds = %332, %326, %298
  call void @profileStop(i32 noundef 0) #40
...
343:                                              ; preds = %340
  ...
  call void %345(ptr noundef nonnull %3) #40
  br label %346

346:                                              ; preds = %343, %340
  call void @destroyLinkCells(ptr noundef nonnull %116) #40
  %347 = load ptr, ptr %115, align 8, !tbaa !38
  call void @destroyAtoms(ptr noundef %347) #40
  call void @destroyHaloExchange(ptr noundef nonnull %23) #40
  %348 = load ptr, ptr %127, align 8, !tbaa !30
  call void @free(ptr noundef %348) #40
  %349 = load ptr, ptr %21, align 8, !tbaa !36
  call void @free(ptr noundef %349) #40
  call void @free(ptr noundef nonnull %14) #40
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %3) #41
  call void @timestampBarrier(ptr noundef nonnull @.str.4) #40
  call void @destroyParallel() #40
  call void @llvm.lifetime.end.p0(i64 3144, ptr nonnull %9) #41
  ret i32 0
}
...
13:                                               ; preds = %16, %1
  tail call void @profileStart(i32 noundef 10) #40
  %14 = load ptr, ptr %2, align 8, !tbaa !38
  %15 = getelementptr inbounds %struct.AtomsSt, ptr %14, i64 0, i32 1
  tail call void @addIntParallel(ptr noundef %14, ptr noundef nonnull %15, i32 noundef 1) #40
  tail call void @profileStop(i32 noundef 10) #40
  ret void
...
7:                                                ; preds = %5
  ...
  %10 = load ptr, ptr @stdout, align 8, !tbaa !11
  %11 = tail call i32 @fflush(ptr noundef %10) #43
  br label %12
...
12:                                               ; preds = %7, %5
  ...
  %32 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %31, ptr noundef nonnull @.str.19, i32 noundef %1, double noundef %16, double noundef %27, double noundef %29, double noundef %28, double noundef %30, double noundef 0.000000e+00, i32 noundef %25) #43
  br label %33
...
define internal i32 @addArg(ptr noundef %0, i8 noundef signext %1, i32 noundef %2, i8 noundef signext %3, ptr noundef %4, i32 noundef %5, ptr noundef %6) #11 {
  %8 = tail call noalias dereferenceable_or_null(48) ptr @calloc(i64 noundef 1, i64 noundef 48) #46
  %9 = tail call fastcc ptr @dupString(ptr noundef %6) #43
  store ptr %9, ptr %8, align 8, !tbaa !55
  %10 = tail call fastcc ptr @dupString(ptr noundef %0) #43
...
25:                                               ; preds = %17
  ...
  %28 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #44
...
define internal fastcc ptr @dupString(ptr noundef readonly %0) unnamed_addr #13 {
  ...
  %5 = add i64 %4, 1
  %6 = tail call noalias ptr @calloc(i64 noundef %5, i64 noundef 1) #46
  %7 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %6, ptr noundef nonnull dereferenceable(1) %3) #40
  ret ptr %6
}
...
define internal void @printArgs() #11 {
  ...
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %1) #41
  ...
  %6 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) @.str.1.10, i32 noundef %5) #40
...
8:                                                ; preds = %8, %0
  ...
  %16 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef nonnull %1, ptr noundef %15) #43
  ...
  %27 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %17, ptr noundef nonnull @.str.3.11, i32 noundef %20, i32 noundef %22, i32 noundef %25, ptr noundef %26) #43
...
31:                                               ; preds = %8, %0
  ...
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %1) #41
  ret void
}
...
15:                                               ; preds = %6
  ...
  %19 = tail call noalias ptr @calloc(i64 noundef %18, i64 noundef 1) #46
  %20 = zext i32 %.lcssa3 to i64
  %21 = tail call noalias ptr @calloc(i64 noundef %20, i64 noundef 32) #46
...
23:                                               ; preds = %43, %15
  ...
  %37 = tail call ptr @strcat(ptr noundef nonnull dereferenceable(1) %19, ptr noundef nonnull dereferenceable(1) %33) #40
...
48:                                               ; preds = %114, %43
  ...
  %49 = call i32 @getopt_long(i32 noundef %0, ptr noundef %1, ptr noundef %19, ptr noundef %21, ptr noundef nonnull %3) #40
  %50 = icmp eq i32 %49, -1
...
64:                                               ; preds = %60, %51
  ...
  %66 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %65, ptr noundef nonnull @.str.6.13, i32 noundef %.lcssa2) #43
  br label %115
...
78:                                               ; preds = %74
  ...
  %82 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %79, ptr noundef nonnull @.str.7.14, ptr noundef %81) #40
  br label %114
...
83:                                               ; preds = %74
  ...
  %87 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %84, ptr noundef nonnull @.str.8.15, ptr noundef %86) #40
  br label %114
...
88:                                               ; preds = %74
  ...
  %92 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %89, ptr noundef nonnull @.str.9.16, ptr noundef %91) #40
  br label %114
...
93:                                               ; preds = %74
  ...
  %100 = call ptr @strncpy(ptr noundef %95, ptr noundef %96, i64 noundef %99) #40
...
106:                                              ; preds = %74
  ...
  %110 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %107, ptr noundef nonnull @.str.10.17, ptr noundef %109) #40
  br label %114

111:                                              ; preds = %74
  %112 = load ptr, ptr @stdout, align 8, !tbaa !11
  %113 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %112, ptr noundef nonnull @.str.11.18, i32 noundef %49) #43
  br label %114
...
115:                                              ; preds = %64, %48
  ...
  call void @free(ptr noundef %19) #40
  br label %116
...
define internal noalias ptr @initDecomposition(i32 noundef %0, i32 noundef %1, i32 noundef %2, ptr nocapture noundef readonly %3) #0 {
  %5 = tail call noalias dereferenceable_or_null(168) ptr @malloc(i64 noundef 168) #42
...
define internal ptr @initEamPot(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 {
  ...
  %27 = tail call noalias dereferenceable_or_null(120) ptr @malloc(i64 noundef 120) #42
  ...
  %34 = tail call i32 @getMyRank() #40
  %35 = icmp eq i32 %34, 0
  br i1 %35, label %36, label %246

36:                                               ; preds = %3
  %37 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(6) @.str.36) #44
  %38 = icmp eq i32 %37, 0
  br i1 %38, label %39, label %142

39:                                               ; preds = %36
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %16) #41
  %40 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %16, ptr noundef nonnull dereferenceable(1) @.str.10.37, ptr noundef %0, ptr noundef %1) #40
  %41 = call noalias ptr @fopen(ptr noundef nonnull %16, ptr noundef nonnull @.str.11.38) #43
  %42 = icmp eq ptr %41, null
  br i1 %42, label %43, label %46

43:                                               ; preds = %39
  %44 = load ptr, ptr @stdout, align 8, !tbaa !11
  %45 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %44, ptr noundef nonnull @.str.17.39, ptr noundef nonnull @.str.12.40, ptr noundef nonnull %16) #43
  call void @exit(i32 noundef -1) #45
  unreachable

46:                                               ; preds = %39
  %47 = call ptr @fgets(ptr noundef nonnull %16, i32 noundef 4096, ptr noundef nonnull %41) #43
  %48 = call ptr @fgets(ptr noundef nonnull %16, i32 noundef 4096, ptr noundef nonnull %41) #43
  %49 = call ptr @fgets(ptr noundef nonnull %16, i32 noundef 4096, ptr noundef nonnull %41) #43
  %50 = call ptr @fgets(ptr noundef nonnull %16, i32 noundef 4096, ptr noundef nonnull %41) #43
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %17) #41
  %51 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %16, ptr noundef nonnull @.str.13.41, ptr noundef nonnull %17) #40
...
54:                                               ; preds = %46
  ...
  %56 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %55, ptr noundef nonnull @.str.18.42, ptr noundef nonnull @.str.12.40) #43
  call void @exit(i32 noundef -1) #45
  unreachable

57:                                               ; preds = %46
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %18) #41
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %19) #41
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %20) #41
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %21) #41
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %22) #41
  %58 = call ptr @fgets(ptr noundef nonnull %16, i32 noundef 4096, ptr noundef nonnull %41) #43
  %59 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %16, ptr noundef nonnull @.str.14.43, ptr noundef nonnull %18, ptr noundef nonnull %20, ptr noundef nonnull %19, ptr noundef nonnull %21, ptr noundef nonnull %22) #40
  %60 = load double, ptr %22, align 8, !tbaa !31
  store double %60, ptr %27, align 8, !tbaa !73
  %61 = call ptr @fgets(ptr noundef nonnull %16, i32 noundef 4096, ptr noundef nonnull %41) #43
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %23) #41
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %24) #41
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %25) #41
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %26) #41
  %62 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %16, ptr noundef nonnull @.str.15.44, ptr noundef nonnull %23, ptr noundef nonnull %24, ptr noundef nonnull %25, ptr noundef nonnull %26) #40
  ...
  %71 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %70, ptr noundef nonnull dereferenceable(1) %26) #40
  %72 = load i32, ptr %18, align 4
  %73 = load i32, ptr %19, align 4
  %74 = call i32 @llvm.smax.i32(i32 %72, i32 %73)
  %75 = sext i32 %74 to i64
  %76 = shl nsw i64 %75, 3
  %77 = call noalias ptr @malloc(i64 noundef %76) #42
...
79:                                               ; preds = %85, %57
  ...
  %82 = call fastcc ptr @initInterpolationObject(i32 noundef %80, double noundef %81, ptr noundef %77) #43
...
85:                                               ; preds = %85, %57
  ...
  %88 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef nonnull %41, ptr noundef nonnull @.str.16.45, ptr noundef %87) #40
...
93:                                               ; preds = %101, %79
  ...
  %96 = call fastcc ptr @initInterpolationObject(i32 noundef %94, double noundef %95, ptr noundef %77) #43
...
101:                                              ; preds = %101, %79
  ...
  %104 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef nonnull %41, ptr noundef nonnull @.str.16.45, ptr noundef %103) #40
...
114:                                              ; preds = %114, %93
  ...
  %117 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef nonnull %41, ptr noundef nonnull @.str.16.45, ptr noundef %116) #40
...
132:                                              ; preds = %122, %109, %99
  ...
  %141 = call fastcc ptr @initInterpolationObject(i32 noundef %134, double noundef %133, ptr noundef nonnull %77) #43
  store ptr %141, ptr %31, align 8, !tbaa !79
  call void @free(ptr noundef %77) #40
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %26) #41
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %25) #41
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %24) #41
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %23) #41
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %22) #41
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %21) #41
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %20) #41
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %19) #41
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %18) #41
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %17) #41
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %16) #41
  br label %246

142:                                              ; preds = %36
  %143 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(7) @.str.1.46) #44
  %144 = icmp eq i32 %143, 0
  br i1 %144, label %145, label %243

145:                                              ; preds = %142
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %5) #41
  %146 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %5, ptr noundef nonnull dereferenceable(1) @.str.10.37, ptr noundef %0, ptr noundef %1) #40
  %147 = call noalias ptr @fopen(ptr noundef nonnull %5, ptr noundef nonnull @.str.11.38) #43
  %148 = icmp eq ptr %147, null
  br i1 %148, label %149, label %152

149:                                              ; preds = %145
  %150 = load ptr, ptr @stdout, align 8, !tbaa !11
  %151 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %150, ptr noundef nonnull @.str.17.39, ptr noundef nonnull @.str.19.47, ptr noundef nonnull %5) #43
  call void @exit(i32 noundef -1) #45
  unreachable

152:                                              ; preds = %145
  %153 = call ptr @fgets(ptr noundef nonnull %5, i32 noundef 4096, ptr noundef nonnull %147) #43
  call void @llvm.lifetime.start.p0(i64 3, ptr nonnull %6) #41
  %154 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %5, ptr noundef nonnull @.str.20.48, ptr noundef nonnull %6) #40
  %155 = getelementptr inbounds %struct.EamPotentialSt, ptr %27, i64 0, i32 4
  %156 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %155, ptr noundef nonnull dereferenceable(1) %6) #40
  ...
  %157 = call ptr @fgets(ptr noundef nonnull %5, i32 noundef 4096, ptr noundef nonnull %147) #43
  %158 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %5, ptr noundef nonnull @.str.15.44, ptr noundef nonnull %7, ptr noundef nonnull %8, ptr noundef nonnull %9, ptr noundef nonnull %10) #40
  ...
  %167 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %166, ptr noundef nonnull dereferenceable(1) %10) #40
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %11) #41
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %12) #41
  ...
  %168 = call ptr @fgets(ptr noundef nonnull %5, i32 noundef 4096, ptr noundef nonnull %147) #43
  %169 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %5, ptr noundef nonnull @.str.14.43, ptr noundef nonnull %11, ptr noundef nonnull %13, ptr noundef nonnull %12, ptr noundef nonnull %14, ptr noundef nonnull %15) #40
  ...
  %176 = call noalias ptr @malloc(i64 noundef %175) #42
...
178:                                              ; preds = %186, %152
  ...
  %181 = call fastcc ptr @initInterpolationObject(i32 noundef %179, double noundef %180, ptr noundef %176) #43
...
186:                                              ; preds = %186, %152
  ...
  %189 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef nonnull %147, ptr noundef nonnull @.str.16.45, ptr noundef %188) #40
...
199:                                              ; preds = %199, %178
  ...
  %202 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef nonnull %147, ptr noundef nonnull @.str.16.45, ptr noundef %201) #40
...
207:                                              ; preds = %219, %194, %184
  ...
  %216 = call fastcc ptr @initInterpolationObject(i32 noundef %209, double noundef %208, ptr noundef nonnull %176) #43
...
231:                                              ; preds = %231, %207
  ...
  %234 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef nonnull %147, ptr noundef nonnull @.str.16.45, ptr noundef nonnull %233) #40
...
239:                                              ; preds = %231, %207
  ...
  %242 = call fastcc ptr @initInterpolationObject(i32 noundef %240, double noundef %241, ptr noundef nonnull %176) #43
  store ptr %242, ptr %32, align 8, !tbaa !78
  call void @free(ptr noundef %176) #40
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %12) #41
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %11) #41
  ...
  call void @llvm.lifetime.end.p0(i64 3, ptr nonnull %6) #41
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %5) #41
  br label %246

243:                                              ; preds = %142
  %244 = load ptr, ptr @stdout, align 8, !tbaa !11
  %245 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %244, ptr noundef nonnull @.str.21.49, ptr noundef nonnull @.str.2.50, ptr noundef %2) #43
  tail call void @exit(i32 noundef -1) #45
  unreachable

246:                                              ; preds = %239, %132, %3
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %4) #41
  %247 = call i32 @getMyRank() #40
...
249:                                              ; preds = %246
  ...
  %259 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %257, ptr noundef nonnull dereferenceable(1) %258) #40
  ...
  %262 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %260, ptr noundef nonnull dereferenceable(1) %261) #40
  br label %263

263:                                              ; preds = %249, %246
  call void @bcastParallel(ptr noundef nonnull %4, i32 noundef 40, i32 noundef 0) #40
  ...
  %273 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %271, ptr noundef nonnull dereferenceable(1) %272) #40
  ...
  %276 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %274, ptr noundef nonnull dereferenceable(1) %275) #40
  call fastcc void @bcastInterpolationObject(ptr noundef nonnull %31) #43
  call fastcc void @bcastInterpolationObject(ptr noundef nonnull %32) #43
  call fastcc void @bcastInterpolationObject(ptr noundef nonnull %33) #43
...
20:                                               ; preds = %1
  ...
  %28 = tail call noalias ptr @malloc(i64 noundef %25) #42
  ...
  %32 = tail call ptr @initForceHaloExchange(ptr noundef %31, ptr noundef %19) #40
  store ptr %32, ptr %15, align 8, !tbaa !83
  %33 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #42
...
38:                                               ; preds = %20, %1
  ...
  call void @llvm.lifetime.start.p0(i64 108, ptr nonnull %2) #41
...
91:                                               ; preds = %107, %81
  ...
  %102 = call i32 @getNeighborBoxes(ptr noundef nonnull %94, i32 noundef %101, ptr noundef nonnull %2) #40
...
168:                                              ; preds = %154
  %169 = call double @sqrt(double noundef %.lcssa1) #40
  ...
  call fastcc void @interpolate(ptr noundef %170, double noundef %169, ptr noundef nonnull %4, ptr noundef nonnull %5) #43
  %171 = load ptr, ptr %83, align 8, !tbaa !78
  call fastcc void @interpolate(ptr noundef %171, double noundef %169, ptr noundef nonnull %6, ptr noundef nonnull %7) #43
...
226:                                              ; preds = %253, %84, %38
  ...
  call void @profileStart(i32 noundef 8) #40
  ...
  call void @haloExchange(ptr noundef %228, ptr noundef %230) #40
  call void @profileStop(i32 noundef 8) #40
...
258:                                              ; preds = %258, %244
  ...
  call fastcc void @interpolate(ptr noundef %246, double noundef %262, ptr noundef nonnull %8, ptr noundef nonnull %9) #43
...
273:                                              ; preds = %290, %226
  ...
  call void @llvm.lifetime.end.p0(i64 108, ptr nonnull %2) #41
  ret i32 0
...
275:                                              ; preds = %290, %235
  ...
  %285 = call i32 @getNeighborBoxes(ptr noundef nonnull %278, i32 noundef %284, ptr noundef nonnull %2) #40
...
346:                                              ; preds = %332
  %347 = call double @sqrt(double noundef %.lcssa) #40
  ...
  call fastcc void @interpolate(ptr noundef %348, double noundef %347, ptr noundef nonnull %11, ptr noundef nonnull %12) #43
...
define internal void @eamPrint(ptr nocapture noundef %0, ptr noundef %1) #11 {
  ...
  %5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.4.52, ptr noundef nonnull %4) #43
  %6 = getelementptr inbounds %struct.EamPotentialSt, ptr %1, i64 0, i32 5
  %7 = load i32, ptr %6, align 4, !tbaa !74
  %8 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.5.53, i32 noundef %7) #43
  %9 = call double @_wyvern_slice_eamPrint__316183912(ptr %1)
  %10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.6.54, double noundef %9) #43
  %11 = getelementptr inbounds %struct.EamPotentialSt, ptr %1, i64 0, i32 3
  %12 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.7.55, ptr noundef nonnull %11) #43
  %13 = getelementptr inbounds %struct.EamPotentialSt, ptr %1, i64 0, i32 2
  %14 = load double, ptr %13, align 8, !tbaa !75
  %15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.8.56, double noundef %14) #43
  %16 = load double, ptr %1, align 8, !tbaa !73
  %17 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.9.57, double noundef %16) #43
  ret void
}
...
6:                                                ; preds = %3
  ...
  tail call fastcc void @destroyInterpolationObject(ptr noundef nonnull %7) #43
  %8 = getelementptr inbounds %struct.EamPotentialSt, ptr %4, i64 0, i32 10
  tail call fastcc void @destroyInterpolationObject(ptr noundef nonnull %8) #43
  %9 = getelementptr inbounds %struct.EamPotentialSt, ptr %4, i64 0, i32 11
  tail call fastcc void @destroyInterpolationObject(ptr noundef nonnull %9) #43
  %10 = getelementptr inbounds %struct.EamPotentialSt, ptr %4, i64 0, i32 14
  tail call void @destroyHaloExchange(ptr noundef nonnull %10) #40
  tail call void @free(ptr noundef nonnull %4) #40
...
define internal fastcc noalias ptr @initInterpolationObject(i32 noundef %0, double noundef %1, ptr nocapture noundef readonly %2) unnamed_addr #13 {
  %4 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #42
  %5 = add nsw i32 %0, 3
  %6 = sext i32 %5 to i64
  %7 = shl nsw i64 %6, 3
  %8 = tail call noalias ptr @calloc(i64 noundef 1, i64 noundef %7) #46
...
11:                                               ; preds = %5, %1
  call void @bcastParallel(ptr noundef nonnull %2, i32 noundef 24, i32 noundef 0) #40
  %12 = call i32 @getMyRank() #40
  %13 = icmp eq i32 %12, 0
...
19:                                               ; preds = %11
  %20 = call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #42
  ...
  %27 = shl nsw i64 %26, 3
  %28 = call noalias ptr @malloc(i64 noundef %27) #42
...
31:                                               ; preds = %19, %14
  ...
  call void @bcastParallel(ptr noundef nonnull %36, i32 noundef %35, i32 noundef 0) #40
...
10:                                               ; preds = %6
  ...
  tail call void @free(ptr noundef %14) #40
  %15 = load ptr, ptr %0, align 8, !tbaa !11
  br label %16
...
define internal noalias ptr @initAtomHaloExchange(ptr noundef %0, ptr noundef %1) #0 {
  %3 = tail call fastcc ptr @initHaloExchange(ptr noundef %0) #43
  ...
  %20 = tail call noalias dereferenceable_or_null(120) ptr @malloc(i64 noundef 120) #42
  %21 = shl i32 %5, 1
  %22 = add i32 %21, 4
  %23 = mul nsw i32 %22, %9
...
33:                                               ; preds = %91, %2
  ...
  %38 = shl nsw i64 %37, 2
  %39 = tail call noalias ptr @malloc(i64 noundef %38) #42
...
83:                                               ; preds = %83, %71
  ...
  %86 = tail call i32 @getBoxFromTuple(ptr noundef nonnull %1, i32 noundef %66, i32 noundef %69, i32 noundef %85) #40
  %87 = add nsw i64 %84, 1
...
define internal fastcc noalias ptr @initHaloExchange(ptr noundef %0) unnamed_addr #0 {
  %2 = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #42
  %3 = tail call i32 @processorNum(ptr noundef %0, i32 noundef -1, i32 noundef 0, i32 noundef 0) #40
  store i32 %3, ptr %2, align 8, !tbaa !7
  %4 = tail call i32 @processorNum(ptr noundef %0, i32 noundef 1, i32 noundef 0, i32 noundef 0) #40
  %5 = getelementptr inbounds [6 x i32], ptr %2, i64 0, i64 1
  store i32 %4, ptr %5, align 4, !tbaa !7
  %6 = tail call i32 @processorNum(ptr noundef %0, i32 noundef 0, i32 noundef -1, i32 noundef 0) #40
  %7 = getelementptr inbounds [6 x i32], ptr %2, i64 0, i64 2
  store i32 %6, ptr %7, align 8, !tbaa !7
  %8 = tail call i32 @processorNum(ptr noundef %0, i32 noundef 0, i32 noundef 1, i32 noundef 0) #40
  %9 = getelementptr inbounds [6 x i32], ptr %2, i64 0, i64 3
  store i32 %8, ptr %9, align 4, !tbaa !7
  %10 = tail call i32 @processorNum(ptr noundef %0, i32 noundef 0, i32 noundef 0, i32 noundef -1) #40
  %11 = getelementptr inbounds [6 x i32], ptr %2, i64 0, i64 4
  store i32 %10, ptr %11, align 8, !tbaa !7
  %12 = tail call i32 @processorNum(ptr noundef %0, i32 noundef 0, i32 noundef 0, i32 noundef 1) #40
...
15:                                               ; preds = %15, %10
  ...
  tail call void @putAtomInBox(ptr noundef %33, ptr noundef %34, i32 noundef %18, i32 noundef %20, double noundef %22, double noundef %24, double noundef %26, double noundef %28, double noundef %30, double noundef %32) #40
...
define internal noalias ptr @initForceHaloExchange(ptr noundef %0, ptr noundef %1) #0 {
  ...
  %19 = tail call noalias dereferenceable_or_null(120) ptr @malloc(i64 noundef 120) #42
  %20 = mul nsw i32 %10, %8
...
28:                                               ; preds = %151, %2
  ...
  %33 = shl nsw i64 %32, 2
  %34 = tail call noalias ptr @malloc(i64 noundef %33) #42
...
82:                                               ; preds = %82, %70
  ...
  %85 = tail call i32 @getBoxFromTuple(ptr noundef nonnull %1, i32 noundef %65, i32 noundef %68, i32 noundef %84) #40
  %86 = add nsw i64 %83, 1
...
94:                                               ; preds = %90, %48
  ...
  %99 = tail call noalias ptr @malloc(i64 noundef %33) #42
...
143:                                              ; preds = %143, %131
  ...
  %146 = tail call i32 @getBoxFromTuple(ptr noundef nonnull %1, i32 noundef %126, i32 noundef %129, i32 noundef %145) #40
...
8:                                                ; preds = %8, %2
  ...
  %15 = tail call noalias ptr @malloc(i64 noundef %13) #42
  %16 = tail call noalias ptr @malloc(i64 noundef %13) #42
  %17 = tail call noalias ptr @malloc(i64 noundef %13) #42
  %18 = load ptr, ptr %4, align 8, !tbaa !103
  %19 = load ptr, ptr %5, align 8, !tbaa !106
  %20 = trunc i64 %10 to i32
  %21 = tail call i32 %18(ptr noundef %19, ptr noundef %1, i32 noundef %20, ptr noundef %14) #40
  %22 = load ptr, ptr %4, align 8, !tbaa !103
  %23 = load ptr, ptr %5, align 8, !tbaa !106
  %24 = trunc i64 %11 to i32
  %25 = tail call i32 %22(ptr noundef %23, ptr noundef %1, i32 noundef %24, ptr noundef %15) #40
  ...
  tail call void @profileStart(i32 noundef 9) #40
  %30 = load i32, ptr %3, align 8, !tbaa !101
  %31 = tail call i32 @sendReceiveParallel(ptr noundef %14, i32 noundef %21, i32 noundef %27, ptr noundef %17, i32 noundef %30, i32 noundef %29) #40
  %32 = load i32, ptr %3, align 8, !tbaa !101
  %33 = tail call i32 @sendReceiveParallel(ptr noundef %15, i32 noundef %25, i32 noundef %29, ptr noundef %16, i32 noundef %32, i32 noundef %27) #40
  tail call void @profileStop(i32 noundef 9) #40
  %34 = load ptr, ptr %6, align 8, !tbaa !104
  %35 = load ptr, ptr %5, align 8, !tbaa !106
  tail call void %34(ptr noundef %35, ptr noundef %1, i32 noundef %20, i32 noundef %33, ptr noundef %16) #40
  %36 = load ptr, ptr %6, align 8, !tbaa !104
  %37 = load ptr, ptr %5, align 8, !tbaa !106
  tail call void %36(ptr noundef %37, ptr noundef %1, i32 noundef %24, i32 noundef %31, ptr noundef %17) #40
  tail call void @free(ptr noundef %17) #40
...
14:                                               ; preds = %3
  ...
  call void @qsort(ptr noundef nonnull %10, i64 noundef %15, i64 noundef 56, ptr noundef nonnull @sortAtomsById) #40
  br label %70
...
27:                                               ; preds = %40
  ...
  call void @qsort(ptr noundef nonnull %10, i64 noundef %28, i64 noundef 56, ptr noundef nonnull @sortAtomsById) #40
...
define internal noalias ptr @initAtoms(ptr nocapture noundef readonly %0) #25 {
  ...
  %10 = tail call noalias ptr @malloc(i64 noundef %7) #42
  ...
  %15 = tail call noalias ptr @malloc(i64 noundef %12) #42
  %16 = getelementptr inbounds %struct.AtomsSt, ptr %2, i64 0, i32 5
  store ptr %15, ptr %16, align 8, !tbaa !109
  %17 = tail call noalias ptr @malloc(i64 noundef %12) #42
...
define internal void @createFccLattice(i32 noundef %0, i32 noundef %1, i32 noundef %2, double noundef %3, ptr nocapture noundef readonly %4) #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %6) #41
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %7) #41
  br label %33
...
49:                                               ; preds = %58, %12
  ...
  tail call void @addIntParallel(ptr noundef %51, ptr noundef nonnull %52, i32 noundef 1) #40
  tail call void @profileStop(i32 noundef 10) #40
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %7) #41
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %6) #41
  ret void
...
109:                                              ; preds = %106
  ...
  %113 = add i32 %71, %112
  tail call void @putAtomInBox(ptr noundef %110, ptr noundef %111, i32 noundef %113, i32 noundef 0, double noundef %83, double noundef %87, double noundef %91, double noundef 0.000000e+00, double noundef 0.000000e+00, double noundef 0.000000e+00) #40
  br label %114
...
70:                                               ; preds = %38, %2
  tail call void @profileStart(i32 noundef 10) #40
  call void @addRealParallel(ptr noundef nonnull %3, ptr noundef nonnull %4, i32 noundef 4) #40
  call void @profileStop(i32 noundef 10) #40
...
36:                                               ; preds = %36, %25
  ...
  %49 = call double @sqrt(double noundef %48) #40
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %3) #41
  ...
  %55 = call i64 @mkSeed(i32 noundef %54, i32 noundef 123) #40
  store i64 %55, ptr %3, align 8, !tbaa !121
  %56 = fmul double %47, %49
  %57 = call double @gasdev(ptr noundef nonnull %3) #40
  ...
  %63 = call double @gasdev(ptr noundef nonnull %3) #40
  ...
  %69 = call double @gasdev(ptr noundef nonnull %3) #40
...
83:                                               ; preds = %14
  ...
  call void @setVcm(ptr noundef nonnull %0, ptr noundef nonnull %4) #43
  call void @kineticEnergy(ptr noundef nonnull %0) #40
  ...
  %94 = fdiv double %1, %93
  %95 = call double @sqrt(double noundef %94) #40
...
32:                                               ; preds = %32, %21
  ...
  %40 = call i64 @mkSeed(i32 noundef %39, i32 noundef 457) #40
  store i64 %40, ptr %3, align 8, !tbaa !121
  %41 = call double @lcg61(ptr noundef nonnull %3) #40
  ...
  %49 = call double @lcg61(ptr noundef nonnull %3) #40
  ...
  %57 = call double @lcg61(ptr noundef nonnull %3) #40
...
define internal noalias ptr @initLinkCells(ptr nocapture noundef readonly %0, double noundef %1) #26 {
  %3 = tail call noalias dereferenceable_or_null(128) ptr @malloc(i64 noundef 128) #42
  br label %30
...
95:                                               ; preds = %95, %87
  ...
  %98 = tail call i32 @getBoxFromTuple(ptr noundef %0, i32 noundef %82, i32 noundef %88, i32 noundef %97) #43
  %99 = add i64 %96, 1
...
8:                                                ; preds = %4
  ...
  %17 = add i32 %16, %11
  %18 = mul i32 %17, %14
  %19 = call i32 @_wyvern_slice_getBoxFromTuple__426579709(ptr %0, i32 %1)
  %20 = add i32 %19, %12
  %21 = add i32 %20, %18
  br label %91
...
24:                                               ; preds = %22
  ...
  %32 = add i32 %31, %25
  %33 = mul i32 %30, %32
  %34 = call i32 @_wyvern_slice_getBoxFromTuple__426579709(ptr %0, i32 %1)
  %35 = add i32 %34, %28
  %36 = add i32 %35, %33
  br label %91
...
41:                                               ; preds = %37
  %42 = getelementptr inbounds %struct.LinkCellSt, ptr %0, i64 0, i32 1
  %43 = load i32, ptr %42, align 4, !tbaa !52
  %44 = shl nsw i32 %6, 1
  %45 = mul nsw i32 %44, %2
  %46 = load i32, ptr %0, align 4, !tbaa !7
  %47 = add nsw i32 %46, 2
  %48 = add i32 %6, %3
  %49 = mul i32 %47, %48
  %50 = add i32 %1, 1
...
56:                                               ; preds = %54
  %57 = getelementptr inbounds %struct.LinkCellSt, ptr %0, i64 0, i32 1
  %58 = load i32, ptr %57, align 4, !tbaa !52
  %59 = shl nsw i32 %6, 1
  %60 = mul nsw i32 %59, %39
...
68:                                               ; preds = %54
  %69 = load i32, ptr %0, align 4, !tbaa !7
  %70 = icmp eq i32 %69, %1
  br i1 %70, label %71, label %78

71:                                               ; preds = %68
  %72 = getelementptr inbounds %struct.LinkCellSt, ptr %0, i64 0, i32 1
...
80:                                               ; preds = %78
  %81 = getelementptr inbounds %struct.LinkCellSt, ptr %0, i64 0, i32 1
...
91:                                               ; preds = %86, %80, %71, %56, %41, %24, %8
  %92 = phi i32 [ %21, %8 ], [ %36, %24 ], [ %53, %41 ], [ %67, %56 ], [ %77, %71 ], [ %85, %80 ], [ %90, %86 ]
  ret i32 %92
}
...
define internal void @putAtomInBox(ptr nocapture noundef readonly %0, ptr nocapture noundef %1, i32 noundef %2, i32 noundef %3, double noundef %4, double noundef %5, double noundef %6, double noundef %7, double noundef %8, double noundef %9) #28 {
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %11) #41
  ...
  %14 = call fastcc i32 @getBoxFromCoord(ptr noundef %0, ptr noundef nonnull %11) #43
...
27:                                               ; preds = %23, %10
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %11) #41
  ret void
}
...
28:                                               ; preds = %26, %13
  ...
  %57 = tail call i32 @getBoxFromTuple(ptr noundef nonnull %0, i32 noundef %29, i32 noundef %50, i32 noundef %56) #43
  ret i32 %57
}
...
define internal void @moveAtom(ptr nocapture noundef readonly %0, ptr nocapture noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4) #28 {
  ...
  tail call fastcc void @copyAtom(ptr noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %10, i32 noundef %4) #43
...
20:                                               ; preds = %5
  tail call fastcc void @copyAtom(ptr noundef %1, i32 noundef %18, i32 noundef %3, i32 noundef %2, i32 noundef %3) #43
  br label %21
...
39:                                               ; preds = %53, %29
  ...
  %46 = tail call fastcc i32 @getBoxFromCoord(ptr noundef nonnull %0, ptr noundef %45) #43
  %47 = zext i32 %46 to i64
  %48 = icmp eq i64 %33, %47
  br i1 %48, label %51, label %49

49:                                               ; preds = %39
  tail call void @moveAtom(ptr noundef %0, ptr noundef nonnull %1, i32 noundef %41, i32 noundef %34, i32 noundef %46) #43
...
11:                                               ; preds = %13, %1
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %3) #41
  tail call void @profileStart(i32 noundef 10) #40
  call void @maxIntParallel(ptr noundef nonnull %2, ptr noundef nonnull %3, i32 noundef 1) #40
  call void @profileStop(i32 noundef 10) #40
...
define internal noalias ptr @initLjPot() #31 {
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(3) %8, ptr noundef nonnull align 1 dereferenceable(3) @.str.1.90, i64 3, i1 false) #40
...
72:                                               ; preds = %61
  ...
  %74 = call i32 @getNeighborBoxes(ptr noundef nonnull %62, i32 noundef %73, ptr noundef nonnull %2) #40
...
define internal void @ljPrint(ptr nocapture noundef %0, ptr noundef %1) #11 {
  ...
  %5 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.3.92, ptr noundef nonnull %4) #43
  %6 = getelementptr inbounds %struct.LjPotentialSt, ptr %1, i64 0, i32 5
  %7 = load i32, ptr %6, align 4, !tbaa !129
  %8 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.4.93, i32 noundef %7) #43
  %9 = call double @_wyvern_slice_eamPrint__316183912(ptr %1)
  %10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.5.94, double noundef %9) #43
  %11 = getelementptr inbounds %struct.LjPotentialSt, ptr %1, i64 0, i32 3
  %12 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.6.95, ptr noundef nonnull %11) #43
  %13 = getelementptr inbounds %struct.LjPotentialSt, ptr %1, i64 0, i32 2
  %14 = load double, ptr %13, align 8, !tbaa !128
  %15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.7.96, double noundef %14) #43
  %16 = load double, ptr %1, align 8, !tbaa !132
  %17 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.8.97, double noundef %16) #43
  %18 = getelementptr inbounds %struct.LjPotentialSt, ptr %1, i64 0, i32 10
  %19 = load double, ptr %18, align 8, !tbaa !131
  %20 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.9.98, double noundef %19) #43
  %21 = getelementptr inbounds %struct.LjPotentialSt, ptr %1, i64 0, i32 9
  %22 = load double, ptr %21, align 8, !tbaa !130
  %23 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.10.99, double noundef %22) #43
  ret void
}
...
define internal void @parseCommandLine(ptr noalias sret(%struct.CommandSt) align 8 %0, i32 noundef %1, ptr noundef %2) #0 {
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(5) %0, ptr noundef nonnull align 1 dereferenceable(5) @.str.102, i64 5, i1 false) #40
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(7) %6, ptr noundef nonnull align 1 dereferenceable(7) @.str.2.103, i64 7, i1 false) #40
  ...
  store i32 10, ptr %16, align 8, !tbaa !133
  ...
  %21 = call i32 @addArg(ptr noundef nonnull @.str.3.104, i8 noundef signext 104, i32 noundef 0, i8 noundef signext 105, ptr noundef nonnull %4, i32 noundef 0, ptr noundef nonnull @.str.4.105) #40
  %22 = call i32 @addArg(ptr noundef nonnull @.str.5.106, i8 noundef signext 100, i32 noundef 1, i8 noundef signext 115, ptr noundef %0, i32 noundef 1024, ptr noundef nonnull @.str.6.107) #40
  %23 = call i32 @addArg(ptr noundef nonnull @.str.7.108, i8 noundef signext 112, i32 noundef 1, i8 noundef signext 115, ptr noundef nonnull %5, i32 noundef 1024, ptr noundef nonnull @.str.8.109) #40
  %24 = call i32 @addArg(ptr noundef nonnull @.str.9.110, i8 noundef signext 116, i32 noundef 1, i8 noundef signext 115, ptr noundef nonnull %6, i32 noundef 1024, ptr noundef nonnull @.str.10.111) #40
  %25 = call i32 @addArg(ptr noundef nonnull @.str.11.112, i8 noundef signext 101, i32 noundef 0, i8 noundef signext 105, ptr noundef nonnull %8, i32 noundef 0, ptr noundef nonnull @.str.12.113) #40
  %26 = call i32 @addArg(ptr noundef nonnull @.str.13.114, i8 noundef signext 120, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %9, i32 noundef 0, ptr noundef nonnull @.str.14.115) #40
  %27 = call i32 @addArg(ptr noundef nonnull @.str.15.116, i8 noundef signext 121, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %10, i32 noundef 0, ptr noundef nonnull @.str.16.117) #40
  %28 = call i32 @addArg(ptr noundef nonnull @.str.17.118, i8 noundef signext 122, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %11, i32 noundef 0, ptr noundef nonnull @.str.18.119) #40
  %29 = call i32 @addArg(ptr noundef nonnull @.str.19.120, i8 noundef signext 105, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %12, i32 noundef 0, ptr noundef nonnull @.str.20.121) #40
  %30 = call i32 @addArg(ptr noundef nonnull @.str.21.122, i8 noundef signext 106, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %13, i32 noundef 0, ptr noundef nonnull @.str.22.123) #40
  %31 = call i32 @addArg(ptr noundef nonnull @.str.23.124, i8 noundef signext 107, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %14, i32 noundef 0, ptr noundef nonnull @.str.24.125) #40
  %32 = call i32 @addArg(ptr noundef nonnull @.str.25.126, i8 noundef signext 78, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %15, i32 noundef 0, ptr noundef nonnull @.str.26.127) #40
  %33 = call i32 @addArg(ptr noundef nonnull @.str.27.128, i8 noundef signext 110, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %16, i32 noundef 0, ptr noundef nonnull @.str.28.129) #40
  %34 = call i32 @addArg(ptr noundef nonnull @.str.29.130, i8 noundef signext 68, i32 noundef 1, i8 noundef signext 100, ptr noundef nonnull %17, i32 noundef 0, ptr noundef nonnull @.str.30.131) #40
  %35 = call i32 @addArg(ptr noundef nonnull @.str.31.132, i8 noundef signext 108, i32 noundef 1, i8 noundef signext 100, ptr noundef nonnull %18, i32 noundef 0, ptr noundef nonnull @.str.32.133) #40
  %36 = call i32 @addArg(ptr noundef nonnull @.str.33.134, i8 noundef signext 84, i32 noundef 1, i8 noundef signext 100, ptr noundef nonnull %19, i32 noundef 0, ptr noundef nonnull @.str.34.135) #40
  %37 = call i32 @addArg(ptr noundef nonnull @.str.35.136, i8 noundef signext 114, i32 noundef 1, i8 noundef signext 100, ptr noundef nonnull %20, i32 noundef 0, ptr noundef nonnull @.str.36.137) #40
  call void @processArgs(i32 noundef %1, ptr noundef %2) #40
...
43:                                               ; preds = %40
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(15) %5, ptr noundef nonnull align 1 dereferenceable(15) @.str.38, i64 15, i1 false) #40
  br label %44
...
47:                                               ; preds = %44
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(10) %5, ptr noundef nonnull align 1 dereferenceable(10) @.str.39, i64 10, i1 false) #40
  br label %48
...
51:                                               ; preds = %48
  call void @printArgs() #40
  call void @freeArgs() #40
  call void @exit(i32 noundef 2) #45
  unreachable
...
5:                                                ; preds = %2
  ...
  %35 = tail call i32 @fflush(ptr noundef %0) #43
  br label %36
...
define internal void @timestampBarrier(ptr noundef %0) #0 {
  ...
  %3 = tail call i64 @time(ptr noundef null) #40
  store i64 %3, ptr %2, align 8, !tbaa !121
  %4 = call ptr @ctime(ptr noundef nonnull %2) #40
  %5 = getelementptr inbounds i8, ptr %4, i64 24
  store i8 0, ptr %5, align 1, !tbaa !63
  store i8 0, ptr %4, align 1, !tbaa !63
  %6 = load ptr, ptr @stdout, align 8, !tbaa !11
  %7 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.148, ptr noundef nonnull %4, ptr noundef %0) #43
  %8 = load ptr, ptr @stdout, align 8, !tbaa !11
  %9 = call i32 @fflush(ptr noundef %8) #43
...
define internal void @profileStart(i32 noundef %0) #11 {
  ...
  %3 = call i32 @gettimeofday(ptr noundef nonnull %2, ptr noundef null) #40
  ...
  store i64 %8, ptr %10, align 8, !tbaa !138
  ret void
}
...
define internal void @profileStop(i32 noundef %0) #11 {
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %2) #41
  %8 = call i32 @gettimeofday(ptr noundef nonnull %2, ptr noundef null) #40
...
20:                                               ; preds = %3
  ...
  %21 = tail call double @log(double noundef %.lcssa) #40
  %22 = fmul double %21, -2.000000e+00
  %23 = fdiv double %22, %.lcssa
  %24 = tail call double @sqrt(double noundef %23) #40
...
11:                                               ; preds = %77, %3
  tail call void @kineticEnergy(ptr noundef %0) #43
  %12 = getelementptr inbounds %struct.SimFlatSt, ptr %0, i64 0, i32 7
...
14:                                               ; preds = %77, %5
  ...
  tail call void @profileStart(i32 noundef 4) #40
  ...
  tail call fastcc void @advanceVelocity(ptr noundef %0, i32 noundef %18, double noundef %7) #43
  tail call void @profileStop(i32 noundef 4) #40
  tail call void @profileStart(i32 noundef 3) #40
...
77:                                               ; preds = %44, %14
  tail call void @profileStop(i32 noundef 3) #40
  tail call void @profileStart(i32 noundef 5) #40
  tail call void @redistributeAtoms(ptr noundef %0) #43
  tail call void @profileStop(i32 noundef 5) #40
  tail call void @profileStart(i32 noundef 7) #40
  ...
  %81 = tail call i32 %80(ptr noundef %0) #40
  tail call void @profileStop(i32 noundef 7) #40
  tail call void @profileStart(i32 noundef 4) #40
  ...
  tail call fastcc void @advanceVelocity(ptr noundef %0, i32 noundef %84, double noundef %7) #43
  tail call void @profileStop(i32 noundef 4) #40
...
18:                                               ; preds = %36, %1
  ...
  tail call void @profileStart(i32 noundef 10) #40
  call void @addRealParallel(ptr noundef nonnull %2, ptr noundef nonnull %3, i32 noundef 2) #40
  call void @profileStop(i32 noundef 10) #40
...
define internal void @redistributeAtoms(ptr noundef %0) #0 {
  ...
  tail call void @updateLinkCells(ptr noundef %3, ptr noundef %5) #40
  tail call void @profileStart(i32 noundef 6) #40
  %6 = getelementptr inbounds %struct.SimFlatSt, ptr %0, i64 0, i32 10
  %7 = load ptr, ptr %6, align 8, !tbaa !18
  tail call void @haloExchange(ptr noundef %7, ptr noundef %0) #40
  tail call void @profileStop(i32 noundef 6) #40
...
13:                                               ; preds = %13, %1
  ...
  tail call void @sortAtomsInCell(ptr noundef %16, ptr noundef nonnull %14, i32 noundef %15) #40
...
define internal void @computeForce(ptr noundef %0) #0 {
  ...
  %6 = tail call i32 %5(ptr noundef %0) #40
  ret void
}
...
5:                                                ; preds = %1
  ...
  %7 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.3.185, ptr noundef nonnull @.str.26.186) #43
  %8 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.4.187, ptr noundef nonnull @.str.27.188) #43
  %9 = tail call i64 @fwrite(ptr nonnull @.str.5.189, i64 10, i64 1, ptr %0)
  %10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.6.190, ptr noundef nonnull @.str.7.191) #43
  %11 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.8.192, ptr noundef nonnull @.str.9.193) #43
  %12 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.10.194, ptr noundef nonnull @.str.9.193) #43
  %13 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.11.195, ptr noundef nonnull @.str.9.193) #43
  %14 = tail call i64 @fwrite(ptr nonnull @.str.12.196, i64 7, i64 1, ptr %0)
  %15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.13.197, ptr noundef nonnull @.str.9.193) #43
  %16 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.14.198, ptr noundef nonnull @.str.9.193) #43
  %17 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.15.199, ptr noundef nonnull @.str.16.200) #43
  %18 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.17.201, ptr noundef nonnull @.str.18.202) #43
  %19 = tail call i32 @builtWithMpi() #40
  %20 = icmp eq i32 %19, 0
  %21 = select i1 %20, ptr @.str.21.203, ptr @.str.20.204
  %22 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.19.205, ptr noundef nonnull %21) #43
  %23 = tail call i64 @fwrite(ptr nonnull @.str.22.206, i64 18, i64 1, ptr %0)
  %24 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.23.207, ptr noundef nonnull @.str.20.204) #43
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %2) #41
  store i8 0, ptr %2, align 16, !tbaa !63
  %25 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.24.208, ptr noundef nonnull %2) #43
  %26 = call i32 @fputc(i32 10, ptr %0)
  %27 = call i32 @fflush(ptr noundef %0) #43
...
define internal double @_wyvern_slice_eamPrint__316183912(ptr %0) #39 {
sliceclone_:
  %1 = getelementptr inbounds %struct.EamPotentialSt, ptr %0, i64 0, i32 1
  %2 = load double, ptr %1, align 8, !tbaa !76
  %3 = fdiv double %2, 0x4059E921DD37DC65
  ret double %3
}

; Function Attrs: noinline nounwind optsize willreturn
define internal i32 @_wyvern_slice_getBoxFromTuple__426579709(ptr %0, i32 %1) #39 {
sliceclone_:
  %2 = getelementptr inbounds %struct.LinkCellSt, ptr %0, i64 0, i32 1
...
attributes #39 = { noinline nounwind optsize willreturn "Daedalus"="1" }
attributes #40 = { nounwind optsize }
attributes #41 = { nounwind }
attributes #42 = { nounwind optsize allocsize(0) }
attributes #43 = { optsize }
attributes #44 = { nounwind optsize willreturn memory(read) }
attributes #45 = { noreturn nounwind optsize }
attributes #46 = { nounwind optsize allocsize(0,1) }
...
!134 = !{!14, !8, i64 3100}
!135 = !{!136, !122, i64 0}
!136 = !{!"timeval", !122, i64 0, !122, i64 8}
!137 = !{!136, !122, i64 8}
!138 = !{!139, !122, i64 0}
!139 = !{!"TimersSt", !122, i64 0, !122, i64 8, !122, i64 16, !122, i64 24, !8, i64 32, !8, i64 36, !15, i64 40, !15, i64 48, !15, i64 56, !15, i64 64}
!140 = !{!139, !122, i64 16}
!141 = !{!139, !122, i64 8}
!142 = !{!139, !122, i64 24}
!143 = !{!23, !12, i64 40}
