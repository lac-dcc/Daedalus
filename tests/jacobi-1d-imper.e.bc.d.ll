; ModuleID = 'jacobi-1d-imper.e.bc.ll'
...
81:                                               ; preds = %74
  ...
  br i1 %83, label %84, label %57, !llvm.loop !15
...
93:                                               ; preds = %84
  ...
  %96 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %95, ptr noundef nonnull @.str.2, i32 noundef %94, double noundef %.lcssa2, i32 noundef %94, double noundef %.lcssa, double noundef 1.000000e-05) #9
  br label %160
...
100:                                              ; preds = %97
  %101 = tail call noalias dereferenceable_or_null(160001) ptr @malloc(i64 noundef 160001) #10
...
157:                                              ; preds = %103
  ...
  %159 = tail call i32 @fputs(ptr noundef nonnull %101, ptr noundef %158) #9
...
define internal fastcc ptr @polybench_alloc_data() unnamed_addr #0 {
  ...
  %2 = call i32 @posix_memalign(ptr noundef nonnull %1, i64 noundef 32, i64 noundef 80000) #11
