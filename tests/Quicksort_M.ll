; ModuleID = 'tests/Quicksort_F.ll'
source_filename = "tests/Quicksort.c"
...
entry:
  ...
  %conv1 = call i32 @_wyvern_slice_Rand_conv_77891630()
  %conv = trunc i64 undef to i32
  ret i32 %conv1
}
...
define internal i32 @_wyvern_slice_Rand_conv_77891630() #2 {
sliceclone_entry:
  %0 = load i64, ptr @seed, align 8
