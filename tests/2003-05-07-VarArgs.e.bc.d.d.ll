; ModuleID = '2003-05-07-VarArgs.e.bc.d.ll'
...
define dso_local i32 @main() #0 {
  ...
  store i32 21, ptr %2, align 8, !tbaa !7
...
; Function Attrs: nofree nounwind optsize uwtable
define internal void @test(ptr nocapture noundef readonly %0, ...) unnamed_addr #0 {
...
102:                                              ; preds = %99, %94
  ...
  %104 = load i32, ptr %103, align 4, !tbaa.struct !18
  %105 = getelementptr inbounds i8, ptr %103, i64 4
  %106 = load i8, ptr %105, align 4, !tbaa.struct !20
...
125:                                              ; preds = %109
  ...
  %129 = load double, ptr %127, align 8, !tbaa.struct !21
  %130 = load i32, ptr %126, align 8, !tbaa.struct !23
  br label %131
...
135:                                              ; preds = %9
  ...
  %138 = load i32, ptr %136, align 8, !tbaa.struct !24
  %139 = getelementptr inbounds i8, ptr %136, i64 8
  %140 = load double, ptr %139, align 8, !tbaa.struct !26
  %141 = getelementptr inbounds i8, ptr %136, i64 16
  %142 = load ptr, ptr %141, align 8, !tbaa.struct !27
  %143 = getelementptr inbounds i8, ptr %136, i64 24
  %144 = load i32, ptr %143, align 8, !tbaa.struct !28
...
148:                                              ; preds = %135, %131, %102, %85, %70, %55, %40, %25, %9
  %149 = load i8, ptr %12, align 1, !tbaa !17
  %150 = icmp eq i8 %149, 0
  br i1 %150, label %151, label %9, !llvm.loop !29
...
!7 = !{!8, !9, i64 0}
!8 = !{!"LargeS_struct", !9, i64 0, !12, i64 8, !13, i64 16, !9, i64 24}
!9 = !{!"int", !10, i64 0}
...
!16 = !{!8, !9, i64 24}
!17 = !{!10, !10, i64 0}
!18 = !{i64 0, i64 4, !19, i64 4, i64 1, !17}
!19 = !{!9, !9, i64 0}
!20 = !{i64 0, i64 1, !17}
!21 = !{i64 0, i64 8, !22}
!22 = !{!12, !12, i64 0}
!23 = !{i64 0, i64 4, !19, i64 8, i64 8, !22}
!24 = !{i64 0, i64 4, !19, i64 8, i64 8, !22, i64 16, i64 8, !25, i64 24, i64 4, !19}
!25 = !{!13, !13, i64 0}
!26 = !{i64 0, i64 8, !22, i64 8, i64 8, !25, i64 16, i64 4, !19}
!27 = !{i64 0, i64 8, !25, i64 8, i64 4, !19}
!28 = !{i64 0, i64 4, !19}
!29 = distinct !{!29, !30}
