...
96:                                               ; preds = %149, %156, %94
  %97 = phi ptr [ %91, %94 ], [ %145, %156 ], [ %145, %149 ]
  %98 = phi ptr [ %23, %94 ], [ %144, %156 ], [ %144, %149 ]
...
149:                                              ; preds = %143
  ...
  br i1 %152, label %96, label %153, !llvm.loop !221

153:                                              ; preds = %153, %149
  %154 = call i32 @getchar() #30
  %155 = icmp eq i32 %154, 10
  br i1 %155, label %156, label %153, !llvm.loop !223

156:                                              ; preds = %153
  %157 = and i32 %151, -33
  %158 = icmp eq i32 %157, 78
  br i1 %158, label %247, label %96, !llvm.loop !221

159:                                              ; preds = %82
  %160 = load i32, ptr @step_thru, align 4, !tbaa !217
...
162:                                              ; preds = %159
  ...
  %165 = load ptr, ptr %23, align 8, !tbaa !219
  %166 = getelementptr inbounds ptr, ptr %165, i64 13
  %167 = load ptr, ptr %166, align 8
  %168 = invoke noundef ptr %167(ptr noundef nonnull align 8 dereferenceable(16) %23, ptr noundef %164, i32 noundef %163, ptr noundef nonnull %7) #30
          to label %169 unwind label %194

169:                                              ; preds = %198, %162
  %170 = phi ptr [ %199, %198 ], [ %23, %162 ]
  %171 = phi ptr [ %200, %198 ], [ %168, %162 ]
  %172 = icmp eq ptr %171, null
  br i1 %172, label %247, label %173

173:                                              ; preds = %169
  %174 = load i32, ptr %7, align 4, !tbaa !217
  %175 = and i32 %174, 2
...
177:                                              ; preds = %173
  %178 = and i32 %174, -3
  store i32 %178, ptr %7, align 4, !tbaa !217
  %179 = load ptr, ptr %6, align 8, !tbaa !213
  %180 = load ptr, ptr %171, align 8, !tbaa !219
  %181 = getelementptr inbounds ptr, ptr %180, i64 13
  %182 = load ptr, ptr %181, align 8
  %183 = invoke noundef ptr %182(ptr noundef nonnull align 8 dereferenceable(16) %171, ptr noundef %179, i32 noundef %163, ptr noundef nonnull %7) #30
          to label %184 unwind label %196

184:                                              ; preds = %177
  %185 = icmp eq ptr %183, null
  %186 = icmp eq ptr %171, %183
  %187 = or i1 %185, %186
  br i1 %187, label %198, label %188

188:                                              ; preds = %184
  %189 = load ptr, ptr %171, align 8, !tbaa !219
  %190 = getelementptr inbounds ptr, ptr %189, i64 2
  %191 = load ptr, ptr %190, align 8
  call void %191(ptr noundef nonnull align 8 dereferenceable(16) %171) #28
  %192 = icmp eq ptr %171, %170
  %193 = select i1 %192, ptr null, ptr %170
  br label %198

194:                                              ; preds = %214, %209, %162
...
198:                                              ; preds = %188, %184
  %199 = phi ptr [ %193, %188 ], [ %170, %184 ]
  %200 = phi ptr [ %183, %188 ], [ %171, %184 ]
  %201 = load i32, ptr %7, align 4, !tbaa !217
  %202 = and i32 %201, 2
  %203 = icmp eq i32 %202, 0
  br i1 %203, label %204, label %169, !llvm.loop !224

204:                                              ; preds = %198, %173
  %205 = phi ptr [ %170, %173 ], [ %199, %198 ]
  %206 = phi ptr [ %171, %173 ], [ %200, %198 ]
  %207 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.11) #30
  %208 = load ptr, ptr %6, align 8, !tbaa !213
  br i1 %83, label %209, label %214

209:                                              ; preds = %204
  %210 = and i32 %163, -9
  %211 = load ptr, ptr %206, align 8, !tbaa !219
  %212 = getelementptr inbounds ptr, ptr %211, i64 14
  %213 = load ptr, ptr %212, align 8
  invoke void %213(ptr noundef nonnull align 8 dereferenceable(16) %206, ptr noundef %208, i32 noundef %210) #30
          to label %215 unwind label %194

214:                                              ; preds = %204
  invoke void @_ZNK8exp_node14symbolic_printEPK9alst_nodei(ptr noundef nonnull align 8 dereferenceable(16) %206, ptr noundef %208, i32 noundef %163) #30
          to label %215 unwind label %194

215:                                              ; preds = %214, %209
  %216 = call i32 @putchar(i32 10)
  %217 = load ptr, ptr %206, align 8, !tbaa !219
  %218 = getelementptr inbounds ptr, ptr %217, i64 2
  %219 = load ptr, ptr %218, align 8
  call void %219(ptr noundef nonnull align 8 dereferenceable(16) %206) #28
  %220 = icmp eq ptr %206, %205
  br i1 %220, label %255, label %247

221:                                              ; preds = %159
  %222 = load ptr, ptr %6, align 8, !tbaa !213
  %223 = load ptr, ptr %23, align 8, !tbaa !219
  %224 = getelementptr inbounds ptr, ptr %223, i64 13
  %225 = load ptr, ptr %224, align 8
  %226 = invoke noundef ptr %225(ptr noundef nonnull align 8 dereferenceable(16) %23, ptr noundef %222, i32 noundef %77, ptr noundef nonnull %7) #30
...
229:                                              ; preds = %227
  %230 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.11) #30
  %231 = load ptr, ptr %6, align 8, !tbaa !213
  br i1 %83, label %232, label %239

232:                                              ; preds = %229
  %233 = and i32 %77, -9
  %234 = load ptr, ptr %226, align 8, !tbaa !219
  %235 = getelementptr inbounds ptr, ptr %234, i64 14
  %236 = load ptr, ptr %235, align 8
  invoke void %236(ptr noundef nonnull align 8 dereferenceable(16) %226, ptr noundef %231, i32 noundef %233) #30
          to label %240 unwind label %237

237:                                              ; preds = %239, %232, %221
  %238 = landingpad { ptr, i32 }
          cleanup
  br label %256

239:                                              ; preds = %229
  invoke void @_ZNK8exp_node14symbolic_printEPK9alst_nodei(ptr noundef nonnull align 8 dereferenceable(16) %226, ptr noundef %231, i32 noundef %77) #30
          to label %240 unwind label %237

240:                                              ; preds = %239, %232
  %241 = call i32 @putchar(i32 10)
  %242 = load ptr, ptr %226, align 8, !tbaa !219
  %243 = getelementptr inbounds ptr, ptr %242, i64 2
  %244 = load ptr, ptr %243, align 8
  call void %244(ptr noundef nonnull align 8 dereferenceable(16) %226) #28
  %245 = icmp eq ptr %226, %23
...
247:                                              ; preds = %215, %169, %156, %143, %119
  %248 = phi ptr [ %205, %215 ], [ %170, %169 ], [ %144, %156 ], [ %98, %119 ], [ %144, %143 ]
  %249 = icmp eq ptr %248, null
  br i1 %249, label %255, label %250

250:                                              ; preds = %247, %240, %227, %92
  %251 = phi ptr [ %248, %247 ], [ %23, %240 ], [ %23, %227 ], [ %23, %92 ]
...
255:                                              ; preds = %250, %247, %215
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %7) #27
  br label %21

256:                                              ; preds = %237, %196, %194, %141, %116, %110, %108, %41
  %257 = phi { ptr, i32 } [ %42, %41 ], [ %238, %237 ], [ %109, %108 ], [ %111, %110 ], [ %142, %141 ], [ %117, %116 ], [ %195, %194 ], [ %197, %196 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %7) #27
  br label %263

258:                                              ; preds = %31
  %.lcssa1 = phi ptr [ %23, %31 ]
  %259 = load ptr, ptr %.lcssa1, align 8, !tbaa !219
  %260 = getelementptr inbounds ptr, ptr %259, i64 2
  %261 = load ptr, ptr %260, align 8
  call void %261(ptr noundef nonnull align 8 dereferenceable(16) %.lcssa1) #28
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %7) #27
...
263:                                              ; preds = %256, %39, %37
  %264 = phi { ptr, i32 } [ %38, %37 ], [ %257, %256 ], [ %40, %39 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %6) #27
  call void @_ZN24lambda_expression_parserD1Ev(ptr noundef nonnull align 8 dereferenceable(12) %5) #28
  br label %265

265:                                              ; preds = %263, %35
  %266 = phi { ptr, i32 } [ %264, %263 ], [ %36, %35 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %5) #27
  br label %267

267:                                              ; preds = %265, %33
  %268 = phi { ptr, i32 } [ %266, %265 ], [ %34, %33 ]
  call void @_ZN12token_streamD1Ev(ptr noundef nonnull align 8 dereferenceable(8756) %4) #28
  call void @llvm.lifetime.end.p0(i64 8760, ptr nonnull %4) #27
  resume { ptr, i32 } %268
}
