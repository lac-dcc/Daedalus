...
4:                                                ; preds = %2
  ...
  %7 = tail call i32 @atoi(ptr nocapture noundef %6) #24
...
10:                                               ; preds = %8, %4
  ...
  %13 = tail call i32 @atoi(ptr nocapture noundef %12) #24
  br label %14
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #2 {
  ...
  %6 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %4, i32 noundef %5) #26
  %7 = tail call ptr @old_main() #26
  ret i32 0
}
...
define internal noalias ptr @old_main() #2 {
  ...
  %9 = tail call noalias dereferenceable_or_null(1064) ptr @malloc(i64 noundef 1064) #28
...
14:                                               ; preds = %52, %0
  ...
  call void @uniform_testdata(ptr nonnull sret(%struct.datapoints) align 8 %7, i32 noundef %22, i32 noundef %24, i32 noundef %26) #26
...
103:                                              ; preds = %94
  %104 = tail call { i64, i64 } @intcoord(ptr noundef nonnull %81, ptr noundef nonnull %9) #26
...
149:                                              ; preds = %149, %82
  ...
  %154 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %153, i32 noundef %152) #26
...
162:                                              ; preds = %82, %149, %162
  %163 = phi double [ %165, %162 ], [ 0.000000e+00, %149 ], [ 0.000000e+00, %82 ]
  %164 = phi i32 [ %166, %162 ], [ 0, %149 ], [ 0, %82 ]
  tail call void @stepsystem(ptr noundef nonnull %9, i32 noundef %164) #26
  %165 = fadd double %163, 1.250000e-02
  %166 = add nuw nsw i32 %164, 1
  %167 = fcmp olt double %165, 2.001250e+00
  %168 = icmp ult i32 %164, 9
  %169 = and i1 %167, %168
...
define internal void @uniform_testdata(ptr noalias nocapture sret(%struct.datapoints) align 8 %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #2 {
  %5 = tail call noalias dereferenceable_or_null(144) ptr @malloc(i64 noundef 144) #28
...
15:                                               ; preds = %105, %10
  ...
  %19 = tail call noalias dereferenceable_or_null(144) ptr @malloc(i64 noundef 144) #28
  ...
  %25 = tail call double (double, ...) @my_rand(double noundef %18) #25
  %26 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 0x3FEFF7CED916872B, double noundef %25) #25
  %27 = tail call double @pow(double noundef %26, double noundef 0xBFE5555555555555) #25
  %28 = fadd double %27, -1.000000e+00
  %29 = tail call double @sqrt(double noundef %28) #25
  br label %30

30:                                               ; preds = %30, %15
  %31 = phi i64 [ 0, %15 ], [ %37, %30 ]
  %32 = phi double [ %25, %15 ], [ %33, %30 ]
  %33 = tail call double (double, ...) @my_rand(double noundef %32) #25
  %34 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 0x3FEFF7CED916872B, double noundef %33) #25
...
48:                                               ; preds = %48, %39
  ...
  %50 = tail call double (double, ...) @my_rand(double noundef %49) #25
  %51 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 1.000000e+00, double noundef %50) #25
  %52 = tail call double (double, ...) @my_rand(double noundef %50) #25
  %53 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 1.000000e-01, double noundef %52) #25
  %54 = fmul double %51, %51
  %55 = fneg double %51
  %56 = tail call double @llvm.fmuladd.f64(double %55, double %51, double 1.000000e+00)
  %57 = tail call double @pow(double noundef %56, double noundef 3.500000e+00) #25
...
60:                                               ; preds = %48
  ...
  %63 = tail call double @pow(double noundef %62, double noundef 2.500000e-01) #25
...
65:                                               ; preds = %73, %60
  ...
  %68 = tail call double (double, ...) @my_rand(double noundef %67) #25
  %69 = tail call double (double, double, double, ...) @xrand(double noundef -1.000000e+00, double noundef 1.000000e+00, double noundef %68) #25
...
85:                                               ; preds = %83
  ...
  %87 = tail call double @sqrt(double noundef %.lcssa4.lcssa) #25
...
define internal { i64, i64 } @intcoord(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) #9 {
  ...
  %7 = call double @_wyvern_slice_ic_test__818509035(ptr %0, ptr %1)
  %8 = fdiv double %7, %4
...
12:                                               ; preds = %2
  %13 = fmul double %8, 0x41D0000000000000
...
27:                                               ; preds = %17
  %28 = fmul double %23, 0x41D0000000000000
...
33:                                               ; preds = %27, %17
  %34 = phi i64 [ %32, %27 ], [ 0, %17 ]
  %35 = phi i64 [ %19, %27 ], [ 0, %17 ]
  %36 = call double @_wyvern_slice_intcoord__57094253(ptr %0, ptr %1)
  %37 = fdiv double %36, %4
...
41:                                               ; preds = %33
  %42 = fmul double %37, 0x41D0000000000000
...
46:                                               ; preds = %41, %33
  %47 = phi i64 [ %45, %41 ], [ 0, %33 ]
  %48 = phi i64 [ %35, %41 ], [ 0, %33 ]
  %49 = or i64 %34, %18
  %50 = insertvalue { i64, i64 } poison, i64 %49, 0
  %51 = and i64 %48, 281470681743360
  %52 = or i64 %51, %47
  %53 = insertvalue { i64, i64 } %50, i64 %52, 1
  ret { i64, i64 } %53
}
...
6:                                                ; preds = %2
  tail call void @freetree(ptr noundef nonnull %4) #26
  store ptr null, ptr %3, align 8, !tbaa !13
  br label %7

7:                                                ; preds = %6, %2
  %8 = load i32, ptr @nbody, align 4, !tbaa !11
  %9 = tail call ptr @maketree(ptr poison, i32 noundef %8, ptr noundef nonnull %0, i32 noundef %1, i32 noundef 0) #26
  store ptr %9, ptr %3, align 8, !tbaa !13
  tail call void @computegrav(ptr noundef nonnull %0, i32 noundef %1) #26
  %10 = getelementptr inbounds %struct.tree, ptr %0, i64 0, i32 4
  %11 = load ptr, ptr %10, align 8, !tbaa !7
  tail call void @vp(ptr noundef %11, i32 noundef %1) #26
  ret void
}
...
11:                                               ; preds = %6
  tail call void @freetree(ptr noundef nonnull %9) #26
  br label %12
...
28:                                               ; preds = %22
  tail call void @expandbox(ptr noundef nonnull %24, ptr noundef %2, i32 poison, i32 poison) #26
  %29 = tail call { i64, i64 } @intcoord(ptr noundef nonnull %24, ptr noundef %2) #26
  %30 = extractvalue { i64, i64 } %29, 0
  %31 = extractvalue { i64, i64 } %29, 1
  %32 = load ptr, ptr %6, align 8, !tbaa !13
  %33 = tail call ptr @loadtree(ptr noundef nonnull %24, i64 %30, i64 %31, ptr noundef %32, i32 noundef 536870912, ptr noundef %2) #26
...
39:                                               ; preds = %11, %5
  ...
  %41 = tail call double @hackcofm(ptr noundef %40) #26
...
10:                                               ; preds = %10, %7
  ...
  tail call void @grav(double noundef %4, ptr noundef %13, ptr noundef %16, i32 poison, double poison) #26
...
51:                                               ; preds = %43
  %52 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 99) #26
...
55:                                               ; preds = %53
  %56 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 98) #26
  tail call void @abort() #29
  unreachable
...
59:                                               ; preds = %57
  %60 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 97) #26
  tail call void @abort() #29
  unreachable
...
64:                                               ; preds = %61
  %65 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 96) #26
  tail call void @abort() #29
  unreachable
...
69:                                               ; preds = %66
  %70 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 95) #26
  tail call void @abort() #29
  unreachable
...
82:                                               ; preds = %71
  %83 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 94) #26
  tail call void @abort() #29
  unreachable

84:                                               ; preds = %74
  %85 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 89) #26
  tail call void @abort() #29
  unreachable
...
88:                                               ; preds = %86
  %89 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 88) #26
  tail call void @abort() #29
  unreachable
...
92:                                               ; preds = %90
  %93 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 87) #26
  tail call void @abort() #29
  unreachable
...
97:                                               ; preds = %94
  %98 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 86) #26
  tail call void @abort() #29
  unreachable
...
102:                                              ; preds = %99
  %103 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 85) #26
  tail call void @abort() #29
  unreachable
...
107:                                              ; preds = %104
  %108 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 84) #26
  tail call void @abort() #29
  unreachable
...
125:                                              ; preds = %117
  %126 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 79) #26
  tail call void @abort() #29
  unreachable
...
129:                                              ; preds = %127
  %130 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 78) #26
  tail call void @abort() #29
  unreachable
...
133:                                              ; preds = %131
  %134 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 77) #26
  tail call void @abort() #29
  unreachable
...
138:                                              ; preds = %135
  %139 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 76) #26
  tail call void @abort() #29
  unreachable
...
143:                                              ; preds = %140
  %144 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 75) #26
  tail call void @abort() #29
  unreachable
...
148:                                              ; preds = %145
  %149 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 74) #26
  tail call void @abort() #29
  unreachable
...
193:                                              ; preds = %188
  %194 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 69) #26
  tail call void @abort() #29
  unreachable
...
197:                                              ; preds = %195
  %198 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 68) #26
  tail call void @abort() #29
  unreachable
...
201:                                              ; preds = %199
  %202 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 67) #26
  tail call void @abort() #29
  unreachable
...
206:                                              ; preds = %203
  %207 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 66) #26
  tail call void @abort() #29
  unreachable
...
211:                                              ; preds = %208
  %212 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 65) #26
  tail call void @abort() #29
  unreachable
...
216:                                              ; preds = %213
  %217 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 64) #26
  tail call void @abort() #29
  unreachable
...
define internal void @expandbox(ptr nocapture noundef readonly %0, ptr nocapture noundef %1, i32 %2, i32 %3) #2 {
  ...
  %6 = alloca [3 x double], align 16
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %6) #27
  %7 = tail call i32 @ic_test(ptr noundef %0, ptr noundef %1) #26, !range !73
  %8 = icmp eq i32 %7, 0
...
19:                                               ; preds = %16
  %20 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 999) #26
  tail call void @abort() #29
  unreachable
...
53:                                               ; preds = %47
  %54 = tail call noalias dereferenceable_or_null(120) ptr @malloc(i64 noundef 120) #28
  br label %55
...
55:                                               ; preds = %53, %50
  ...
  %62 = tail call { i64, i64 } @intcoord1(double noundef %59, double noundef %60, double noundef %61, ptr noundef nonnull %1) #26
...
66:                                               ; preds = %55
  %67 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 1) #26
  tail call void @abort() #29
  unreachable
...
83:                                               ; preds = %70
  ...
  %87 = tail call i32 @ic_test(ptr noundef %0, ptr noundef %1) #26, !range !73
  br label %88
...
11:                                               ; preds = %9
  %12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 2) #26
  tail call void @abort() #29
  unreachable
...
22:                                               ; preds = %16
  %23 = tail call noalias dereferenceable_or_null(120) ptr @malloc(i64 noundef 120) #28
  br label %24
...
24:                                               ; preds = %22, %19
  ...
  %28 = tail call i32 @subindex(ptr noundef nonnull %3, ptr noundef %5, i32 noundef %4) #26
...
49:                                               ; preds = %34
  ...
  %53 = ashr i32 %4, 1
  %54 = tail call ptr @loadtree(ptr noundef %0, i64 %1, i64 %2, ptr noundef %52, i32 noundef %53, ptr noundef %5) #26
...
13:                                               ; preds = %7
  %14 = tail call double @hackcofm(ptr noundef nonnull %11) #26
  br label %15
...
12:                                               ; preds = %3
  %13 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 5) #26
  tail call void @abort() #29
  unreachable
...
14:                                               ; preds = %3
  ...
  %17 = fmul double %8, 0x41D0000000000000
...
27:                                               ; preds = %14
  %28 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 6) #26
  tail call void @abort() #29
  unreachable

29:                                               ; preds = %14
  %30 = fmul double %23, 0x41D0000000000000
  %31 = tail call double @llvm.floor.f64(double %30)
  %32 = fptosi double %31 to i32
  %33 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 1
  store i32 %32, ptr %33, align 4, !tbaa !11
  %34 = call double @_wyvern_slice_intcoord__57094253(ptr %0, ptr %1)
  %35 = fdiv double %34, %6
...
39:                                               ; preds = %29
  %40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 7) #26
  tail call void @abort() #29
  unreachable

41:                                               ; preds = %29
  %42 = fmul double %35, 0x41D0000000000000
  %43 = tail call double @llvm.floor.f64(double %42)
  %44 = fptosi double %43 to i32
...
46:                                               ; preds = %46, %41
  ...
  %48 = phi i32 [ 0, %41 ], [ %56, %46 ]
  %49 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 %47
  ...
  %58 = icmp eq i64 %57, 3
  br i1 %58, label %59, label %46, !llvm.loop !84
...
define internal i32 @ic_test(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) #15 {
  %3 = getelementptr inbounds %struct.bnode, ptr %0, i64 0, i32 2, i64 1
  %4 = getelementptr inbounds %struct.tree, ptr %1, i64 0, i32 1
  %5 = load double, ptr %4, align 8, !tbaa !48
  %6 = call double @_wyvern_slice_ic_test__818509035(ptr %0, ptr %1)
  %7 = fdiv double %6, %5
  %8 = fcmp oge double %7, 0.000000e+00
  %9 = fcmp olt double %7, 1.000000e+00
  %10 = and i1 %8, %9
  %11 = getelementptr inbounds [3 x double], ptr %1, i64 0, i64 1
  %12 = load <2 x double>, ptr %3, align 8, !tbaa !16
  ...
  %20 = fcmp olt <2 x double> %17, <double 1.000000e+00, double 1.000000e+00>
...
6:                                                ; preds = %6, %3
  %7 = phi i64 [ 0, %3 ], [ %10, %6 ]
  %8 = call double @_wyvern_slice_gravsub__333786985(ptr %1, ptr %2, i64 %7)
  %9 = getelementptr inbounds [3 x double], ptr %5, i64 0, i64 %7
  store double %8, ptr %9, align 8, !tbaa !16
  %10 = add nuw nsw i64 %7, 1
  %11 = icmp eq i64 %10, 3
  br i1 %11, label %12, label %6, !llvm.loop !85

12:                                               ; preds = %12, %6
  %13 = phi i64 [ %18, %12 ], [ 0, %6 ]
  %14 = phi double [ %17, %12 ], [ 0.000000e+00, %6 ]
  %15 = getelementptr inbounds [3 x double], ptr %5, i64 0, i64 %13
  %16 = load double, ptr %15, align 8, !tbaa !16
  %17 = tail call double @llvm.fmuladd.f64(double %16, double %16, double %14)
  %18 = add nuw nsw i64 %13, 1
  %19 = icmp eq i64 %18, 3
  br i1 %19, label %20, label %12, !llvm.loop !86

20:                                               ; preds = %12
  %.lcssa = phi double [ %17, %12 ]
  %21 = fadd double %.lcssa, 0x3F647AE147AE147C
  %22 = tail call double @sqrt(double noundef %21) #25
  ...
  store double %28, ptr %26, align 8, !tbaa !70
  %29 = fdiv double %25, %21
  br label %30

30:                                               ; preds = %30, %20
  %31 = phi i64 [ 0, %20 ], [ %36, %30 ]
  %32 = getelementptr inbounds [3 x double], ptr %5, i64 0, i64 %31
  %33 = load double, ptr %32, align 8, !tbaa !16
  %34 = fmul double %29, %33
  %35 = getelementptr inbounds [3 x double], ptr %4, i64 0, i64 %31
  store double %34, ptr %35, align 8, !tbaa !16
  %36 = add nuw nsw i64 %31, 1
  %37 = icmp eq i64 %36, 3
  br i1 %37, label %38, label %30, !llvm.loop !87

38:                                               ; preds = %38, %30
  %39 = phi i64 [ %45, %38 ], [ 0, %30 ]
  %40 = getelementptr inbounds %struct.hgstruct, ptr %2, i64 0, i32 3, i64 %39
  %41 = load double, ptr %40, align 8, !tbaa !16
  %42 = getelementptr inbounds [3 x double], ptr %4, i64 0, i64 %39
  %43 = load double, ptr %42, align 8, !tbaa !16
  %44 = fadd double %41, %43
  store double %44, ptr %40, align 8, !tbaa !16
...
8:                                                ; preds = %8, %4
  %9 = phi i64 [ %12, %8 ], [ 0, %4 ]
  %10 = call double @_wyvern_slice_gravsub__333786985(ptr %0, ptr %3, i64 %9)
  %11 = getelementptr inbounds [3 x double], ptr %5, i64 0, i64 %9
  store double %10, ptr %11, align 8, !tbaa !16
  %12 = add nuw nsw i64 %9, 1
  %13 = icmp eq i64 %12, 3
  br i1 %13, label %14, label %8, !llvm.loop !89

14:                                               ; preds = %14, %8
  %15 = phi i64 [ %20, %14 ], [ 0, %8 ]
  %16 = phi double [ %19, %14 ], [ 0.000000e+00, %8 ]
  %17 = getelementptr inbounds [3 x double], ptr %5, i64 0, i64 %15
  %18 = load double, ptr %17, align 8, !tbaa !16
  %19 = tail call double @llvm.fmuladd.f64(double %18, double %18, double %16)
  %20 = add nuw nsw i64 %15, 1
  %21 = icmp eq i64 %20, 3
  br i1 %21, label %22, label %14, !llvm.loop !90

22:                                               ; preds = %14
  %.lcssa = phi double [ %19, %14 ]
  %23 = fmul double %.lcssa, %2
  %24 = fcmp olt double %23, %1
  %25 = zext i1 %24 to i16
  br label %26

26:                                               ; preds = %22, %4
  %27 = phi i16 [ %25, %22 ], [ 0, %4 ]
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %5) #27
  ret i16 %27
}
...
define dso_local i32 @error(ptr nocapture noundef readonly %0) #21 {
  ...
  %3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef %0) #30
...
7:                                                ; preds = %1
  tail call void @perror(ptr noundef nonnull @.str.9) #30
  br label %8
...
define internal void @walksub(ptr noalias nocapture writeonly sret(%struct.hgstruct) align 8 %0, ptr noundef %1, double noundef %2, double noundef %3, ptr noundef byval(%struct.hgstruct) align 8 %4, i32 noundef %5) #2 {
  ...
  %9 = tail call signext i16 @subdivp(ptr noundef %1, double noundef %2, double noundef %3, ptr noundef nonnull byval(%struct.hgstruct) align 8 %4) #25
  %10 = icmp eq i16 %9, 0
...
19:                                               ; preds = %14
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %7) #27
  call void @walksub(ptr nonnull sret(%struct.hgstruct) align 8 %7, ptr noundef nonnull %17, double noundef %12, double noundef %3, ptr noundef nonnull byval(%struct.hgstruct) align 8 %4, i32 noundef %13) #26
...
26:                                               ; preds = %23
  ...
  call void @gravsub(ptr nonnull sret(%struct.hgstruct) align 8 %8, ptr noundef %1, ptr noundef nonnull byval(%struct.hgstruct) align 8 %4) #25
...
define internal double @_wyvern_slice_intcoord__57094253(ptr %0, ptr %1) #23 {
sliceclone_:
  %2 = getelementptr inbounds %struct.bnode, ptr %0, i64 0, i32 2, i64 2
...
; Function Attrs: noinline nounwind optsize willreturn
define internal double @_wyvern_slice_ic_test__818509035(ptr %0, ptr %1) #23 {
sliceclone_:
  %2 = getelementptr inbounds %struct.bnode, ptr %0, i64 0, i32 2
  %3 = load double, ptr %2, align 8, !tbaa !16
...
; Function Attrs: noinline nounwind optsize willreturn
define internal double @_wyvern_slice_gravsub__333786985(ptr %0, ptr %1, i64 %2) #23 {
sliceclone_:
  %3 = getelementptr inbounds %struct.node, ptr %0, i64 0, i32 2, i64 %2
  %4 = load double, ptr %3, align 8, !tbaa !16
  %5 = getelementptr inbounds %struct.hgstruct, ptr %1, i64 0, i32 1, i64 %2
  %6 = load double, ptr %5, align 8, !tbaa !16
  %7 = fsub double %4, %6
  ret double %7
}
