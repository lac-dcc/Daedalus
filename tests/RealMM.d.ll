...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [41 x double], ptr %m, i64 %idxprom
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [41 x double], ptr %a, i64 %idxprom
  %idxprom1 = sext i32 %i.0 to i64
  %arrayidx2 = getelementptr inbounds [41 x double], ptr %arrayidx, i64 0, i64 %idxprom1
  %1 = load double, ptr %arrayidx2, align 8
  %idxprom3 = sext i32 %i.0 to i64
  %arrayidx4 = getelementptr inbounds [41 x double], ptr %b, i64 %idxprom3
...
for.end8:                                         ; preds = %for.cond
  ...
  %0 = load double, ptr %arrayidx13, align 8
