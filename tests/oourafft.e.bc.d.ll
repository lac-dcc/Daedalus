...
define dso_local i32 @main() #0 {
  ...
  %5 = call i32 @gettimeofday(ptr noundef nonnull %4, ptr noundef null) #16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %4) #15
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %3) #15
  %6 = call i32 @gettimeofday(ptr noundef nonnull %3, ptr noundef null) #16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %3) #15
  %7 = tail call noalias align 16 dereferenceable_or_null(128) ptr @memalign(i64 noundef 16, i64 noundef 128) #17
  %8 = tail call noalias align 16 dereferenceable_or_null(20480) ptr @memalign(i64 noundef 16, i64 noundef 20480) #17
  tail call void @makewt(i32 noundef 512, ptr noundef %7, ptr noundef %8) #18
  %9 = tail call noalias align 16 dereferenceable_or_null(16384) ptr @memalign(i64 noundef 16, i64 noundef 16384) #17
  %10 = tail call noalias align 16 dereferenceable_or_null(16384) ptr @memalign(i64 noundef 16, i64 noundef 16384) #17
  %11 = tail call noalias align 16 dereferenceable_or_null(16384) ptr @memalign(i64 noundef 16, i64 noundef 16384) #17
  br label %12

12:                                               ; preds = %12, %0
  %13 = phi i64 [ 0, %0 ], [ %19, %12 ]
  %14 = phi i32 [ 0, %0 ], [ %15, %12 ]
  %15 = call i32 @_wyvern_slice_main__267800474(i32 %14)
  %16 = sitofp i32 %15 to double
  %17 = fmul double %16, 0x3ED02E85C0898B71
  %18 = getelementptr inbounds double, ptr %9, i64 %13
...
22:                                               ; preds = %12
  tail call fastcc void @bitrv2(i32 noundef 2048, ptr noundef %7, ptr noundef nonnull %9) #18
  tail call fastcc void @cftfsub(i32 noundef 2048, ptr noundef nonnull %9, ptr noundef %8) #18
  tail call void @cdft(i32 noundef 2048, i32 noundef -1, ptr noundef nonnull %9, ptr noundef %7, ptr noundef %8) #18
  br label %23

23:                                               ; preds = %23, %22
  %24 = phi i64 [ 0, %22 ], [ %36, %23 ]
  %25 = phi double [ 0.000000e+00, %22 ], [ %35, %23 ]
  %26 = phi i32 [ 0, %22 ], [ %27, %23 ]
  %27 = call i32 @_wyvern_slice_main__267800474(i32 %26)
  %28 = sitofp i32 %27 to double
  %29 = getelementptr inbounds double, ptr %9, i64 %24
  %30 = load double, ptr %29, align 8, !tbaa !7
  %31 = fmul double %30, 0xBF50000000000000
  %32 = tail call double @llvm.fmuladd.f64(double %28, double 0x3ED02E85C0898B71, double %31)
  %33 = tail call double @llvm.fabs.f64(double %32)
  %34 = fcmp ogt double %25, %33
  %35 = select i1 %34, double %25, double %33
  %36 = add nuw nsw i64 %24, 1
  %37 = and i64 %36, 4294967295
  %38 = icmp eq i64 %37, 2048
  br i1 %38, label %39, label %23, !llvm.loop !13

39:                                               ; preds = %23
  %.lcssa = phi double [ %35, %23 ]
  %40 = tail call double @llvm.fabs.f64(double %.lcssa)
  %41 = fcmp ogt double %40, 1.000000e-10
  br i1 %41, label %42, label %44

42:                                               ; preds = %39
  %43 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, double noundef %.lcssa) #18
...
45:                                               ; preds = %45, %44
  %46 = phi i64 [ 0, %44 ], [ %52, %45 ]
  %47 = phi i32 [ 0, %44 ], [ %48, %45 ]
  %48 = call i32 @_wyvern_slice_main__267800474(i32 %47)
  %49 = sitofp i32 %48 to double
  %50 = fmul double %49, 0x3ED02E85C0898B71
  %51 = getelementptr inbounds double, ptr %9, i64 %46
...
66:                                               ; preds = %66, %65
  %67 = phi i64 [ 0, %65 ], [ %73, %66 ]
  %68 = phi i32 [ 0, %65 ], [ %69, %66 ]
  %69 = call i32 @_wyvern_slice_main__267800474(i32 %68)
  %70 = sitofp i32 %69 to double
  %71 = fmul double %70, 0x3ED02E85C0898B71
  %72 = getelementptr inbounds double, ptr %11, i64 %67
...
76:                                               ; preds = %66
  ...
  %77 = call i32 @gettimeofday(ptr noundef nonnull %2, ptr noundef null) #16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %2) #15
  %78 = getelementptr double, ptr %10, i64 -1
  br label %79

79:                                               ; preds = %102, %76
  %80 = phi i32 [ 0, %76 ], [ %103, %102 ]
  ...
  tail call fastcc void @bitrv2(i32 noundef 2048, ptr noundef %7, ptr noundef %10) #18
  tail call fastcc void @cftfsub(i32 noundef 2048, ptr noundef %10, ptr noundef %8) #18
  br label %81

81:                                               ; preds = %81, %79
  %82 = phi i64 [ 0, %79 ], [ %100, %81 ]
  %83 = shl nuw nsw i64 %82, 1
  %84 = getelementptr inbounds double, ptr %10, i64 %83
  %85 = load <4 x double>, ptr %84, align 16, !tbaa !7
  ...
  %89 = load <4 x double>, ptr %88, align 16, !tbaa !7
  %90 = shufflevector <4 x double> %89, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %91 = shufflevector <4 x double> %89, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %92 = or i64 %83, 1
  %93 = fneg <2 x double> %87
  %94 = fmul <2 x double> %91, %93
  %95 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %86, <2 x double> %90, <2 x double> %94)
  %96 = fmul <2 x double> %90, %87
  %97 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %86, <2 x double> %91, <2 x double> %96)
  %98 = getelementptr double, ptr %78, i64 %92
  %99 = shufflevector <2 x double> %95, <2 x double> %97, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %99, ptr %98, align 16, !tbaa !7
  %100 = add nuw i64 %82, 2
  %101 = icmp eq i64 %100, 1024
  br i1 %101, label %102, label %81, !llvm.loop !15

102:                                              ; preds = %81
  tail call void @cdft(i32 noundef 2048, i32 noundef -1, ptr noundef nonnull %10, ptr noundef %7, ptr noundef %8) #18
  %103 = add nuw nsw i32 %80, 1
  %104 = icmp eq i32 %103, 150000
  br i1 %104, label %105, label %79, !llvm.loop !18

105:                                              ; preds = %102
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %1) #15
  %106 = call i32 @gettimeofday(ptr noundef nonnull %1, ptr noundef null) #16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %1) #15
  br label %107

107:                                              ; preds = %107, %105
  %108 = phi i64 [ 0, %105 ], [ %122, %107 ]
  %109 = shl nuw nsw i64 %108, 1
  %110 = getelementptr inbounds double, ptr %10, i64 %109
  %111 = load double, ptr %110, align 16, !tbaa !7
  %112 = tail call double @llvm.fabs.f64(double %111)
  %113 = fcmp ogt double %112, 1.000000e-09
  %114 = select i1 %113, double %111, double 0.000000e+00
  %115 = or i64 %109, 1
  ...
  %119 = fcmp ogt double %118, 1.000000e-09
  %120 = select i1 %119, double %117, double 0.000000e+00
  %121 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, double noundef %114, double noundef %120) #18
  %122 = add nuw nsw i64 %108, 1
  %123 = icmp eq i64 %122, 1024
  br i1 %123, label %124, label %107, !llvm.loop !19
...
5:                                                ; preds = %3
  ...
  %9 = fmul double %8, %7
  %10 = tail call double @cos(double noundef %9) #16
...
19:                                               ; preds = %19, %17
  ...
  %25 = tail call double @sin(double noundef %23) #16
...
35:                                               ; preds = %19
  tail call fastcc void @bitrv2(i32 noundef %0, ptr noundef %1, ptr noundef nonnull %2) #18
  br label %36
...
5:                                                ; preds = %3
  tail call fastcc void @cft1st(i32 noundef %0, ptr noundef %1, ptr noundef %2) #18
  %6 = icmp ugt i32 %0, 32
...
7:                                                ; preds = %7, %5
  %8 = phi i32 [ %10, %7 ], [ 32, %5 ]
  %9 = phi i32 [ %8, %7 ], [ 8, %5 ]
  tail call fastcc void @cftmdl(i32 noundef %0, i32 noundef %9, ptr noundef %1, ptr noundef %2) #18
  %10 = shl i32 %8, 2
...
9:                                                ; preds = %7
  tail call fastcc void @bitrv2(i32 noundef %0, ptr noundef %3, ptr noundef %2) #18
  br label %328
...
236:                                              ; preds = %235
  tail call fastcc void @cft1st(i32 noundef %0, ptr noundef %2, ptr noundef %4) #18
...
238:                                              ; preds = %238, %236
  ...
  tail call fastcc void @cftmdl(i32 noundef %0, i32 noundef %240, ptr noundef %2, ptr noundef %4) #18
  %241 = shl i32 %239, 2
...
328:                                              ; preds = %326, %9
  ...
  tail call fastcc void @cftfsub(i32 noundef %329, ptr noundef %2, ptr noundef %4) #18
  br label %330
...
define internal i32 @_wyvern_slice_main__267800474(i32 %0) #14 {
sliceclone_:
  %1 = mul nuw nsw i32 %0, 7141
  %2 = add nuw nsw i32 %1, 54773
  %3 = urem i32 %2, 259200
  ret i32 %3
}
...
attributes #17 = { nounwind optsize allocsize(1) }
