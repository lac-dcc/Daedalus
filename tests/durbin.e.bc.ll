...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readnone %1) #0 {
  %3 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 16000000) #7
  %4 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 16000000) #7
  %5 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #7
  %6 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #7
  %7 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #7
  %8 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #7
  %9 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 4000) #7
  br label %13

10:                                               ; preds = %24
  %11 = add nuw nsw i64 %14, 1
  %12 = icmp eq i64 %11, 4000
  br i1 %12, label %34, label %13, !llvm.loop !7
...
24:                                               ; preds = %24, %13
  ...
  br i1 %33, label %10, label %24, !llvm.loop !13

34:                                               ; preds = %10
  %35 = load double, ptr %7, align 8, !tbaa !9
  store double %35, ptr %3, align 8, !tbaa !9
...
64:                                               ; preds = %51
  ...
  %67 = fneg double %66
  %68 = load double, ptr %47, align 8, !tbaa !9
...
71:                                               ; preds = %71, %64
  ...
  %75 = load double, ptr %70, align 8, !tbaa !9
  %76 = xor i64 %72, -1
...
84:                                               ; preds = %71
  %85 = load double, ptr %70, align 8, !tbaa !9
  ...
  br i1 %88, label %89, label %37, !llvm.loop !16
...
89:                                               ; preds = %89, %84
  ...
  br i1 %95, label %99, label %89, !llvm.loop !17

96:                                               ; preds = %110
  %97 = add nuw nsw i64 %100, 1
  %98 = icmp eq i64 %97, 4000
  br i1 %98, label %120, label %99, !llvm.loop !7
...
110:                                              ; preds = %110, %99
  ...
  store double %115, ptr %117, align 8, !tbaa !9
  %118 = add nuw nsw i64 %111, 1
  %119 = icmp eq i64 %118, 4000
  br i1 %119, label %96, label %110, !llvm.loop !13

120:                                              ; preds = %96
  %121 = load double, ptr %7, align 8, !tbaa !9
  store double %121, ptr %3, align 8, !tbaa !9
  store double 1.000000e+00, ptr %6, align 8, !tbaa !9
  %122 = load double, ptr %7, align 8, !tbaa !9
  store double %122, ptr %5, align 8, !tbaa !9
  br label %123
...
158:                                              ; preds = %158, %151
  ...
  %162 = load double, ptr %157, align 8, !tbaa !9
  %163 = xor i64 %159, -1
...
172:                                              ; preds = %158
  %173 = load double, ptr %157, align 8, !tbaa !9
  ...
  br i1 %176, label %177, label %123, !llvm.loop !20
...
177:                                              ; preds = %177, %172
  ...
  store double %180, ptr %181, align 8, !tbaa !9
  %182 = add nuw nsw i64 %178, 1
  %183 = icmp eq i64 %182, 4000
  br i1 %183, label %184, label %177, !llvm.loop !21
...
193:                                              ; preds = %184
  ...
  %196 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %195, ptr noundef nonnull @.str.2, i32 noundef %194, double noundef %.lcssa2, i32 noundef %194, double noundef %.lcssa, double noundef 1.000000e-05) #8
  br label %216
...
200:                                              ; preds = %212, %197
  ...
  %202 = load ptr, ptr @stderr, align 8, !tbaa !22
  %203 = getelementptr inbounds double, ptr %9, i64 %201
  %204 = load double, ptr %203, align 8, !tbaa !9
  %205 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %202, ptr noundef nonnull @.str.3, double noundef %204) #8
...
define internal fastcc ptr @polybench_alloc_data(i64 noundef %0) unnamed_addr #0 {
  ...
  %4 = call i32 @posix_memalign(ptr noundef nonnull %2, i64 noundef 32, i64 noundef %3) #9
