...
for.end:                                          ; preds = %for.cond
  %sum.0.lcssa1 = call i32 @_wyvern_slice_foo_sum.0.lcssa_81287502(i32 %x, i32 %N)
...
for.end:                                          ; preds = %for.cond
  %sum.0.lcssa1 = call i32 @_wyvern_slice_bar_sum.0.lcssa_748125087(i32 %y, i32 %SIZE)
  %mul2 = call i32 @_wyvern_slice_bar_mul_215731275(i32 %y, i32 %SIZE, i32 %v)
  ret i32 %mul2
}
...
define internal i32 @_wyvern_slice_foo_sum.0.lcssa_81287502(i32 %x, i32 %N) #1 {
sliceclone_entry:
...
; Function Attrs: willreturn
define internal i32 @_wyvern_slice_bar_sum.0.lcssa_748125087(i32 %y, i32 %SIZE) #1 {
sliceclone_entry:
  br label %sliceclone_for.cond
...
; Function Attrs: willreturn
define internal i32 @_wyvern_slice_bar_mul_215731275(i32 %y, i32 %SIZE, i32 %v) #1 {
sliceclone_entry:
  br label %sliceclone_for.cond
