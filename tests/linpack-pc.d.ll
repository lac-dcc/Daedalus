...
237:                                              ; preds = %223
  ...
  %250 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 38, i64 1, ptr %249) #14
  %251 = load ptr, ptr @stderr, align 8, !tbaa !7
  %252 = tail call i64 @fwrite(ptr nonnull @.str.8, i64 34, i64 1, ptr %251) #14
  ...
  %258 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %253, ptr noundef nonnull @.str.9, double noundef %254, double noundef %255, double noundef 0x3E80000000000000, double noundef %256, double noundef %257) #15
  %259 = load ptr, ptr @stderr, align 8, !tbaa !7
  %260 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %259, ptr noundef nonnull @.str.10, i32 noundef 100) #15
  %261 = load ptr, ptr @stderr, align 8, !tbaa !7
  %262 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %261, ptr noundef nonnull @.str.11, i32 noundef 201) #15
  %263 = load ptr, ptr @stderr, align 8, !tbaa !7
  %264 = tail call i64 @fwrite(ptr nonnull @.str.12, i64 55, i64 1, ptr %263) #14
  %265 = load ptr, ptr @stderr, align 8, !tbaa !7
  %266 = tail call i64 @fwrite(ptr nonnull @.str.13, i64 12, i64 1, ptr %265) #14
...
274:                                              ; preds = %268, %237
  ...
  %279 = tail call i64 @fwrite(ptr nonnull @.str.14, i64 29, i64 1, ptr %278) #14
  br label %280

280:                                              ; preds = %288, %274
  %281 = phi i32 [ -3, %274 ], [ %289, %288 ]
  %282 = phi i32 [ 100, %274 ], [ %293, %288 ]
  %283 = tail call i64 @clock() #17
  br label %284
...
288:                                              ; preds = %284
  ...
  %290 = tail call i64 @clock() #17
  %291 = load ptr, ptr @stderr, align 8, !tbaa !7
  %292 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %291, ptr noundef nonnull @.str.15, i32 noundef %282, double noundef 0.000000e+00) #15
...
295:                                              ; preds = %288
  ...
  %300 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %299, ptr noundef nonnull @.str.16, double noundef 0.000000e+00) #15
  %301 = load ptr, ptr @stderr, align 8, !tbaa !7
  %302 = tail call i64 @fwrite(ptr nonnull @.str.17, i64 46, i64 1, ptr %301) #14
  br label %303
...
314:                                              ; preds = %310, %303
  %315 = tail call i64 @clock() #17
  %316 = load ptr, ptr @stderr, align 8, !tbaa !7
  %317 = load i32, ptr @main.ntimes, align 4, !tbaa !23
  %318 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %316, ptr noundef nonnull @.str.15, i32 noundef %317, double noundef 0.000000e+00) #15
...
323:                                              ; preds = %314
  ...
  %328 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %327, ptr noundef nonnull @.str.18, i32 noundef 0) #15
  %329 = load ptr, ptr @stderr, align 8, !tbaa !7
  %330 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %329, ptr noundef nonnull @.str.19, i32 noundef 201) #15
  %331 = load ptr, ptr @stderr, align 8, !tbaa !7
  %332 = tail call i64 @fwrite(ptr nonnull @.str.12, i64 55, i64 1, ptr %331) #14
  %333 = load ptr, ptr @stderr, align 8, !tbaa !7
  %334 = tail call i64 @fwrite(ptr nonnull @.str.13, i64 12, i64 1, ptr %333) #14
...
341:                                              ; preds = %341, %338
  %342 = phi i32 [ %343, %341 ], [ 0, %338 ]
  call fastcc void @matgen(ptr noundef nonnull @main.a, i32 noundef 201, ptr noundef nonnull %1) #16
  tail call fastcc void @dgefa(ptr noundef nonnull @main.a, i32 noundef 201) #16
  %343 = add nuw nsw i32 %342, 1
  %344 = icmp eq i32 %343, %339
  br i1 %344, label %345, label %341, !llvm.loop !27

345:                                              ; preds = %341, %338
  %346 = call float @_wyvern_slice_main__282090046()
  %347 = fsub float %346, %337
  %348 = load i32, ptr @main.ntimes, align 4, !tbaa !23
  %349 = sitofp i32 %348 to float
  %350 = fdiv float %347, %349
  %351 = load i32, ptr @main.j, align 4, !tbaa !23
  %352 = sext i32 %351 to i64
  %353 = getelementptr inbounds [15 x float], ptr @atime, i64 0, i64 %352
...
356:                                              ; preds = %356, %345
  %357 = phi i32 [ %358, %356 ], [ 0, %345 ]
  tail call fastcc void @dgesl(ptr noundef nonnull @main.a, i32 noundef 201) #16
  %358 = add nuw nsw i32 %357, 1
  %359 = icmp eq i32 %358, %354
  br i1 %359, label %360, label %356, !llvm.loop !28

360:                                              ; preds = %356, %345
  %361 = call float @_wyvern_slice_main__168736891()
  %362 = load i32, ptr @main.j, align 4, !tbaa !23
  %363 = sext i32 %362 to i64
  %364 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 1, i64 %363
  store float %361, ptr %364, align 4, !tbaa !11
  %365 = getelementptr inbounds [15 x float], ptr @atime, i64 0, i64 %363
  %366 = load float, ptr %365, align 4, !tbaa !11
  %367 = fadd float %366, %361
  %368 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 2, i64 %363
  store float %367, ptr %368, align 4, !tbaa !11
  %369 = fpext float %367 to double
  %370 = fmul double %369, 1.000000e+06
  %371 = fdiv double 0x4124F49560000000, %370
  %372 = fptrunc double %371 to float
  %373 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 3, i64 %363
  store float %372, ptr %373, align 4, !tbaa !11
  %374 = fdiv float 2.000000e+00, %372
  %375 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 4, i64 %363
  store float %374, ptr %375, align 4, !tbaa !11
  %376 = fdiv float %367, 0x3FACAC0840000000
  %377 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 5, i64 %363
  store float %376, ptr %377, align 4, !tbaa !11
  %378 = load float, ptr getelementptr inbounds ([9 x [15 x float]], ptr @atime, i64 0, i64 3, i64 6), align 4, !tbaa !11
  %379 = fadd float %378, %372
  store float %379, ptr getelementptr inbounds ([9 x [15 x float]], ptr @atime, i64 0, i64 3, i64 6), align 4, !tbaa !11
  %380 = add nsw i32 %362, 1
  store i32 %380, ptr @main.j, align 4, !tbaa !23
  %381 = icmp slt i32 %362, 5
  br i1 %381, label %338, label %382, !llvm.loop !29

382:                                              ; preds = %360
  %.lcssa1 = phi float [ %379, %360 ]
  %383 = fdiv float %.lcssa1, 5.000000e+00
  store float %383, ptr getelementptr inbounds ([9 x [15 x float]], ptr @atime, i64 0, i64 3, i64 6), align 4, !tbaa !11
  %384 = load ptr, ptr @stderr, align 8, !tbaa !7
  %385 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %384, ptr noundef nonnull @.str.20, double noundef 0.000000e+00) #15
  %386 = load ptr, ptr @stderr, align 8, !tbaa !7
  %387 = tail call i64 @fwrite(ptr nonnull @.str.21, i64 30, i64 1, ptr %386) #14
  %388 = tail call i64 @clock() #17
  %389 = sitofp i64 %388 to float
  br label %390

390:                                              ; preds = %390, %382
  %391 = phi i32 [ %392, %390 ], [ 0, %382 ]
...
394:                                              ; preds = %390
  %395 = fdiv float %389, 1.000000e+06
  %396 = call float @_wyvern_slice_main__102942978()
  %397 = fsub float %396, %395
  %398 = fdiv float %397, 4.000000e+02
  %399 = load ptr, ptr @stderr, align 8, !tbaa !7
  %400 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %399, ptr noundef nonnull @.str.16, double noundef 0.000000e+00) #15
  %401 = load ptr, ptr @stderr, align 8, !tbaa !7
  %402 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %401, ptr noundef nonnull @.str.19, i32 noundef 200) #15
  %403 = load ptr, ptr @stderr, align 8, !tbaa !7
  %404 = tail call i64 @fwrite(ptr nonnull @.str.12, i64 55, i64 1, ptr %403) #14
  %405 = load ptr, ptr @stderr, align 8, !tbaa !7
  %406 = tail call i64 @fwrite(ptr nonnull @.str.13, i64 12, i64 1, ptr %405) #14
...
413:                                              ; preds = %413, %410
  ...
  br i1 %416, label %417, label %413, !llvm.loop !31

417:                                              ; preds = %413, %410
  %418 = call float @_wyvern_slice_main__282090046()
  %419 = fsub float %418, %409
  %420 = load i32, ptr @main.ntimes, align 4, !tbaa !23
  %421 = sitofp i32 %420 to float
  %422 = fdiv float %419, %421
  %423 = load i32, ptr @main.j, align 4, !tbaa !23
  %424 = sext i32 %423 to i64
  %425 = getelementptr inbounds [15 x float], ptr @atime, i64 0, i64 %424
  store float %422, ptr %425, align 4, !tbaa !11
  %426 = load i32, ptr @main.ntimes, align 4, !tbaa !23
  %427 = icmp sgt i32 %426, 0
  br i1 %427, label %428, label %432

428:                                              ; preds = %428, %417
  %429 = phi i32 [ %430, %428 ], [ 0, %417 ]
  ...
  br i1 %431, label %432, label %428, !llvm.loop !32

432:                                              ; preds = %428, %417
  %433 = call float @_wyvern_slice_main__168736891()
  %434 = load i32, ptr @main.j, align 4, !tbaa !23
  %435 = sext i32 %434 to i64
  %436 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 1, i64 %435
  store float %433, ptr %436, align 4, !tbaa !11
  %437 = getelementptr inbounds [15 x float], ptr @atime, i64 0, i64 %435
  %438 = load float, ptr %437, align 4, !tbaa !11
  %439 = fadd float %438, %433
  %440 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 2, i64 %435
  store float %439, ptr %440, align 4, !tbaa !11
  %441 = fpext float %439 to double
  %442 = fmul double %441, 1.000000e+06
  %443 = fdiv double 0x4124F49560000000, %442
  %444 = fptrunc double %443 to float
  %445 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 3, i64 %435
  store float %444, ptr %445, align 4, !tbaa !11
  %446 = fdiv float 2.000000e+00, %444
  %447 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 4, i64 %435
  store float %446, ptr %447, align 4, !tbaa !11
  %448 = fdiv float %439, 0x3FACAC0840000000
  %449 = getelementptr inbounds [9 x [15 x float]], ptr @atime, i64 0, i64 5, i64 %435
  store float %448, ptr %449, align 4, !tbaa !11
  %450 = load float, ptr getelementptr inbounds ([9 x [15 x float]], ptr @atime, i64 0, i64 3, i64 12), align 4, !tbaa !11
  %451 = fadd float %450, %444
  store float %451, ptr getelementptr inbounds ([9 x [15 x float]], ptr @atime, i64 0, i64 3, i64 12), align 4, !tbaa !11
  %452 = add nsw i32 %434, 1
  store i32 %452, ptr @main.j, align 4, !tbaa !23
  %453 = icmp slt i32 %434, 11
  br i1 %453, label %410, label %454, !llvm.loop !33

454:                                              ; preds = %432
  %.lcssa = phi float [ %451, %432 ]
  %455 = fdiv float %.lcssa, 5.000000e+00
  store float %455, ptr getelementptr inbounds ([9 x [15 x float]], ptr @atime, i64 0, i64 3, i64 12), align 4, !tbaa !11
  %456 = load ptr, ptr @stderr, align 8, !tbaa !7
  %457 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %456, ptr noundef nonnull @.str.20, double noundef 0.000000e+00) #15
...
define internal float @_wyvern_slice_main__239906974() #11 {
sliceclone_:
  %0 = call float @_wyvern_slice_main__102942978()
  %1 = call float @_wyvern_slice_main__102942978()
  %2 = fsub float %1, %0
  ret float %2
}

; Function Attrs: nounwind optsize willreturn
define internal float @_wyvern_slice_main__282090046() #12 {
sliceclone_1:
  %0 = call float @_wyvern_slice_main__102942978()
  %1 = call float @_wyvern_slice_main__102942978()
  %2 = fsub float %1, %0
...
; Function Attrs: nounwind optsize willreturn
define internal float @_wyvern_slice_main__102942978() #12 {
sliceclone_:
...
; Function Attrs: noinline nounwind optsize willreturn
define internal float @_wyvern_slice_main__168736891() #11 {
sliceclone_:
  %0 = call float @_wyvern_slice_main__282090046()
