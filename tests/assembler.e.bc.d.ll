...
16:                                               ; preds = %28, %35, %65, %81, %82, %85, %134, %136, %149, %152, %5
...
51:                                               ; preds = %51, %45
  ...
  %63 = icmp eq i32 %62, 0
  br i1 %63, label %51, label %64, !llvm.loop !48
...
104:                                              ; preds = %98
  ...
  br i1 %106, label %98, label %107, !llvm.loop !49
...
127:                                              ; preds = %124, %121, %114
  ...
  br i1 %133, label %94, label %134, !llvm.loop !50
...
149:                                              ; preds = %19
  ...
  br i1 %151, label %152, label %16, !llvm.loop !47

152:                                              ; preds = %149
  call void (ptr, ptr, ...) @GET_LINE(ptr noundef nonnull %6, ptr noundef %0) #23
  %153 = call i32 @puts(ptr nonnull dereferenceable(1) @str.134)
  %154 = load ptr, ptr %6, align 8, !tbaa !11
  %155 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5.129, i32 noundef %22, ptr noundef %154) #24
  br label %16, !llvm.loop !47
