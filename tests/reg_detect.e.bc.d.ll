...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readnone %1) #0 {
  %3 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 36) #7
  %4 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 36) #7
  %5 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 36) #7
  %6 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 36) #7
  %7 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 2304) #7
  %8 = tail call fastcc ptr @polybench_alloc_data(i64 noundef 2304) #7
  br label %9
...
37:                                               ; preds = %37, %34
  ...
  %39 = load i32, ptr %36, align 4, !tbaa !7
...
71:                                               ; preds = %65
  ...
  %73 = icmp eq i64 %72, 6
  br i1 %73, label %74, label %49, !llvm.loop !19
...
74:                                               ; preds = %74, %71
  ...
  %80 = icmp eq i64 %79, 6
  br i1 %80, label %81, label %74, !llvm.loop !20
...
84:                                               ; preds = %84, %81
  ...
  %94 = icmp eq i64 %93, 6
  br i1 %94, label %95, label %84, !llvm.loop !21

95:                                               ; preds = %84
  %96 = add nuw nsw i64 %82, 1
  %97 = icmp eq i64 %96, 6
  br i1 %97, label %98, label %81, !llvm.loop !22

98:                                               ; preds = %95
  %99 = add nuw nsw i32 %31, 1
  %100 = icmp eq i32 %99, 10000
  br i1 %100, label %101, label %30, !llvm.loop !23
...
104:                                              ; preds = %104, %101
  ...
  store i32 %109, ptr %108, align 4, !tbaa !7
  ...
  br i1 %119, label %120, label %104, !llvm.loop !11
...
129:                                              ; preds = %129, %126
  ...
  %131 = load i32, ptr %128, align 4, !tbaa !7
  ...
  br i1 %134, label %135, label %129, !llvm.loop !24

135:                                              ; preds = %129
  %136 = add nuw nsw i64 %127, 1
  %137 = icmp eq i64 %136, 6
  br i1 %137, label %138, label %126, !llvm.loop !25

138:                                              ; preds = %135
  %139 = add nuw nsw i64 %125, 1
  %140 = icmp eq i64 %139, 6
  br i1 %140, label %141, label %124, !llvm.loop !26
...
148:                                              ; preds = %148, %143
  ...
  store i32 %153, ptr %154, align 4, !tbaa !7
  %155 = add nuw nsw i64 %150, 1
  %156 = icmp eq i64 %155, 64
  br i1 %156, label %157, label %148, !llvm.loop !27
...
157:                                              ; preds = %148
  ...
  store i32 %159, ptr %160, align 4, !tbaa !7
  %161 = add nuw nsw i64 %144, 1
  %162 = icmp eq i64 %161, 6
  br i1 %162, label %163, label %143, !llvm.loop !28

163:                                              ; preds = %157
  %164 = add nuw nsw i64 %142, 1
  %165 = icmp eq i64 %164, 6
  br i1 %165, label %166, label %141, !llvm.loop !29
...
166:                                              ; preds = %166, %163
  ...
  store i32 %169, ptr %170, align 4, !tbaa !7
  %171 = add nuw nsw i64 %167, 1
  %172 = icmp eq i64 %171, 6
  br i1 %172, label %173, label %166, !llvm.loop !30
...
176:                                              ; preds = %176, %173
  ...
  br i1 %186, label %187, label %176, !llvm.loop !31

187:                                              ; preds = %176
  %188 = add nuw nsw i64 %174, 1
  %189 = icmp eq i64 %188, 6
  br i1 %189, label %190, label %173, !llvm.loop !32

190:                                              ; preds = %187
  %191 = add nuw nsw i32 %123, 1
  %192 = icmp eq i32 %191, 10000
  br i1 %192, label %193, label %122, !llvm.loop !33
...
206:                                              ; preds = %195
  ...
  %210 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %209, ptr noundef nonnull @.str.2, i32 noundef %207, i32 noundef %208, double noundef %.lcssa2, i32 noundef %207, i32 noundef %208, double noundef %.lcssa, double noundef 1.000000e-05) #8
  br label %242
...
220:                                              ; preds = %233, %217
  ...
  %225 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %222, ptr noundef nonnull @.str.3, i32 noundef %224) #8
...
239:                                              ; preds = %236
  %240 = load ptr, ptr @stderr, align 8, !tbaa !34
