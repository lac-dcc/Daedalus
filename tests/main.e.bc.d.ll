...
define internal ptr @MakeSphere(ptr noundef returned %0, i32 noundef %1, i32 noundef %2, double noundef %3) #1 {
  ...
  %6 = getelementptr inbounds %struct.PointStruct, ptr %5, i64 0, i32 1
  %7 = getelementptr inbounds %struct.PointStruct, ptr %5, i64 0, i32 2
  %8 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 1
  %9 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 1, i32 1
  %10 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 1, i32 2
  %11 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 2
  %12 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 2, i32 1
  %13 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 2, i32 2
  %14 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 3
  %15 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 3, i32 1
  %16 = getelementptr inbounds [4 x %struct.PointStruct], ptr %5, i64 0, i64 3, i32 2
  br label %17

17:                                               ; preds = %64, %4
  %18 = phi double [ 0xC00921FB54442EEA, %4 ], [ %19, %64 ]
  %19 = call double @_wyvern_slice_MakeSphere__307277864(i32 %1, double %18)
  br label %20

20:                                               ; preds = %20, %17
  %21 = phi double [ 0xC00921FB54442EEA, %17 ], [ %42, %20 ]
  %22 = call double @cos(double noundef %21) #20
  %23 = call double @cos(double noundef %18) #20
  %24 = fmul double %22, %23
  %25 = fmul double %24, %3
  store double %25, ptr %5, align 16, !tbaa !17
  %26 = call double @sin(double noundef %21) #20
  %27 = call double @cos(double noundef %18) #20
  %28 = fmul double %26, %27
  %29 = fmul double %28, %3
  store double %29, ptr %6, align 8, !tbaa !19
  %30 = call double @sin(double noundef %18) #20
  %31 = fmul double %30, %3
  store double %31, ptr %7, align 16, !tbaa !20
  %32 = call double @cos(double noundef %21) #20
  %33 = call double @cos(double noundef %19) #20
  %34 = fmul double %32, %33
  %35 = fmul double %34, %3
  store double %35, ptr %8, align 8, !tbaa !17
  %36 = call double @sin(double noundef %21) #20
  %37 = call double @cos(double noundef %19) #20
  %38 = fmul double %36, %37
  %39 = fmul double %38, %3
  store double %39, ptr %9, align 16, !tbaa !19
  %40 = call double @sin(double noundef %19) #20
  %41 = fmul double %40, %3
  store double %41, ptr %10, align 8, !tbaa !20
  %42 = call double @_wyvern_slice_MakeSphere__307277864(i32 %2, double %21)
  %43 = call double @cos(double noundef %42) #20
  %44 = call double @cos(double noundef %19) #20
  %45 = fmul double %43, %44
  %46 = fmul double %45, %3
  store double %46, ptr %11, align 16, !tbaa !17
  %47 = call double @sin(double noundef %42) #20
  %48 = call double @cos(double noundef %19) #20
  %49 = fmul double %47, %48
  %50 = fmul double %49, %3
  store double %50, ptr %12, align 8, !tbaa !19
  %51 = call double @sin(double noundef %19) #20
  %52 = fmul double %51, %3
  store double %52, ptr %13, align 16, !tbaa !20
  %53 = call double @cos(double noundef %42) #20
  %54 = call double @cos(double noundef %18) #20
  %55 = fmul double %53, %54
  %56 = fmul double %55, %3
  store double %56, ptr %14, align 8, !tbaa !17
  %57 = call double @sin(double noundef %42) #20
  %58 = call double @cos(double noundef %18) #20
  %59 = fmul double %57, %58
  %60 = fmul double %59, %3
  store double %60, ptr %15, align 16, !tbaa !19
  %61 = call double @sin(double noundef %18) #20
  %62 = fmul double %61, %3
  store double %62, ptr %16, align 8, !tbaa !20
  call void @InsertPoly4(ptr noundef %0, ptr noundef nonnull %5, ptr noundef null, ptr noundef null) #20
  %63 = fcmp olt double %42, 0x400921FBDA7BEBF0
  br i1 %63, label %20, label %64, !llvm.loop !21

64:                                               ; preds = %20
  %65 = fcmp olt double %19, 0x400921FBDA7BEBF0
  br i1 %65, label %17, label %66, !llvm.loop !23
...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readnone %1) #1 {
  %3 = tail call ptr @Oalloc(ptr noundef nonnull @.str) #20
  %4 = tail call ptr @Oalloc(ptr noundef nonnull @.str.1) #20
  %5 = tail call ptr @MakeSphere(ptr noundef %4, i32 noundef 25, i32 noundef 25, double noundef 1.000000e+01) #21
  ...
  tail call void @InsertChild(ptr noundef %3, ptr noundef %4) #20
...
8:                                                ; preds = %8, %2
  ...
  tail call void @CalcObject(ptr noundef %3) #20
  %11 = add nuw nsw i32 %9, 1
  %12 = icmp eq i32 %11, 360
  br i1 %12, label %13, label %8, !llvm.loop !29

13:                                               ; preds = %8
  tail call void @PrintObject(ptr noundef %4) #20
  tail call void @Draw_All(ptr noundef null) #20
  ret i32 0
}
...
define internal ptr @Oalloc(ptr nocapture noundef readonly %0) #4 {
  %2 = tail call noalias dereferenceable_or_null(272) ptr @calloc(i64 noundef 272, i64 noundef 1) #22
  %3 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) %0) #20
...
8:                                                ; preds = %4
  %9 = tail call noalias dereferenceable_or_null(24) ptr @malloc(i64 noundef 24) #23
  %10 = getelementptr inbounds %struct.ObjectStruct, ptr %0, i64 0, i32 1
  store ptr %9, ptr %10, align 8, !tbaa !35
  %11 = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #23
...
47:                                               ; preds = %43
  ...
  %50 = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #23
...
8:                                                ; preds = %8, %4
  ...
  %16 = tail call ptr @InsertPoint(ptr noundef %0, double noundef %11, double noundef %13, double noundef %15) #21
...
5:                                                ; preds = %5, %1
  ...
  %14 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %7, double noundef %9, double noundef %11, double noundef %13) #21
  ...
  %22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1.6, double noundef %17, double noundef %19, double noundef %21) #21
...
7:                                                ; preds = %7, %5
  ...
  %17 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %16, double noundef %11, double noundef %13, double noundef %15) #21
  ...
  %25 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, double noundef %20, double noundef %22, double noundef %24) #21
...
7:                                                ; preds = %7, %5
  ...
  %15 = load double, ptr %14, align 8, !tbaa !11
  %16 = trunc i64 %8 to i32
  %17 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i32 noundef %16, double noundef %11, double noundef %13, double noundef %15) #21
  %18 = load ptr, ptr %9, align 8, !tbaa !46
  %19 = getelementptr inbounds %struct.ObjPointStruct, ptr %18, i64 0, i32 3
  %20 = load double, ptr %19, align 8, !tbaa !40
  %21 = getelementptr inbounds %struct.ObjPointStruct, ptr %18, i64 0, i32 4
...
define internal void @PrintObject(ptr noundef %0) #8 {
  %2 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5.9, ptr noundef %0) #21
  tail call void @PrintPoints(ptr noundef %0) #21
  tail call void @PrintPoly3s(ptr noundef %0) #21
  tail call void @PrintPoly4s(ptr noundef %0) #21
  ...
  %9 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %4, double noundef %6, double noundef %8) #21
  ...
  %16 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, double noundef %11, double noundef %13, double noundef %15) #21
  ...
  %23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8, double noundef %18, double noundef %20, double noundef %22) #21
  ...
  %30 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.9, double noundef %25, double noundef %27, double noundef %29) #21
...
16:                                               ; preds = %16, %12
  ...
  tail call void @ScaleObjectAdd(ptr noundef nonnull %17, double noundef %1, double noundef %2, double noundef %3) #21
  tail call void @RotateObjectAdd(ptr noundef nonnull %17, double noundef %4, double noundef %5, double noundef %6) #21
  tail call void @TranslateObjectAdd(ptr noundef nonnull %17, double noundef %7, double noundef %8, double noundef %9) #21
  tail call void @CalcObjectChildren(ptr noundef nonnull %17, double noundef %1, double noundef %2, double noundef %3, double noundef %4, double noundef %5, double noundef %6, double noundef %7, double noundef %8, double noundef %9) #21
...
define internal void @ScaleObjectAdd(ptr noundef readonly %0, double noundef %1, double noundef %2, double noundef %3) #1 {
  ...
  %8 = tail call ptr @ScaleMatrix(double noundef %1, double noundef %2, double noundef %3) #20
...
16:                                               ; preds = %16, %14
  ...
  call void @TPointToHPoint(ptr nonnull sret(%struct.HPointStruct) align 8 %6, ptr noundef byval(%struct.ObjPointStruct) align 8 %18) #20
  ...
  call void @MultMatrixHPoint(ptr nonnull sret(%struct.HPointStruct) align 8 %7, ptr noundef %8, ptr noundef nonnull byval(%struct.HPointStruct) align 8 %5) #20
...
27:                                               ; preds = %4
  ...
  %29 = tail call i64 @fwrite(ptr nonnull @.str.15, i64 25, i64 1, ptr %28) #24
  br label %30
...
9:                                                ; preds = %4
  %10 = tail call ptr @RotateMatrix(double noundef %1, double noundef %2, double noundef %3) #20
  %11 = getelementptr inbounds %struct.ObjectStruct, ptr %0, i64 0, i32 1
  %12 = load ptr, ptr %11, align 8, !tbaa !46
  %13 = icmp eq ptr %12, null
  br i1 %13, label %30, label %14
...
16:                                               ; preds = %16, %14
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %6) #19
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %7) #19
  call void @MultMatrixHPoint(ptr nonnull sret(%struct.HPointStruct) align 8 %7, ptr noundef %10, ptr noundef nonnull byval(%struct.HPointStruct) align 8 %5) #20
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %5, ptr noundef nonnull align 8 dereferenceable(32) %7, i64 32, i1 false), !tbaa.struct !74
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %7) #19
  %19 = load ptr, ptr %17, align 8, !tbaa !36
  %20 = getelementptr inbounds %struct.ObjPointStruct, ptr %19, i64 0, i32 3
...
27:                                               ; preds = %4
  %28 = load ptr, ptr @stderr, align 8, !tbaa !46
  %29 = tail call i64 @fwrite(ptr nonnull @.str.14, i64 26, i64 1, ptr %28) #24
  br label %30
...
9:                                                ; preds = %4
  %10 = tail call ptr @TranslateMatrix(double noundef %1, double noundef %2, double noundef %3) #20
  %11 = getelementptr inbounds %struct.ObjectStruct, ptr %0, i64 0, i32 1
  %12 = load ptr, ptr %11, align 8, !tbaa !46
  %13 = icmp eq ptr %12, null
  br i1 %13, label %30, label %14
...
27:                                               ; preds = %4
  %28 = load ptr, ptr @stderr, align 8, !tbaa !46
  %29 = tail call i64 @fwrite(ptr nonnull @.str.13, i64 29, i64 1, ptr %28) #24
  br label %30
...
7:                                                ; preds = %7, %3
  %8 = phi ptr [ %10, %7 ], [ %5, %3 ]
  tail call void @CalcObject(ptr noundef nonnull %8) #21
...
12:                                               ; preds = %7, %3
  ...
  tail call void @CalcObjectChildren(ptr noundef nonnull %0, double noundef %14, double noundef %16, double noundef %18, double noundef %20, double noundef %22, double noundef %24, double noundef %26, double noundef %28, double noundef %30) #21
  %31 = load double, ptr %13, align 8, !tbaa !61
  %32 = load double, ptr %15, align 8, !tbaa !62
  %33 = load double, ptr %17, align 8, !tbaa !33
  tail call void @ScaleObjectOverwrite(ptr noundef nonnull %0, double noundef %31, double noundef %32, double noundef %33) #21
  %34 = load double, ptr %19, align 8, !tbaa !66
  %35 = load double, ptr %21, align 8, !tbaa !24
  %36 = load double, ptr %23, align 8, !tbaa !67
  tail call void @RotateObjectAdd(ptr noundef nonnull %0, double noundef %34, double noundef %35, double noundef %36) #21
  %37 = load double, ptr %25, align 8, !tbaa !63
  %38 = load double, ptr %27, align 8, !tbaa !64
  %39 = load double, ptr %29, align 8, !tbaa !65
  tail call void @TranslateObjectAdd(ptr noundef nonnull %0, double noundef %37, double noundef %38, double noundef %39) #21
  br label %40
...
16:                                               ; preds = %16, %14
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %6) #19
  %18 = load ptr, ptr %17, align 8, !tbaa !36
  call void @PointToHPoint(ptr nonnull sret(%struct.HPointStruct) align 8 %6, ptr noundef byval(%struct.ObjPointStruct) align 8 %18) #20
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %5, ptr noundef nonnull align 8 dereferenceable(32) %6, i64 32, i1 false), !tbaa.struct !74
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %6) #19
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %7) #19
  call void @MultMatrixHPoint(ptr nonnull sret(%struct.HPointStruct) align 8 %7, ptr noundef %8, ptr noundef nonnull byval(%struct.HPointStruct) align 8 %5) #20
...
3:                                                ; preds = %1
  tail call void @PrintObject(ptr noundef nonnull %0) #21
  %4 = getelementptr inbounds %struct.ObjectStruct, ptr %0, i64 0, i32 12
  %5 = load ptr, ptr %4, align 8, !tbaa !46
  %6 = icmp eq ptr %5, null
  br i1 %6, label %12, label %7
...
7:                                                ; preds = %7, %3
  %8 = phi ptr [ %10, %7 ], [ %5, %3 ]
  tail call void @Draw_Children(ptr noundef nonnull %8) #21
  %9 = getelementptr inbounds %struct.ObjectStruct, ptr %8, i64 0, i32 21
  %10 = load ptr, ptr %9, align 8, !tbaa !46
  %11 = icmp eq ptr %10, null
...
3:                                                ; preds = %1
  ...
  tail call void @Draw_Children(ptr noundef %5) #21
  br label %6
...
7:                                                ; preds = %7, %3
  %8 = phi ptr [ %12, %7 ], [ %5, %3 ]
  tail call void @CalcObject(ptr noundef nonnull %8) #21
  tail call void @PrintObject(ptr noundef nonnull %8) #21
  %9 = getelementptr inbounds %struct.ObjectStruct, ptr %8, i64 0, i32 12
  %10 = load ptr, ptr %9, align 8, !tbaa !70
  tail call void @Draw_Children(ptr noundef %10) #21
...
3:                                                ; preds = %1
  tail call void @CalcObject(ptr noundef nonnull %0) #21
  br label %4

4:                                                ; preds = %3, %1
  tail call void @Draw_All_Prevs(ptr noundef %0) #21
  tail call void @Draw_Object(ptr noundef %0) #21
  tail call void @Draw_All_Nexts(ptr noundef %0) #21
  ret void
}
...
define internal noalias ptr @RotateMatrix(double noundef %0, double noundef %1, double noundef %2) #17 {
  ...
  %5 = tail call double @cos(double noundef %4) #20
  %6 = tail call double @sin(double noundef %4) #20
  %7 = fmul double %1, 0x3F91DF46A2529E84
  %8 = tail call double @cos(double noundef %7) #20
  %9 = tail call double @sin(double noundef %7) #20
  %10 = fmul double %2, 0x3F91DF46A2529E84
  %11 = tail call double @cos(double noundef %10) #20
  %12 = tail call double @sin(double noundef %10) #20
  %13 = tail call noalias dereferenceable_or_null(128) ptr @malloc(i64 noundef 128) #23
...
define internal double @_wyvern_slice_MakeSphere__307277864(i32 %0, double %1) #18 {
sliceclone_:
  %2 = sitofp i32 %0 to double
  %3 = fdiv double 0x401921FB54442EEA, %2
  %4 = fadd double %3, %1
  ret double %4
}
