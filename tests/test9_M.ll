...
entry:
  ...
  %call = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %a2)
  %call1 = call i32 (ptr, ...) @__isoc99_scanf(ptr noundef @.str, ptr noundef %a3)
